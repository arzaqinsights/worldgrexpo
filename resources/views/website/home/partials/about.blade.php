        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div class="lg:col-span-6 space-y-8">
                ...
                <div class="flex gap-4 items-center pt-4">
                    <a href="{{ route('about.index') }}" class="text-xs font-black bg-brand-primary p-4 text-white uppercase tracking-widest transition-colors">Institutional Profile</a>
                    <a href="{{ route('contact') }}" class="text-xs font-black uppercase tracking-widest bg-white p-4 border border-brand-primary text-brand-primary transition-colors">Connect with us</a>
                </div>
            </div>
        </div>
    </div>
