        ...
        <div class="space-y-1">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-1">
                <div class="lg:col-span-3 bg-slate-900 p-6  relative overflow-hidden group">
                    <div class="relative z-10 flex flex-col md:flex-row gap-12 items-start">
                        <div class="w-20 h-20 bg-brand-primary flex items-center justify-center shrink-0">
                            <i class="{{ $reasons[0]['icon'] }} text-white text-3xl"></i>
                        </div>
                        <div class="space-y-6">
                            <h3 class="text-3xl font-black text-white uppercase tracking-tighter">{{ $reasons[0]['title'] }}</h3>
                            <p class="text-white/60 text-lg leading-relaxed max-w-2xl">{{ $reasons[0]['desc'] }}</p>
                            <div class="flex flex-wrap gap-3">
                                @foreach($reasons[0]['points'] as $point)
                                    <span class="px-4 py-1.5 bg-white/5 border border-white/10 text-[9px] font-black text-white uppercase tracking-widest">{{ $point }}</span>
                                @endforeach
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-brand-primary p-6 flex flex-col justify-between group">
                    ...
                    <div class="space-y-4">
                        <h3 class="text-xl font-black text-white uppercase tracking-tighter leading-tight">{{ $reasons[1]['title'] }}</h3>
                        <p class="text-brand-primary-dark/60 text-[10px] font-black uppercase tracking-widest leading-relaxed">{{ $reasons[1]['desc'] }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-1">
                <div class="bg-brand-primary p-6 flex flex-col justify-between group">
                    ...
                    <div class="space-y-4">
                        <h3 class="text-xl font-black text-white uppercase tracking-tighter leading-tight">{{ $reasons[3]['title'] }}</h3>
                        <p class="text-brand-primary-dark/60 text-[10px] font-black uppercase tracking-widest leading-relaxed">{{ $reasons[3]['desc'] }}</p>
                    </div>
                </div>
                <div class="lg:col-span-3 bg-slate-900 p-6  relative overflow-hidden group">
                    <div class="relative z-10 flex flex-col md:flex-row gap-12 items-start">
                        <div class="w-20 h-20 bg-brand-accent flex items-center justify-center shrink-0">
                            <i class="{{ $reasons[2]['icon'] }} text-brand-primary-dark text-3xl"></i>
                        </div>
                        <div class="space-y-6">
                            <h3 class="text-3xl font-black text-white uppercase tracking-tighter">{{ $reasons[2]['title'] }}</h3>
                            <p class="text-white/60 text-lg leading-relaxed max-w-2xl">{{ $reasons[2]['desc'] }}</p>
                            <div class="grid grid-cols-3 gap-4">
                                @foreach($reasons[2]['points'] as $point)
                                    <div class="flex items-center gap-3 bg-white/5 p-3 border border-white/10">
                                        ...
                                        <span class="text-[9px] font-black text-white uppercase tracking-widest">{{ $point }}</span>
                                    </div>
                                @endforeach
                            </div>
                        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-1">
                <div class="lg:col-span-3 bg-slate-900 p-6  relative overflow-hidden group">
                    <div class="relative z-10 flex flex-col md:flex-row gap-12 items-start">
                        <div class="w-20 h-20 bg-white flex items-center justify-center shrink-0">
                            <i class="{{ $reasons[4]['icon'] }} text-brand-primary text-3xl"></i>
                        </div>
                        <div class="space-y-6">
                            <h3 class="text-3xl font-black text-white uppercase tracking-tighter">{{ $reasons[4]['title'] }}</h3>
                            <p class="text-white/60 text-lg leading-relaxed max-w-2xl">{{ $reasons[4]['desc'] }}</p>
                            <div class="flex flex-wrap gap-3">
                                @foreach($reasons[4]['points'] as $point)
                                    <span class="px-4 py-1.5 bg-brand-accent text-brand-primary-dark text-[9px] font-black uppercase tracking-widest">{{ $point }}</span>
                                @endforeach
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-brand-primary p-6 flex flex-col justify-between group">
                    ...
                    <div class="space-y-4">
                        <h3 class="text-xl font-black text-white uppercase tracking-tighter leading-tight">{{ $reasons[5]['title'] }}</h3>
                        <p class="text-brand-primary-dark/60 text-[10px] font-black uppercase tracking-widest leading-relaxed">{{ $reasons[5]['desc'] }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-1">
                <div class="bg-brand-primary p-6 flex flex-col justify-between group">
                    ...
                    <div class="space-y-4">
                        <h3 class="text-xl font-black text-white uppercase tracking-tighter leading-tight">{{ $reasons[7]['title'] }}</h3>
                        <p class="text-brand-primary-dark/60 text-[10px] font-black uppercase tracking-widest leading-relaxed">{{ $reasons[7]['desc'] }}</p>
                    </div>
                </div>
                <div class="lg:col-span-3 bg-slate-900 p-6  relative overflow-hidden group">
                    <div class="relative z-10 flex flex-col md:flex-row gap-12 items-start">
                        <div class="w-20 h-20 bg-brand-primary flex items-center justify-center shrink-0">
                            <i class="{{ $reasons[6]['icon'] }} text-white text-3xl"></i>
                        </div>
                        <div class="space-y-6">
                            <h3 class="text-3xl font-black text-white uppercase tracking-tighter">{{ $reasons[6]['title'] }}</h3>
                            <p class="text-white/60 text-lg leading-relaxed max-w-2xl">{{ $reasons[6]['desc'] }}</p>
                            <div class="flex flex-wrap gap-3">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-1">
                <div class="lg:col-span-3 bg-slate-900 p-6  relative overflow-hidden group">
                    <div class="relative z-10 flex flex-col md:flex-row gap-12 items-start">
                        <div class="w-20 h-20 bg-brand-accent flex items-center justify-center shrink-0">
                            <i class="{{ $reasons[8]['icon'] }} text-brand-primary-dark text-3xl"></i>
                        </div>
                        <div class="space-y-6">
                            <h3 class="text-3xl font-black text-white uppercase tracking-tighter">{{ $reasons[8]['title'] }}</h3>
                            <p class="text-white/60 text-lg leading-relaxed max-w-2xl">{{ $reasons[8]['desc'] }}</p>
                            <div class="flex flex-wrap gap-3">
                ...
                <div class="bg-brand-primary p-6 flex flex-col justify-between group">
                    ...
                    <div class="space-y-4">
                        <h3 class="text-xl font-black text-white uppercase tracking-tighter leading-tight">{{ $reasons[9]['title'] }}</h3>
                        <p class="text-brand-primary-dark/60 text-[10px] font-black uppercase tracking-widest leading-relaxed">{{ $reasons[9]['desc'] }}</p>
                    </div>
                </div>
            </div>
        </div>
