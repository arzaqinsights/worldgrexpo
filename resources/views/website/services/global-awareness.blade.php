 ...
 <section class="relative pt-40 pb-20 bg-slate-950 text-white overflow-hidden border-b border-slate-900">
  ...
  <div class="container relative z-10 text-left">
   <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10 backdrop-blur-md mb-12">
    ...
    <span class="text-white text-[10px] font-bold tracking-[0.4em] uppercase">Global Authority</span>
   </div>
  ...
  <div class="container space-y-16">
    ...
    <div class="space-y-12 animate-on-scroll">
     ...
     <div class="grid grid-cols-2 gap-6">
      <div class="p-8 bg-slate-50 rounded-2xl group hover:shadow-lg transition-all">
       <p class="text-4xl font-bold text-brand-primary hover:text-white transition-colors tracking-tight tabular-nums leading-none mb-4">50+</p>
       <p class="text-[10px] font-bold uppercase text-slate-500 tracking-[0.2em] hover:text-slate-400 transition-colors">Annual Global Summits</p>
      </div>
      <div class="p-8 bg-slate-50 rounded-2xl group hover:shadow-lg transition-all">
       <p class="text-4xl font-bold text-brand-primary hover:text-white transition-colors tracking-tight tabular-nums leading-none mb-4">10k+</p>
       <p class="text-[10px] font-bold uppercase text-slate-500 tracking-[0.2em] hover:text-slate-400 transition-colors">Industrial Nodes</p>
      </div>
     </div>
    </div>
   </div>
   ...
   <div class="space-y-12 text-center">
    ...
    <div class="grid lg:grid-cols-3 gap-6">
     ...
     <div class="p-16 bg-white hover:bg-slate-950 transition-all duration-700 group">
      <div class="w-20 h-20 bg-slate-50 border border-slate-100 flex items-center justify-center mb-12 mx-auto hover:bg-brand-primary hover:border-brand-primary transition-all">
        <i class="fa-solid fa-{{ $mod['icon'] }} text-brand-primary text-3xl hover:text-white transition-all"></i>
      </div>
      <h4 class="text-3xl font-bold text-slate-950 mb-8 uppercase tracking-tight hover:text-white transition-colors leading-none">{{ $mod['t'] }}</h4>
      <p class="text-slate-500 text-[10px] font-bold leading-relaxed uppercase tracking-[0.3em] hover:text-slate-400 transition-colors">{{ $mod['d'] }}</p>
     </div>
     @endforeach
    </div>
   </div>
   ...
   <!-- Section 3: Recent Impact -->
    ...
    <div class="flex flex-col md:flex-row justify-between items-end gap-12">
     ...
     <p class="text-2xl text-slate-500 font-medium max-w-xl leading-relaxed ">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
     ...
     <div class="h-96 relative overflow-hidden group bg-slate-900">
      ...
      <div class="absolute bottom-10 left-10">
       <span class="px-8 py-3 bg-brand-primary text-brand-primary-dark text-[10px] font-bold uppercase tracking-[0.3em] shadow-3xl">
        {{ $img['loc'] }}
       </span>
      </div>
     </div>
