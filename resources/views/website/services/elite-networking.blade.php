...
@section('title', 'Elite Networking & B2B Matchmaking - World Grexpo Foundation')
 ...
 <section class="relative pt-40 pb-20 bg-slate-950 text-white overflow-hidden border-b border-slate-900">
  ...
  <div class="container relative z-10 text-left">
   <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10 backdrop-blur-md mb-12">
    ...
    <span class="text-white text-[10px] font-bold tracking-[0.4em] uppercase">Exclusive Synergy</span>
   </div>
  ...
  <div class="container space-y-16">
    ...
    <div class="space-y-12 animate-on-scroll">
     ...
     <div class="grid grid-cols-2 gap-px bg-slate-200 border border-slate-200">
      @foreach(['Investors', 'CXOs', 'Strategists', 'Founders'] as $net)
       <div class="px-10 py-6 bg-slate-50 text-[10px] font-bold uppercase tracking-[0.3em] text-slate-950 hover:bg-brand-primary hover:text-white transition-all duration-500 cursor-default">
        {{ $net }}
       </div>
      @endforeach
     </div>
    ...
    <div class="relative group">
     <div class="overflow-hidden border border-slate-200 shadow-2xl bg-slate-900">
      <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=2070&auto=format&fit=crop" 
        class=" transition-all duration-[2000ms] hover:scale-105 opacity-80 hover:opacity-100" 
   ...
   <div class="bg-slate-950 p-24 lg:p-32 relative overflow-hidden shadow-3xl">
    ...
    <div class="relative z-10 grid lg:grid-cols-2 gap-24 items-center">
     <div class="space-y-16">
      <div class="space-y-6">
       <span class="text-brand-accent text-[10px] font-bold uppercase tracking-[0.4em]">Proprietary Nodes</span>
       <h3 class="text-3xl md:text-7xl font-bold text-white uppercase tracking-tight leading-[0.9]">
      ...
      <div class="grid md:grid-cols-2 gap-1 bg-white/5 border border-white/10">
       ...
       <div class="p-10 bg-transparent border border-white/5 hover:bg-brand-primary transition-all duration-700 group flex items-center gap-8">
        <div class="w-12 h-12 bg-white/5 border border-white/10 flex items-center justify-center hover:bg-brand-primary-dark hover:border-brand-primary-dark transition-all">
         <i class="fa-solid fa-link text-xs text-brand-primary hover:text-white"></i>
        </div>
        <span class="text-[10px] font-bold uppercase text-white tracking-[0.2em] hover:text-slate-950 transition-colors">
         {{ $item }}
        </span>
       </div>
       @endforeach
     ...
     <div class="space-y-12">
      <div class="p-16 bg-white/5 border border-white/10 shadow-2xl relative overflow-hidden group hover:bg-brand-primary transition-all duration-700">
       ...
       <p class="text-4xl font-bold text-white mb-8 uppercase tracking-tight leading-[0.85] hover:text-brand-primary-dark transition-colors">
        5000+ Elite <br> <span class="text-brand-accent hover:text-white transition-colors">Members.</span>
       </p>
       <p class="text-slate-400 text-xl font-medium leading-relaxed hover:text-slate-900 transition-colors">
   ...
   <div class="relative bg-slate-900 p-24 lg:p-32 overflow-hidden group border-t border-slate-800">
    ...
    <div class="relative z-10 space-y-16 max-w-5xl">
     ...
     <a href="{{ route('register') }}" class="btn-sharp px-20 group">
      Acquire Elite Node Access 
      <i class="fa-solid fa-users ml-6 hover:translate-x-4 transition-transform"></i>
     </a>
    </div>
