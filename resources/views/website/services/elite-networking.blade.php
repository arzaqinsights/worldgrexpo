            ...
            <div class="space-y-20">
                ...
                <div class="grid md:grid-cols-3 gap-2">
                    ...
                    <div class="group relative h-[550px] overflow-hidden rounded-sm border border-slate-900">
                        <img src="{{ $eco['img'] }}" class="w-full h-full object-cover grayscale group-hover:grayscale-0 group-hover:scale-105 transition-all duration-1000" alt="Networking Node">
                        ...
                        <div class="absolute inset-0 p-12 flex flex-col justify-end">
                            <h4 class="text-3xl font-black text-brand-accent mb-4 uppercase italic tracking-tighter group-hover:text-white transition-colors">{{ $eco['t'] }}</h4>
                            <p class="text-slate-400 text-[10px] font-bold leading-relaxed uppercase tracking-widest group-hover:text-white transition-colors">{{ $eco['d'] }}</p>
                        </div>
                    ...
                    <div class="lg:w-1/2 space-y-12">
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            ...
                            <div class="p-8 bg-white/5 border border-white/10 rounded-sm hover:bg-brand-primary transition-all duration-700 group flex items-center gap-6">
                                ...
                                <span class="text-[10px] font-black uppercase text-white tracking-[0.2em] group-hover:text-slate-950 transition-colors">{{ $item }}</span>
                            </div>
                            @endforeach
                        </div>
                    </div>
