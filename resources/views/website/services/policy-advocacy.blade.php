 ...
 <section class="relative pt-40 pb-20 bg-slate-950 text-white overflow-hidden border-b border-slate-900">
  ...
  <div class="container relative z-10 text-left">
   <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10 backdrop-blur-md mb-12">
    ...
    <span class="text-white text-[10px] font-bold tracking-[0.4em] uppercase">Institutional Voice</span>
   </div>
     ...
     <div class="grid md:grid-cols-2 gap-6">
      <div class="p-8 bg-slate-50 rounded-2xl group hover:shadow-lg transition-all">
        <div class="w-16 h-16 bg-slate-50 border border-slate-100 flex items-center justify-center mb-8 hover:bg-brand-primary hover:border-brand-primary transition-all">
         <i class="fa-solid fa-user-shield text-brand-primary text-2xl hover:text-white transition-all"></i>
        </div>
        <p class="text-[10px] font-bold uppercase text-slate-950 tracking-[0.2em] hover:text-white transition-colors">Ministerial Node Access</p>
      </div>
      <div class="p-8 bg-slate-50 rounded-2xl group hover:shadow-lg transition-all">
        <div class="w-16 h-16 bg-slate-50 border border-slate-100 flex items-center justify-center mb-8 hover:bg-brand-primary hover:border-brand-primary transition-all">
         <i class="fa-solid fa-bell text-brand-primary text-2xl hover:text-white transition-all"></i>
        </div>
        <p class="text-[10px] font-bold uppercase text-slate-950 tracking-[0.2em] hover:text-white transition-colors">Regulatory Node Alerts</p>
      </div>
     </div>
    </div>
    ...
    <div class="relative z-10 space-y-12">
     ...
     <div class="max-w-4xl mx-auto pt-24 border-t border-white/10">
      <p class="text-3xl text-slate-300 font-medium leading-relaxed ">
       "Ensuring that global industrial nodes are seen not as metrics, but as the <span class="text-brand-primary not-">absolute engine</span> of the new economy."
      </p>
     </div>
    </div>
   </div>
   ...
   <div class="relative bg-slate-900 p-24 lg:p-32 overflow-hidden group border-t border-slate-800">
    ...
    <div class="relative z-10 space-y-16 max-w-5xl">
     ...
     <a href="{{ route('join.index') }}" class="btn-sharp px-20 group">
      ...
      <i class="fa-solid fa-flag ml-6 hover:translate-x-4 transition-transform"></i>
     </a>
    </div>
