    ...
    <div class="bg-slate-950 p-12 lg:p-16 flex flex-col justify-between space-y-16">
     <div class="space-y-12">
      ...
      <div class="space-y-10">
       ...
       <div class="space-y-2">
        <span class="block text-3xl font-bold text-white tracking-tight">{{ $stat['v'] }}</span>
        <div class="flex flex-col">
         <span class="text-[9px] font-bold uppercase tracking-[0.2em] text-brand-primary">{{ $stat['l'] }}</span>
