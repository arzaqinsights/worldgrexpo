...
@section('content')
    ...
    <section class="relative pt-64 pb-32 bg-slate-900 overflow-hidden">
        <div class="absolute inset-0 z-0">
            <div class="absolute inset-0 opacity-40 grayscale" 
                 style="background-image: url('{{ asset('images/home/chairman.jpg') }}'); background-size: cover; background-position: center top;"></div>
        ...
        <div class="container relative z-10">
            <div class="max-w-4xl space-y-10">
                ...
                <div class="flex items-center gap-8 border-l-4 border-brand-primary pl-8">
                    <div>
                        <h2 class="text-4xl font-black text-white uppercase tracking-tighter">Dr. Indrajit Ghosh</h2>
    ...
    <section class="section-padding bg-white relative overflow-hidden">
        <div class="container relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-px bg-slate-100 border border-slate-100">
                ...
                <div class="lg:col-span-2 bg-white p-12 lg:p-20 space-y-12 border-b lg:border-b-0 lg:border-r border-slate-100">
                    <div class="space-y-8">
                        <div class="flex items-center gap-4">
                            ...
                            <span class="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Strategic Mandate</span>
                        </div>
                        <h3 class="text-5xl font-black text-slate-900 leading-[1.1] uppercase tracking-tighter italic">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-12 pt-12 border-t border-slate-50">
                        <div class="space-y-6">
                            <h4 class="text-xs font-black uppercase tracking-widest text-slate-900">The Collective Vision</h4>
                        ...
                        <div class="space-y-6">
                            <h4 class="text-xs font-black uppercase tracking-widest text-slate-900">Industrial Legacy</h4>
                            <p class="text-slate-500 font-medium leading-relaxed">
                    ...
                    <div class="p-10 bg-slate-50 border border-slate-100 relative group overflow-hidden">
                        ...
                        <p class="text-xl text-slate-900 font-black uppercase tracking-tighter italic">
                ...
                <div class="bg-slate-950 p-12 lg:p-16 flex flex-col justify-between space-y-16">
                    <div class="space-y-12">
                        <div class="flex items-center gap-4">
                            ...
                            <span class="text-[9px] font-black uppercase tracking-[0.3em] text-brand-accent">Global Footprint</span>
                        </div>
                        ...
                        <div class="space-y-10">
                            ...
                            <div class="space-y-2">
                                <span class="block text-5xl font-black text-white tracking-tighter">{{ $stat['v'] }}</span>
                                <div class="flex flex-col">
                                    <span class="text-[9px] font-black uppercase tracking-[0.2em] text-brand-primary">{{ $stat['l'] }}</span>
                                    <span class="text-[8px] font-bold uppercase tracking-widest text-slate-500">{{ $stat['s'] }}</span>
                                </div>
                            </div>
                            @endforeach
                        </div>
                    ...
                    <div class="pt-12 border-t border-white/10">
                        <div class="space-y-4">
                            <h5 class="text-[10px] font-black text-white uppercase tracking-[0.3em]">Academic Honors</h5>
    ...
    <section class="py-24 bg-slate-50 border-b border-slate-100">
        <div class="container">
            <div class="max-w-4xl mx-auto text-center space-y-10">
                <h3 class="text-4xl font-black text-slate-900 uppercase tracking-tighter">Architect Your Future With Us.</h3>
                ...
                <div class="flex justify-center pt-6">
                    <a href="{{ route('register') }}" class="btn-sharp group">
                        Join the Global Network <i class="fa-solid fa-arrow-right ml-4 group-hover:translate-x-3 transition-transform"></i>
                    </a>
                </div>
            </div>
        </div>
