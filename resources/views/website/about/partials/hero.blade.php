<section class="relative pt-40 pb-20 bg-slate-950 text-white overflow-hidden border-b border-slate-900">
 ...
 <div class="absolute inset-0 z-0">
  ...
  <div class="absolute inset-0 opacity-10 mix-blend-overlay" style="background-image: url('https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=2070&auto=format&fit=crop'); background-size: cover; background-position: center;"></div>
 </div>
 ...
 <div class="container relative z-10 text-left animate-on-scroll">
  <div class="inline-flex items-center gap-3 px-4 py-2 bg-slate-950 border-l-4 border-brand-accent mb-10">
   <span class="text-white text-[10px] font-bold tracking-[0.4em] uppercase italic">Institutional Architecture</span>
  </div>
  
  <h1 class="text-4xl md:text-8xl font-bold text-white mb-8 tracking-tight uppercase italic leading-[0.85]">
