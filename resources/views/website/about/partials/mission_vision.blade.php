                ...
                <div class="space-y-12">
                    ...
                    <div class="space-y-10 pt-10 border-t border-slate-950/10">
                        ...
                        <div class="flex items-start gap-8 group/item">
                            ...
                            <div class="space-y-2">
                                <span class="block text-slate-950 font-black text-3xl uppercase tracking-tighter italic leading-none">{{ $item['t'] }}</span>
                                <span class="block text-slate-950/60 text-[10px] font-black uppercase tracking-[0.2em] leading-relaxed">{{ $item['d'] }}</span>
                            </div>
                        </div>
                        @endforeach
                    </div>
