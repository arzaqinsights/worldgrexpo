                    ...
                    <div class="space-y-10 pt-12 border-t border-brand-primary-dark/10">
                        ...
                        <div class="flex items-start gap-8 group/item">
                            <div class="w-14 h-14 bg-brand-primary-dark border border-brand-primary-dark flex items-center justify-center shrink-0 group-hover/item:bg-white transition-all duration-500">
                                <i class="fa-solid fa-{{ $item['i'] }} text-brand-accent group-hover/item:text-brand-primary text-lg"></i>
                            </div>
                            <div class="space-y-3">
                                <span class="block text-brand-primary-dark font-black text-3xl uppercase tracking-tighter leading-none">{{ $item['t'] }}</span>
                                <span class="block text-brand-primary-dark/60 text-[10px] font-black uppercase tracking-[0.3em] leading-relaxed">{{ $item['d'] }}</span>
                            </div>
                        </div>
                        @endforeach
                    </div>
