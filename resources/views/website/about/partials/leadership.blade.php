<section class="section-padding bg-white relative overflow-hidden">
    ...
    <div class="container relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="group relative rounded-[3rem] overflow-hidden bg-slate-50 border border-slate-100 shadow-xl transition-all duration-700 hover:-translate-y-4 hover:shadow-brand-primary/20 animate-on-scroll" style="transition-delay: {{ $leader['delay'] }}ms">
                <!-- Media Layer -->
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-10 space-y-4">
                        <div class="space-y-1">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-[9px] font-black text-brand-accent uppercase tracking-[0.2em] italic">{{ $leader['role'] }}</span>
                            </div>
                        </div>
                    </div>
                </div>
