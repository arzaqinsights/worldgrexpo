                    ...
                    <div class="space-y-10">
                        ...
                        <div class="space-y-6">
                            <div class="flex items-baseline gap-4">
                                <span class="text-5xl font-black text-brand-primary leading-none">{{ $p['l'] }}</span>
                                <h4 class="text-xl font-black text-slate-900 group-hover:text-white uppercase tracking-tighter transition-colors leading-none">{{ $p['t'] }}</h4>
                            </div>
                            <p class="text-[10px] font-black text-slate-400 group-hover:text-white/40 uppercase tracking-[0.2em] leading-relaxed transition-colors">{{ $p['d'] }}</p>
                        </div>
