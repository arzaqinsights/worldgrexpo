            ...
            <form action="{{ route('join.forms.store', $form->slug) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="pb-16 mb-16 border-b border-slate-200">
                    ...
                    <div class="mt-10">
                        ...
                        <textarea name="address" rows="3" required
                            class="w-full bg-white border border-slate-200 rounded-sm p-6 focus:border-brand-primary outline-none text-slate-950 font-medium italic uppercase text-xs transition-all shadow-sm resize-none">{{ old('address', auth()->check() ? auth()->user()->address : '') }}</textarea>
                    </div>
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10 border-l border-white/5 pl-12">
                            ...
                            <div class="space-y-2">
                                ...
                                <p class="text-xl font-black text-white italic uppercase tracking-tighter">{{ $site['bank_name'] ?? 'Contact Intelligence Node' }}
                                </p>
                            </div>
                            <div class="space-y-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <p class="text-xl font-black text-brand-accent font-mono tracking-widest italic">{{ $site['ifsc_code'] ?? 'N/A' }}</p>
                            </div>
                            @if(isset($site['swift_code']) && $site['swift_code'])
                                <div class="space-y-2">
                                    ...
                                    <p class="text-xl font-black text-brand-accent font-mono tracking-widest italic">{{ $site['swift_code'] }}</p>
                                </div>
                            @endif
                            @if(isset($site['bank_branch']) && $site['bank_branch'])
                                <div class="space-y-2 md:col-span-2">
                                    ...
                                    <p class="text-sm font-black text-slate-400 italic uppercase leading-relaxed">{{ $site['bank_branch'] }}</p>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="mt-12 p-8 bg-white/5 rounded-sm border border-white/10 flex gap-6 italic">
                            ...
                            <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-loose">
                                Post transition, distribute receipt intelligence to {{ $site['email_1'] ??
                ...
                <div class="mt-16 pt-12 border-t border-slate-100">
                    ...
                    <button type="submit" :disabled="loading"
                        ...
                        <span
                            x-text="loading ? 'Processing Intelligence...' : (isManualPayment ? 'Activate Institutional Node' : '{{ $form->submit_button_text }}')"></span>
