...
@section('content')
 ...
 <section class="relative pt-40 pb-20 bg-slate-950 overflow-hidden border-b border-slate-900">
  ...
  <div class="absolute inset-0 opacity-20">
   <img src="{{ asset('images/sectors/electric-mobility.jpg') }}" class="w-full h-full object-cover">
  </div>
  ...
  <div class="container relative z-10 text-center space-y-12">
   <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10">
    ...
    <span class="text-white text-[10px] font-bold tracking-[0.4em] uppercase">Sustainable Transport Protocol</span>
   </div>
  ...
  <div class="container space-y-20">
   ...
   <div class="grid lg:grid-cols-2 gap-6">
    <div class="p-8 lg:p-12 bg-white space-y-12">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">E-Mobility <br><span class="text-sky-600">Transformation.</span></h2>
     ...
     <div class="space-y-8 text-lg text-slate-600 leading-relaxed border-l-4 border-slate-200 pl-8">
      <p>
       <strong class="text-slate-900 font-bold ">Electric Mobility (E-Mobility)</strong> refers to the use of electrically powered transportation systems designed to reduce dependence on fossil fuels.
      </p>
      <p>
   ...
   <div class="grid lg:grid-cols-3 gap-6 shadow-sm">
    <div class="p-8 lg:p-12 bg-slate-950 text-white space-y-12 group relative overflow-hidden">
     ...
     <h4 class="text-2xl font-bold uppercase tracking-tight">Infrastructure</h4>
     <p class="text-[12px] font-bold uppercase text-slate-500 tracking-[0.1em] leading-relaxed group-hover:text-slate-300 transition-colors">Development of public and private EV charging networks.</p>
    </div>
    <div class="p-8 lg:p-12 bg-slate-950 text-white space-y-12 group relative overflow-hidden">
     <div class="absolute top-0 left-0 w-full h-1 bg-sky-600 scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-500"></div>
     <div class="w-16 h-16 bg-white/5 border border-white/10 flex items-center justify-center text-sky-400 group-hover:bg-sky-600 group-hover:text-slate-950 transition-all duration-500">
     ...
     <h4 class="text-2xl font-bold uppercase tracking-tight">Battery Swapping</h4>
     <p class="text-[12px] font-bold uppercase text-slate-500 tracking-[0.1em] leading-relaxed group-hover:text-slate-300 transition-colors">Next-gen energy replacement systems for high-utilization fleets.</p>
    </div>
    <div class="p-8 lg:p-12 bg-slate-950 text-white space-y-12 group relative overflow-hidden">
     <div class="absolute top-0 left-0 w-full h-1 bg-sky-600 scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-500"></div>
     <div class="w-16 h-16 bg-white/5 border border-white/10 flex items-center justify-center text-sky-400 group-hover:bg-sky-600 group-hover:text-slate-950 transition-all duration-500">
     ...
     <h4 class="text-2xl font-bold uppercase tracking-tight">Smart Platforms</h4>
     <p class="text-[12px] font-bold uppercase text-slate-500 tracking-[0.1em] leading-relaxed group-hover:text-slate-300 transition-colors">Integrated digital ecosystems for connected mobility.</p>
    </div>
   </div>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm overflow-hidden">
    ...
    <div class="p-8 lg:p-12 bg-slate-950 text-white relative overflow-hidden group">
     ...
     <div class="relative z-10 space-y-16">
      <div class="space-y-4">
       <div class="text-sky-400 text-[10px] font-bold uppercase tracking-[0.4em]">Global Opportunity</div>
      ...
      <div class="space-y-12">
       <div class="flex items-end justify-between border-b border-white/10 pb-8">
        ...
        <span class="text-4xl font-bold text-white tracking-tight ">$600B+</span>
       </div>
       <div class="flex items-end justify-between border-b border-white/10 pb-8">
        <span class="text-[10px] font-bold uppercase text-slate-500 tracking-[0.3em]">Projected (2035)</span>
        <span class="text-4xl font-bold text-white tracking-tight ">$1.5T+</span>
       </div>
      </div>
      ...
      <div class="space-y-8">
       ...
       <div class="grid grid-cols-2 gap-4">
        @foreach(['Rising Fuel Costs', 'EV Incentives', 'Battery Cost Reduction', 'Climate Regulations'] as $driver)
         <span class="px-8 py-6 bg-slate-950 text-[9px] font-bold text-slate-400 uppercase tracking-[0.2em] text-center hover:bg-sky-600 hover:text-slate-950 transition-colors cursor-default">{{ $driver }}</span>
        @endforeach
       </div>
      </div>
     </div>
     ...
     <div class="relative z-10 space-y-16 text-right">
      ...
      <div class="space-y-12">
       <div class="flex items-end justify-between border-b border-slate-100 pb-8">
        ...
        <span class="text-4xl font-bold text-slate-950 tracking-tight ">₹1L Cr</span>
       </div>
       <div class="flex items-end justify-between border-b border-slate-100 pb-8">
        <span class="text-[10px] font-bold uppercase text-slate-400 tracking-[0.3em]">Annual CAGR</span>
        <span class="text-4xl font-bold text-sky-600 tracking-tight ">25%</span>
       </div>
       <div class="p-12 bg-sky-50 border-l-8 border-sky-600 shadow-sm text-right">
        <p class="text-[9px] font-bold text-sky-600 uppercase tracking-[0.4em] mb-4">India Forecast (2031)</p>
        <p class="text-4xl font-bold text-slate-950 uppercase leading-tight tracking-tight">₹5 Lakh Crore+</p>
       </div>
      </div>
     </div>
    </div>
   ...
   <div class="space-y-12">
    <div class="text-center space-y-4">
     <span class="text-sky-600 text-[10px] font-bold uppercase tracking-[0.4em]">Vertical Specialization</span>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 shadow-sm">
     ...
     @foreach($ksegments as $ks)
      <div class="p-16 bg-white space-y-8 group hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
       ...
       <h4 class="text-2xl font-bold text-slate-950 group-hover:text-white transition-colors">{{ $ks['title'] }}</h4>
       <p class="text-[12px] font-bold uppercase text-slate-400 tracking-[0.1em] leading-relaxed group-hover:text-slate-300 transition-colors">{{ $ks['desc'] }}</p>
      </div>
     @endforeach
    </div>
   </div>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm">
    ...
    <div class="p-12 bg-slate-50 space-y-16 border-l border-slate-200 shadow-2xl">
     <h3 class="text-3xl font-bold uppercase text-slate-950 border-l-8 border-sky-600 pl-10 tracking-tight">Business Opportunities</h3>
     <div class="space-y-12">
      @foreach([
   ...
   <div class="grid lg:grid-cols-2 gap-32 items-center">
    ...
    <div class="p-8 lg:p-12 bg-slate-950 text-white space-y-16 relative overflow-hidden group shadow-sm border border-white/5">
     ...
     <div class="relative z-10 space-y-12">
      ...
      <h4 class="text-4xl font-bold text-sky-600">The Smart <br><span class="text-white">Transition.</span></h4>
