...
@section('content')
 ...
 <section class="relative pt-40 pb-20 bg-slate-950 overflow-hidden border-b border-slate-900">
  ...
  <div class="absolute inset-0 opacity-20">
   <img src="{{ asset('images/sectors/packaging-inks-hero.png') }}" class="w-full h-full object-cover">
  </div>
  ...
  <div class="container relative z-10 text-center space-y-12">
   <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10">
    ...
    <span class="text-white text-[10px] font-bold tracking-[0.4em] uppercase">Chromatic Engineering Protocol</span>
   </div>
   <h1 class="text-3xl md:text-5xl font-bold text-white leading-tight">
    Packaging <br>
    <span class="text-pink-600">Inks.</span>
   </h1>
   <p class="text-lg text-slate-400 max-w-4xl mx-auto leading-relaxed font-medium border-l-4 border-pink-600 pl-10 md:text-center mx-auto">
  ...
  <div class="container space-y-20">
   ...
   <div class="grid lg:grid-cols-2 gap-6">
    <div class="p-8 lg:p-12 bg-white space-y-12">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">Vibrant <br><span class="text-pink-600">Graphics.</span></h2>
     ...
     <div class="space-y-8 text-lg text-slate-600 leading-relaxed border-l-4 border-slate-200 pl-8">
      <p>
       <strong class="text-slate-900 font-bold ">Flexible Packaging Inks</strong> are specially formulated printing inks used for plastic films, laminates, and pouches.
      </p>
      <p>
    ...
    <div class="relative group">
     ...
     <div class="absolute top-0 right-0 p-8">
      <div class="bg-pink-600 text-white text-[10px] font-bold px-6 py-2 uppercase tracking-[0.3em] shadow-2xl">
       Aesthetic Integrity
      </div>
     </div>
    </div>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm overflow-hidden">
    ...
    <div class="p-8 lg:p-12 bg-slate-950 text-white relative overflow-hidden group">
     ...
     <div class="relative z-10 space-y-16">
      <div class="space-y-4">
       <div class="text-pink-400 text-[10px] font-bold uppercase tracking-[0.4em]">International Value</div>
      ...
      <div class="space-y-12">
       <div class="flex items-end justify-between border-b border-white/10 pb-8">
        ...
        <span class="text-4xl font-bold text-white tracking-tight ">$26 Billion</span>
       </div>
       <div class="flex items-end justify-between border-b border-white/10 pb-8">
        <span class="text-[10px] font-bold uppercase text-slate-500 tracking-[0.3em]">Projected (2033)</span>
        <span class="text-4xl font-bold text-pink-500 tracking-tight ">$35 Billion</span>
       </div>
      </div>

      <div class="grid grid-cols-2 gap-4">
       <div class="p-8 bg-slate-950 text-center space-y-2 group/item hover:bg-pink-600 transition-all duration-500">
        <p class="text-3xl font-bold group-hover:scale-110 transition-transform">3000+</p>
    ...
    <div class="p-8 lg:p-12 bg-white relative overflow-hidden group border-l border-slate-200">
     ...
     <div class="relative z-10 space-y-16 text-right">
      <div class="space-y-4">
       <div class="text-pink-600 text-[10px] font-bold uppercase tracking-[0.4em]">National Strategy</div>
      ...
      <div class="space-y-12">
       <div class="flex items-end justify-between border-b border-slate-100 pb-8">
        ...
        <span class="text-4xl font-bold text-slate-950 tracking-tight ">$1.5B+</span>
       </div>
       <div class="flex items-end justify-between border-b border-slate-100 pb-8">
        <span class="text-[10px] font-bold uppercase text-slate-400 tracking-[0.3em]">Projected CAGR</span>
        <span class="text-4xl font-bold text-pink-600 tracking-tight ">11%</span>
       </div>
       <div class="p-12 bg-pink-50 border-l-8 border-pink-600 shadow-sm text-right">
        <p class="text-[9px] font-bold text-pink-600 uppercase tracking-[0.4em] mb-4 ">Economic Status</p>
        <p class="text-3xl font-bold text-slate-950 uppercase leading-tight tracking-tight">#4 Global Rank</p>
       </div>
      </div>
     </div>
    </div>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm overflow-hidden">
    <div class="p-12 bg-slate-950 text-white space-y-16">
     <h3 class="text-3xl font-bold text-slate-900 text-pink-500 border-l-8 border-pink-600 pl-10">Strategic Verticals</h3>
   ...
   <div class="relative p-12 lg:p-32 bg-slate-950 overflow-hidden text-center shadow-sm group">
    ...
    <div class="relative z-10 space-y-16">
     ...
     <p class="text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed font-medium border-l-4 border-pink-600 pl-10 md:text-center mx-auto ">
