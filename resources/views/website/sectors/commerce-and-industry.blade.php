...
@section('content')
 ...
 <section class="relative pt-40 pb-20 bg-slate-950 overflow-hidden border-b border-slate-900">
  ...
  <div class="absolute inset-0 opacity-20">
   <img src="{{ asset('images/sectors/commerce-industry-hero.png') }}" class="w-full h-full object-cover">
  </div>
  ...
  <div class="container relative z-10 text-center space-y-12">
   <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10">
    ...
    <span class="text-white text-[10px] font-bold tracking-[0.4em] uppercase">Economic Integration Protocol</span>
   </div>
  ...
  <div class="container space-y-20">
   ...
   <div class="grid lg:grid-cols-2 gap-6">
    <div class="p-8 lg:p-12 bg-white space-y-12">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">Driving <br><span class="text-indigo-600">MSME Growth.</span></h2>
     ...
     <div class="space-y-8 text-lg text-slate-600 leading-relaxed border-l-4 border-slate-200 pl-8">
      <p>
       The <strong class="text-slate-900 font-bold ">Commerce & Industry</strong> sector of World Grexpo acts as a strategic bridge between businesses, government, and global markets.
      </p>
      <p>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm">
    ...
    <div class="p-8 lg:p-12 bg-slate-950 text-white space-y-16 relative overflow-hidden group">
     ...
     <div class="relative z-10 space-y-12">
      <div class="text-indigo-400 text-[10px] font-bold uppercase tracking-[0.4em]">Strategic Nodes</div>
      <h3 class="text-3xl font-bold text-slate-900 text-white leading-tight">Key Focus Areas</h3>
       ...
       @foreach([
        ...
        <div class="space-y-4 group/item">
         <div class="flex items-center gap-6">
          ...
          <span class="text-xl font-bold uppercase tracking-widest text-indigo-400 group-hover/item:text-white transition-colors duration-500 leading-tight">{{ $area['title'] }}</span>
         </div>
         <p class="text-[12px] font-bold uppercase text-slate-500 tracking-[0.1em] pl-8">{{ $area['desc'] }}</p>
        </div>
       @endforeach
      </div>
     </div>
    ...
    <!-- Services -->
    <div class="p-8 lg:p-12 bg-white space-y-16 border-l border-slate-200">
     <div class="section-heading text-left">
      <span class="subtitle">Operational Excellence</span>
      <h2 class="text-3xl font-bold text-slate-900">Key Services <br><span class="text-indigo-600">Offered.</span></h2>
      <div class="accent-line bg-indigo-600"></div>
     </div>
     
     <div class="grid grid-cols-1 gap-6 shadow-2xl">
      @foreach([
       ...
       <div class="flex items-center gap-8 p-10 bg-white group hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
        ...
        <span class="text-xl font-bold uppercase text-slate-900 group-hover:text-white tracking-[0.1em] leading-tight transition-colors">{{ $svc['label'] }}</span>
       </div>
      @endforeach
     </div>
    </div>
   ...
   <div class="p-12 lg:p-32 bg-slate-950 relative overflow-hidden group shadow-sm border border-white/5">
    ...
    <div class="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
     <div class="space-y-12">
      <h3 class="text-4xl font-bold text-indigo-600">Diverse Industries <br><span class="text-white">Covered.</span></h3>
      <p class="text-2xl text-slate-400 font-medium leading-relaxed border-l-8 border-indigo-600/30 pl-10 ">
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <p class="text-2xl font-bold text-indigo-400 group-hover/card:text-slate-950 ">Multi-Sector</p>
        <p class="text-[10px] text-slate-500 group-hover/card:text-slate-950/70">Ecosystem Integration</p>
        </div>
        <div class="p-10 bg-slate-950 text-center space-y-4 hover:bg-indigo-600 transition-all duration-500 group/card">
        <p class="text-2xl font-bold text-indigo-400 group-hover/card:text-slate-950 ">Make In India</p>
        <p class="text-[10px] text-slate-500 group-hover/card:text-slate-950/70">Self Reliant Economy</p>
        </div>
      </div>
     </div>
     <div class="grid grid-cols-2 gap-px bg-white/10 border border-white/10 shadow-sm">
      ...
      <div class="flex items-center gap-6 p-8 bg-slate-950 hover:bg-indigo-600 group/ind transition-all duration-500">
       ...
       <span class="text-[10px] font-bold uppercase text-indigo-100 group-hover/ind:text-slate-950 tracking-widest leading-tight">{{ $ind }}</span>
      </div>
      @endforeach
     </div>
    </div>
   ...
   <div class="grid lg:grid-cols-2 gap-32 items-center">
    <div class="space-y-16">
     <h2 class="text-4xl font-bold text-slate-900">Why Join <br><span class="text-indigo-600">This Platform?</span></h2>
     <div class="grid grid-cols-1 gap-6 shadow-sm">
      @foreach([
      ...
      <div class="flex items-center gap-10 p-12 bg-white group hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
       ...
       <span class="text-xl font-bold text-slate-700 group-hover:text-white uppercase tracking-widest leading-tight transition-colors ">{{ $i['title'] }}</span>
      </div>
      @endforeach
     </div>
    </div>

    <div class="p-8 lg:p-12 bg-indigo-50 border border-indigo-100 shadow-sm relative overflow-hidden group">
     ...
     <div class="relative z-10 text-center space-y-12">
      ...
      <h3 class="text-3xl font-bold text-slate-950 ">Accelerate Your Journey</h3>
      <p class="text-2xl text-slate-500 font-medium leading-relaxed border-l-8 border-indigo-600/30 pl-10 ">
