                            ...
                            <div class="grid grid-cols-2 gap-px bg-slate-200 border border-slate-200 shadow-sm">
                                @foreach(['Plastic Packaging', 'E-Waste', 'Battery Waste', 'Waste Tyres', 'Used Oil', 'Hazardous Waste'] as $stream)
                                    <div class="p-6 bg-white flex items-center gap-4 group/item hover:bg-slate-950 transition-all duration-500">
                                        ...
                                        <span class="text-[9px] font-black uppercase text-slate-600 group-hover/item:text-white tracking-[0.1em] leading-tight">{{ $stream }}</span>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="space-y-8">
                            @foreach([
                                ...
                                <div class="flex items-center gap-10 group/item">
                                    ...
                                    <span class="text-[14px] font-black uppercase text-slate-300 group-hover/item:text-white tracking-[0.2em] transition-colors italic">{{ $pos['label'] }}</span>
                                </div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        @foreach(['Germany', 'UK', 'USA', 'Japan'] as $market)
                            <div class="p-16 bg-slate-50 border border-slate-100 flex items-center justify-center group/item hover:bg-slate-950 transition-all duration-700 shadow-sm">
                                <span class="text-[12px] font-black uppercase text-slate-500 group-hover/item:text-white tracking-[0.3em] transition-colors italic">{{ $market }}</span>
                            </div>
                        @endforeach
