...
@section('content')
 ...
 <section class="relative pt-40 pb-20 bg-slate-950 overflow-hidden border-b border-slate-900">
  ...
  <div class="absolute inset-0 opacity-20">
   <img src="{{ asset('images/sectors/home-furnishing.webp') }}" class="w-full h-full object-cover">
  </div>
  ...
  <div class="container relative z-10 text-center space-y-12">
   <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10">
    ...
    <span class="text-white text-[10px] font-bold tracking-[0.4em] uppercase">Lifestyle Design Protocol</span>
   </div>
  ...
  <div class="container space-y-20">
   ...
   <div class="grid lg:grid-cols-2 gap-6">
    <div class="p-8 lg:p-12 bg-white space-y-12">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">Interior <br><span class="text-orange-600">Dynamics.</span></h2>
     ...
     <div class="space-y-8 text-lg text-slate-600 leading-relaxed border-l-4 border-slate-200 pl-8">
      <p>
       <strong class="text-slate-900 font-bold ">The Home Furnishing Industry</strong> encompasses the design and manufacturing of furniture, textiles, floor coverings, and decorative items for living spaces.
      </p>
      <p>
     ...
     <div class="relative z-10 space-y-16">
      ...
      <div class="space-y-12">
       <div class="flex items-end justify-between border-b border-white/10 pb-8">
        ...
        <span class="text-4xl font-bold text-white tracking-tight ">$700B+</span>
       </div>
       <div class="flex items-end justify-between border-b border-white/10 pb-8">
    ...
    <div class="p-8 lg:p-12 bg-white relative overflow-hidden group border-l border-slate-200">
     ...
     <div class="relative z-10 space-y-16 text-right">
      ...
      <div class="p-12 bg-orange-50 border-l-8 border-orange-600 shadow-sm text-right space-y-6">
       ...
       <p class="text-4xl font-bold text-slate-950 uppercase leading-tight tracking-tight">$40B+ Projected (2030)</p>
       <p class="text-[12px] font-bold text-slate-500 uppercase tracking-widest ">15-18% CAGR Expansion</p>
      </div>
   ...
   <div class="grid grid-cols-2 md:grid-cols-4 gap-6 shadow-sm">
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-orange-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110">15%+</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">India CAGR</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-orange-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">50%</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">Global Rugs Share</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-orange-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">10K+</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">Organized Brands</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-orange-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">TOP 3</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">Global Home Textile</p>
    </div>
   </div>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm overflow-hidden">
    <div class="relative overflow-hidden group">
     ...
     <div class="absolute top-0 left-0 p-12">
      <div class="bg-orange-600 text-white p-10 space-y-2 border-l-8 border-white/20 shadow-2xl">
       <p class="text-3xl font-bold tracking-tight uppercase ">Global #2</p>
       <p class="text-[10px] font-bold uppercase tracking-[0.3em] opacity-80">Home Textile Exporter</p>
      </div>
     </div>
    </div>
    ...
    <div class="p-12 bg-white space-y-16">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">Emerging <br><span class="text-orange-600">Trends.</span></h2>
      <div class="accent-line bg-orange-600"></div>
     </div>
