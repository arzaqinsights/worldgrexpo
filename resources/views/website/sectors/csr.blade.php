...
@section('content')
 ...
 <section class="relative pt-40 pb-20 bg-slate-950 overflow-hidden border-b border-slate-900">
  ...
  <div class="absolute inset-0 opacity-20">
   <img src="{{ asset('images/sectors/csr.jpg') }}" class="w-full h-full object-cover">
  </div>
 ...
 <section class="py-20 bg-white relative">
  <div class="container space-y-20">
   ...
   <div class="grid lg:grid-cols-2 gap-6">
    <div class="p-8 lg:p-12 bg-white space-y-12">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">What is <br><span class="text-rose-600">CSR?</span></h2>
     ...
     <div class="space-y-8 text-lg text-slate-600 leading-relaxed border-l-4 border-slate-200 pl-8">
      <p>
       <strong class="text-slate-900 font-bold ">Corporate Social Responsibility (CSR)</strong> refers to a company's commitment to operate ethically and contribute positively toward society, environment, and economic development.
      </p>
      <p>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm overflow-hidden">
    <div class="p-8 lg:p-12 bg-slate-950 text-white space-y-16 relative overflow-hidden group">
     <div class="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,rgba(225,29,72,0.05),transparent)]"></div>
     <div class="relative z-10 space-y-12">
      <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10 text-rose-400 text-[10px] font-bold uppercase tracking-[0.4em]">
       Strategic Value
      </div>
      <h3 class="text-4xl font-bold text-rose-600">Why CSR <br><span class="text-white">Matters.</span></h3>
      <p class="text-2xl text-slate-400 font-medium border-l-8 border-rose-600/30 pl-10 leading-relaxed ">
   ...
   <div class="grid grid-cols-2 md:grid-cols-4 gap-6 shadow-sm">
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-rose-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110">90%+</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">Fortune 500 CSR Reports</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-rose-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">$30T+</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">Global ESG Investment</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-rose-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">2%</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">India Mandatory Spend</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-rose-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">₹25K Cr+</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">India Annual Spend</p>
    </div>
   </div>

   <!-- Global vs India Landscape -->
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm">
    <div class="p-8 lg:p-12 bg-slate-950 text-white space-y-12 group relative overflow-hidden">
     <div class="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(225,29,72,0.05),transparent)]"></div>
     <div class="relative z-10 space-y-12">
      <h3 class="text-3xl font-bold text-slate-900 text-rose-600">Global Landscape</h3>
      <ul class="space-y-8">
       @foreach([
        ...
        <li class="flex items-start gap-8 group/item">
         ...
         <span class="text-xl font-bold uppercase tracking-widest text-slate-400 group-hover/item:text-white transition-colors leading-tight">{{ $item }}</span>
        </li>
       @endforeach
      </ul>
     </div>
    </div>
    <div class="p-8 lg:p-12 bg-white text-slate-950 space-y-12 group relative overflow-hidden border-l border-slate-200">
     <h3 class="text-3xl font-bold text-slate-900 text-rose-600">CSR in India</h3>
     <ul class="space-y-8">
      @foreach([
       ...
       <li class="flex items-start gap-8 group/item">
        <div class="w-2 h-2 bg-rose-600 mt-4 group-hover/item:scale-150 transition-transform"></div>
        <span class="text-xl font-bold uppercase tracking-widest text-slate-700 group-hover/item:text-slate-950 transition-colors leading-tight">{{ $item }}</span>
       </li>
      @endforeach
     </ul>
    </div>
   ...
   <div class="space-y-12">
    <div class="text-center space-y-4">
     <span class="text-rose-600 text-[10px] font-bold uppercase tracking-[0.4em]">Pillars of Impact</span>
     <h3 class="text-4xl font-bold text-slate-900">Key Focus Areas</h3>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 shadow-sm">
     ...
     <div class="p-16 bg-white space-y-12 group hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
      ...
      <h4 class="text-2xl font-bold text-slate-900 group-hover:text-white transition-colors">Social Development</h4>
      <ul class="space-y-4">
       @foreach(['Education & Skill Dev', 'Women Empowerment', 'Rural Development', 'Healthcare & Sanitation'] as $point)
        <li class="flex items-center gap-4 text-[10px] font-bold uppercase tracking-[0.2em] text-slate-500 group-hover:text-slate-400 transition-colors">
     ...
     <div class="p-16 bg-white space-y-12 group hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
      ...
      <h4 class="text-2xl font-bold text-slate-900 group-hover:text-white transition-colors">Environment</h4>
      <ul class="space-y-4">
     ...
     <div class="p-16 bg-white space-y-12 group hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
      ...
      <h4 class="text-2xl font-bold text-slate-900 group-hover:text-white transition-colors">Economic</h4>
      <ul class="space-y-4">
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm">
    <div class="p-8 lg:p-12 bg-white space-y-16">
     <h3 class="text-4xl font-bold uppercase text-slate-950 border-l-8 border-slate-950 pl-10 tracking-tight">Emerging Trends</h3>
     <div class="grid grid-cols-1 sm:grid-cols-2 gap-px bg-slate-100 border border-slate-100">
      @foreach([
       ...
       <div class="p-12 bg-white group/item hover:bg-slate-950 transition-all duration-500 relative overflow-hidden">
        ...
        <span class="text-[12px] font-bold uppercase text-slate-900 group-hover/item:text-white tracking-[0.2em] leading-tight transition-colors">{{ $trend['label'] }}</span>
       </div>
      @endforeach
     </div>
    </div>
    ...
    <div class="p-8 lg:p-12 bg-slate-50 space-y-16 border-l border-slate-200">
     <h3 class="text-4xl font-bold uppercase text-slate-950 border-l-8 border-rose-600 pl-10 tracking-tight">CSR Opportunities</h3>
     <div class="space-y-12">
      @foreach([
      ...
      <div class="flex items-center gap-10 group/opp">
       ...
       <span class="text-xl font-bold uppercase text-slate-700 tracking-[0.15em] group-hover/opp:text-slate-950 transition-colors leading-tight ">{{ $opp['label'] }}</span>
      </div>
      @endforeach
     </div>
    </div>
   ...
   <div class="grid lg:grid-cols-2 gap-32 items-center">
    ...
    <div class="p-8 lg:p-12 bg-slate-950 text-white space-y-16 relative overflow-hidden group shadow-sm">
     ...
     <div class="relative z-10 space-y-12">
      ...
      <h3 class="text-4xl font-bold text-rose-600">The Future <br><span class="text-white">of CSR.</span></h3>
      <p class="text-2xl text-slate-400 font-medium border-l-8 border-rose-600/30 pl-10 leading-relaxed ">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-px bg-white/5 pt-12">
        ...
        <div class="p-8 bg-slate-950 border border-white/5 flex items-center gap-8 group/item hover:bg-rose-600 transition-all duration-500">
         ...
         <span class="text-[12px] font-bold uppercase text-slate-300 group-hover/item:text-slate-950 tracking-[0.2em] transition-colors leading-tight">{{ $fut['label'] }}</span>
        </div>
        @endforeach
      </div>
     </div>
