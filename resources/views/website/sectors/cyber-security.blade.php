...
@section('content')
 ...
 <section class="relative pt-40 pb-20 bg-slate-950 overflow-hidden border-b border-slate-900">
  ...
  <div class="absolute inset-0 opacity-20">
   <img src="{{ asset('images/sectors/cyber-security.jpg') }}" class="w-full h-full object-cover">
  </div>
  ...
  <div class="container relative z-10 text-center space-y-12">
   <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10">
    ...
    <span class="text-white text-[10px] font-bold tracking-[0.4em] uppercase">Digital Defense Infrastructure</span>
   </div>
  ...
  <div class="container space-y-20">
   ...
   <div class="grid lg:grid-cols-2 gap-6">
    <div class="p-8 lg:p-12 bg-white space-y-12">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">Safeguarding <br><span class="text-cyan-600">Digital Assets.</span></h2>
     ...
     <div class="space-y-8 text-lg text-slate-600 leading-relaxed border-l-4 border-slate-200 pl-8">
      <p>
       In today's digital-first economy, <strong class="text-slate-900 font-bold ">Cyber Security</strong> has become one of the most critical industries globally, safeguarding organizations, governments, and individuals.
      </p>
      <p>
    ...
    <div class="grid grid-cols-2 gap-px bg-slate-200 shadow-sm">
     ...
     @foreach($protected as $p)
      <div class="p-16 bg-slate-50 rounded-2xl p-8 flex flex-col items-center text-center group hover:shadow-lg transition-all">
       ...
       <p class="text-[10px] font-bold uppercase tracking-[0.3em] text-slate-400 group-hover:text-white transition-colors">{{ $p['label'] }}</p>
      </div>
     @endforeach
    </div>
   </div>
   ...
   <div class="p-12 lg:p-32 bg-slate-950 relative overflow-hidden group shadow-sm border border-white/5">
    ...
    <div class="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
     <div class="space-y-12">
      <div class="space-y-4">
       <span class="text-cyan-400 text-[10px] font-bold uppercase tracking-[0.4em]">International Market Dynamics</span>
       <h3 class="text-4xl font-bold text-white ">Global Landscape</h3>
      </div>
      <p class="text-2xl text-slate-400 font-medium leading-relaxed border-l-8 border-cyan-600/30 pl-10 ">
      ...
      <div class="grid grid-cols-2 gap-px bg-white/10 border border-white/10 shadow-sm">
       <div class="p-12 bg-slate-950 space-y-4 group/stat hover:bg-cyan-600 transition-all duration-500">
        ...
        <p class="text-4xl font-bold text-white group-hover/stat:text-slate-950 tracking-tight">$250B+</p>
       </div>
       <div class="p-12 bg-slate-950 space-y-4 group/stat hover:bg-cyan-600 transition-all duration-500">
        <p class="text-[10px] font-bold uppercase text-slate-500 group-hover/stat:text-slate-950/70 tracking-[0.3em]">Projected (2031)</p>
        <p class="text-4xl font-bold text-cyan-400 group-hover/stat:text-slate-950 tracking-tight">$500B+</p>
       </div>
      </div>
     </div>
     <div class="space-y-10">
      <h4 class="text-[10px] font-bold uppercase tracking-[0.4em] text-cyan-400">Primary Growth Drivers</h4>
   ...
   <div class="grid lg:grid-cols-2 gap-32 items-center">
    <div class="order-2 lg:order-1 grid grid-cols-2 gap-6 shadow-sm">
     <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all relative overflow-hidden">
      ...
      <h4 class="text-3xl font-bold text-slate-950 group-hover:text-white transition-colors tracking-tight ">$8 - 10B</h4>
     </div>
     <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all relative overflow-hidden">
       <div class="absolute top-0 left-0 w-1 h-full bg-cyan-600 scale-y-0 group-hover:scale-y-100 transition-transform origin-top duration-500"></div>
      <p class="text-[10px] font-bold uppercase text-slate-400 tracking-[0.4em] mb-4">Growth Rate</p>
      <h4 class="text-3xl font-bold text-cyan-600 group-hover:text-cyan-400 transition-colors tracking-tight ">20% CAGR</h4>
     </div>
     <div class="col-span-2 p-8 lg:p-12 bg-slate-950 text-white space-y-12 relative overflow-hidden group">
      ...
      <div class="flex items-center justify-between">
       <span class="text-[10px] font-bold uppercase tracking-[0.4em] text-cyan-400">Total Startups</span>
       <span class="text-4xl font-bold tracking-tight">3,500+</span>
      </div>
      ...
      <p class="text-[10px] text-slate-500 uppercase font-bold tracking-[0.4em] text-center">BENGALURU • HYDERABAD • PUNE • NCR</p>
     </div>
    </div>
    ...
    <div class="order-1 lg:order-2 space-y-16">
     <div class="section-heading text-left">
      ...
      <h2 class="text-4xl font-bold ">India Cyber <br><span class="text-cyan-600">Ecosystem.</span></h2>
      <div class="accent-line bg-cyan-600"></div>
     </div>
     ...
     <div class="space-y-px bg-slate-200 border border-slate-200 shadow-sm">
      ...
      <div class="flex items-center gap-10 p-10 bg-white group hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
       ...
       <span class="text-[14px] font-bold uppercase text-slate-700 group-hover:text-white tracking-[0.2em] transition-colors leading-tight ">{{ $cat }}</span>
      </div>
      @endforeach
     </div>
    </div>
   ...
   <div class="space-y-12">
    <div class="text-center space-y-4">
     <span class="text-cyan-600 text-[10px] font-bold uppercase tracking-[0.4em]">Vertical Specialization</span>
     <h3 class="text-4xl font-bold text-slate-900">High-Growth Segments</h3>
    </div>
   ...
   <div class="grid lg:grid-cols-2 gap-32 items-center">
    <div class="space-y-16">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">Strategic <br><span class="text-cyan-600">Importance.</span></h2>
      <div class="accent-line bg-cyan-600"></div>
     </div>
     <div class="space-y-px bg-slate-200 border border-slate-200 shadow-sm">
      @foreach([
    ...
    <div class="p-8 lg:p-12 bg-slate-950 text-white space-y-16 relative overflow-hidden group shadow-sm border border-white/5">
     ...
     <div class="relative z-10 space-y-12">
      ...
      <h4 class="text-4xl font-bold text-cyan-600">Building <br><span class="text-white">The Shield.</span></h4>
      <p class="text-2xl text-slate-400 font-medium border-l-8 border-cyan-600/30 pl-10 leading-relaxed ">
      ...
      <div class="grid grid-cols-2 gap-px bg-white/5 pt-12 border border-white/10 shadow-2xl">
        ...
        <span class="p-8 bg-slate-950 border border-white/5 text-[10px] font-bold uppercase tracking-[0.4em] text-cyan-400 text-center hover:bg-cyan-600 hover:text-slate-950 transition-all cursor-default">{{ $tag }}</span>
        @endforeach
      </div>
     </div>
    </div>
