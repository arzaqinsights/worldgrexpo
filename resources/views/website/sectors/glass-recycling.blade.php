...
@section('content')
 ...
 <section class="relative pt-40 pb-20 bg-slate-950 overflow-hidden border-b border-slate-900">
  ...
  <div class="absolute inset-0 opacity-20">
   <img src="{{ asset('images/sectors/glass-recycling.jpg') }}" class="w-full h-full object-cover">
  </div>
  ...
  <div class="container relative z-10 text-center space-y-12">
   <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10">
    ...
    <span class="text-white text-[10px] font-bold tracking-[0.4em] uppercase">Infinite Loop Protocol</span>
   </div>
  ...
  <div class="container space-y-20">
   ...
   <div class="grid lg:grid-cols-2 gap-6">
    <div class="p-8 lg:p-12 bg-white space-y-12">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">Infinitely <br><span class="text-cyan-600">Reusable.</span></h2>
     ...
     <div class="space-y-8 text-lg text-slate-600 leading-relaxed border-l-4 border-slate-200 pl-8">
      <p>
       <strong class="text-slate-900 font-bold ">Glass Recycling</strong> is the process of collecting, sorting, crushing, cleaning, and re-melting waste glass into reusable raw material.
      </p>
      <p>
    ...
    <div class="grid grid-cols-1 gap-px bg-slate-200">
     <div class="p-12 bg-white space-y-8">
      <h4 class="text-[10px] font-bold uppercase tracking-[0.3em] text-slate-400">Recycling Process</h4>
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
       ...
       @foreach($process as $step)
        <div class="p-8 bg-white text-center group hover:bg-slate-950 transition-all duration-500">
         ...
         <p class="text-[8px] font-bold uppercase tracking-widest text-slate-500 group-hover:text-white">{{ $step['label'] }}</p>
        </div>
       @endforeach
      </div>
     </div>
     <div class="relative group h-full">
      ...
      <div class="relative h-full overflow-hidden border-t border-slate-200 shadow-sm">
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm overflow-hidden">
    ...
    <div class="p-8 lg:p-12 bg-slate-950 text-white relative overflow-hidden group">
     ...
     <div class="relative z-10 space-y-16">
      <div class="space-y-4">
       <div class="text-cyan-400 text-[10px] font-bold uppercase tracking-[0.4em]">Global Investment</div>
      ...
      <div class="space-y-12">
       <div class="flex items-end justify-between border-b border-white/10 pb-8">
        ...
        <span class="text-4xl font-bold text-white tracking-tight ">$5.4B</span>
       </div>
       <div class="flex items-end justify-between border-b border-white/10 pb-8">
        <span class="text-[10px] font-bold uppercase text-slate-500 tracking-[0.3em]">Projected (2033)</span>
        <span class="text-4xl font-bold text-white tracking-tight ">$8.4B</span>
       </div>
      </div>
    ...
    <div class="p-8 lg:p-12 bg-white relative overflow-hidden group border-l border-slate-200">
     ...
     <div class="relative z-10 space-y-16 text-right">
      ...
      <div class="p-12 bg-cyan-50 border-l-8 border-cyan-600 shadow-sm text-right space-y-6">
       <p class="text-[9px] font-bold text-cyan-600 uppercase tracking-[0.4em] ">Market Value</p>
       <p class="text-4xl font-bold text-slate-950 uppercase leading-tight tracking-tight">₹8,000 Crore+ Target</p>
       <p class="text-[12px] font-bold text-slate-500 uppercase tracking-widest ">7–9% Annual CAGR</p>
      </div>
   ...
   <div class="grid grid-cols-2 md:grid-cols-4 gap-6 shadow-sm">
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-cyan-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110">$5.4B</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">Global Market (2025)</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-cyan-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">₹5K Cr+</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">India Market (2025)</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-cyan-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">1,200+</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">India Recyclers</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-cyan-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">7-9%</h4>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm overflow-hidden">
    ...
    <div class="p-12 bg-slate-950 text-white space-y-12 relative overflow-hidden group border-l border-slate-200 text-center flex flex-col justify-center items-center">
     ...
     <div class="relative z-10 space-y-10">
      ...
      <h4 class="text-3xl font-bold uppercase text-white tracking-tight leading-tight">Bottle-to-Bottle</h4>
      <p class="text-2xl text-slate-400 font-medium max-w-sm mx-auto ">
       High potential segments in <span class="text-white font-bold tracking-tight">Construction & Packaging</span> sectors.
      </p>
     </div>
    </div>
   </div>
