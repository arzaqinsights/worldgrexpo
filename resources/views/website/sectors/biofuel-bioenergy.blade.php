...
@section('content')
 ...
 <section class="relative pt-40 pb-20 bg-slate-950 overflow-hidden border-b border-slate-900">
  ...
  <div class="absolute inset-0 opacity-20">
   <img src="{{ asset('images/sectors/biofuel.jpeg') }}" class="w-full h-full object-cover">
  </div>
  ...
  <div class="container relative z-10 text-center space-y-12">
   <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10">
    ...
    <span class="text-white text-[10px] font-bold tracking-[0.4em] uppercase">Sustainable Energy Architecture</span>
   </div>
   <h1 class="text-3xl md:text-5xl font-bold text-white leading-tight">
    Biofuel & <br>
    <span class="text-brand-primary">Bio Energy.</span>
   </h1>
   <p class="text-lg text-slate-400 max-w-4xl mx-auto leading-relaxed font-medium border-l-4 border-brand-primary pl-10 md:text-center mx-auto uppercase tracking-widest ">
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm">
    <div class="p-8 lg:p-12 bg-white space-y-12">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">Sustainable Energy <br><span class="text-brand-primary">Solutions.</span></h2>
      <div class="accent-line"></div>
     </div>
     
     <div class="space-y-8 text-lg text-slate-600 leading-relaxed border-l-4 border-slate-200 pl-8">
      <p>
       <strong class="text-slate-900 font-bold ">Biofuel and Bio Energy</strong> refer to renewable energy sources derived from biological materials such as agricultural residue, biomass, vegetable oils, and organic waste.
      </p>
      <p>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm">
    ...
    <div class="p-8 lg:p-12 bg-slate-950 relative overflow-hidden group">
     ...
     <div class="relative z-10 space-y-16">
      <div class="space-y-4">
       <div class="text-brand-primary text-[10px] font-bold uppercase tracking-[0.4em]">Global Scale</div>
       <h3 class="text-3xl font-bold text-white ">Global Market</h3>
      </div>
      
      <div class="space-y-12">
       <div class="flex items-end justify-between border-b border-white/10 pb-8">
        <span class="text-[10px] font-bold uppercase text-slate-500 tracking-[0.3em]">Biofuel Market (2025)</span>
        <span class="text-4xl font-bold text-white tracking-tight ">$180 Billion+</span>
       </div>
       <div class="flex items-end justify-between border-b border-white/10 pb-8">
        <span class="text-[10px] font-bold uppercase text-slate-500 tracking-[0.3em]">Bioenergy Market</span>
        <span class="text-4xl font-bold text-white tracking-tight ">$350 Billion+</span>
       </div>
       <div class="flex items-end justify-between">
        <span class="text-[10px] font-bold uppercase text-slate-500 tracking-[0.3em]">Annual CAGR</span>
        <span class="text-4xl font-bold text-brand-primary tracking-tight ">10%</span>
       </div>
      </div>
      ...
      <div class="space-y-8">
       ...
       <div class="grid grid-cols-2 gap-px bg-white/10 border border-white/10">
        @foreach(['Carbon Neutrality', 'Blending Mandates', 'Clean Energy Demand', 'SAF'] as $driver)
         <span class="px-8 py-6 bg-slate-950 text-[9px] font-bold text-slate-300 uppercase tracking-[0.2em] text-center hover:bg-brand-primary hover:text-slate-950 transition-colors cursor-default">{{ $driver }}</span>
        @endforeach
       </div>
      </div>
     </div>
    ...
    <div class="p-8 lg:p-12 bg-white relative overflow-hidden group border-l border-slate-200">
     ...
     <div class="relative z-10 space-y-16">
      <div class="space-y-4">
       <div class="text-brand-primary text-[10px] font-bold uppercase tracking-[0.4em]">National Momentum</div>
       <h3 class="text-3xl font-bold text-slate-950 ">Indian Market</h3>
      </div>
      
      <div class="grid grid-cols-2 gap-6 shadow-sm mb-12">
       <div class="bg-white p-12">
        <p class="text-[9px] text-slate-400 uppercase font-bold tracking-[0.4em] mb-4">Market value (2025)</p>
        <p class="text-3xl font-bold text-slate-950 uppercase tracking-tight">₹60K Cr+</p>
       </div>
       <div class="bg-white p-12">
        <p class="text-[9px] text-slate-400 uppercase font-bold tracking-[0.4em] mb-4">Target by 2031</p>
        <p class="text-3xl font-bold text-slate-950 uppercase tracking-tight">₹1.5L Cr+</p>
       </div>
      </div>
      ...
      <div class="space-y-px bg-slate-200 border border-slate-200">
       <div class="flex items-center justify-between p-10 bg-white group/stat">
        <span class="text-[10px] font-bold text-slate-400 uppercase tracking-[0.3em] group-hover/stat:text-brand-primary transition-colors">Ethanol Blending Target</span>
        <span class="text-2xl font-bold text-brand-primary uppercase ">20%+</span>
       </div>
       <div class="flex items-center justify-between p-10 bg-white group/stat">
        <span class="text-[10px] font-bold text-slate-400 uppercase tracking-[0.3em] group-hover/stat:text-slate-950 transition-colors">Projected CAGR</span>
        <span class="text-2xl font-bold text-slate-950 uppercase ">15-20%</span>
       </div>
      </div>
     </div>
    </div>
    ...
    <div class="group p-16 bg-white text-center hover:bg-slate-950 transition-all duration-700">
     <div class="mb-4 text-slate-950 text-3xl font-bold group-hover:text-brand-primary transition-all duration-500 tracking-tight">$180B</div>
     <div class="text-[10px] font-bold text-slate-400 uppercase tracking-[0.3em]">Global Biofuel</div>
    </div>
    <div class="group p-16 bg-white text-center hover:bg-slate-950 transition-all duration-700">
     <div class="mb-4 text-slate-950 text-3xl font-bold group-hover:text-brand-primary transition-all duration-500 tracking-tight">700+</div>
     <div class="text-[10px] font-bold text-slate-400 uppercase tracking-[0.3em]">Ethanol Plants</div>
    </div>
    <div class="group p-16 bg-white text-center hover:bg-slate-950 transition-all duration-700">
     <div class="mb-4 text-slate-950 text-3xl font-bold group-hover:text-brand-primary transition-all duration-500 tracking-tight">15-20%</div>
     <div class="text-[10px] font-bold text-slate-400 uppercase tracking-[0.3em]">India CAGR</div>
    </div>
    <div class="group p-16 bg-white text-center hover:bg-slate-950 transition-all duration-700">
     <div class="mb-4 text-slate-950 text-3xl font-bold group-hover:text-brand-primary transition-all duration-500 tracking-tight">TOP HUB</div>
     <div class="text-[10px] font-bold text-slate-400 uppercase tracking-[0.3em]">Energy Security</div>
    </div>
   </div>
   ...
   <div class="grid lg:grid-cols-2 gap-32 items-center">
    <div class="space-y-16">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">High Potential <br><span class="text-brand-primary">Segments.</span></h2>
      <div class="accent-line"></div>
     </div>
    ...
    <div class="p-8 lg:p-12 bg-slate-950 text-white space-y-16 relative overflow-hidden group shadow-sm">
     ...
     <div class="relative z-10 space-y-12">
      ...
      <h3 class="text-3xl font-bold text-slate-900 text-brand-primary">Emerging Trends <br><span class="text-white">(2026–2031)</span></h3>
      <div class="space-y-10">
       ...
       <div class="flex items-start gap-10 group/item">
        ...
        <p class="text-xl font-bold uppercase tracking-widest text-slate-400 group-hover/item:text-white transition-colors duration-500 leading-tight">{{ $trend }}</p>
       </div>
       @endforeach
      </div>
     </div>
