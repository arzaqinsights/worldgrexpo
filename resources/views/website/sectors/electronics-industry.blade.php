...
@section('content')
    ...
    <section class="relative pt-64 pb-32 bg-slate-950 overflow-hidden border-b border-slate-900">
        ...
        <div class="absolute inset-0 opacity-20">
            <img src="{{ asset('images/sectors/electronics-industry.jpg') }}" class="w-full h-full object-cover grayscale">
        </div>
        ...
        <div class="container relative z-10 text-center space-y-12">
            <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10">
                ...
                <span class="text-white text-[10px] font-black tracking-[0.4em] uppercase">Digital Infrastructure Protocol</span>
            </div>
        ...
        <div class="container space-y-48">
            ...
            <div class="grid lg:grid-cols-2 gap-px bg-slate-200 border border-slate-200">
                <div class="p-16 lg:p-24 bg-white space-y-12">
                    <div class="section-heading text-left">
                        ...
                        <h2 class="text-5xl font-black uppercase tracking-tighter italic">Silicon <br><span class="text-blue-600">Innovation.</span></h2>
                        <div class="accent-line bg-blue-600"></div>
                    </div>
                    
                    <div class="space-y-8 text-2xl text-slate-500 font-medium leading-relaxed italic border-l-4 border-slate-100 pl-10">
                        <p>
                            The <strong class="text-slate-900 font-black uppercase tracking-tight">Electronics industry</strong> is one of the most transformative sectors, driving technological advancement, digital connectivity, and modern lifestyle convenience.
                        </p>
                        <p>
            ...
            <div class="p-24 lg:p-32 bg-slate-950 relative overflow-hidden group shadow-3xl border border-white/5">
                ...
                <div class="relative z-10 grid lg:grid-cols-2 gap-24 items-center">
                    <div class="space-y-12">
                        <div class="space-y-4">
                            <span class="text-blue-400 text-[10px] font-black uppercase tracking-[0.4em]">International Market Dynamics</span>
                            <h3 class="text-6xl font-black text-white uppercase tracking-tighter italic">Global Landscape</h3>
                        </div>
                        <p class="text-2xl text-slate-400 font-medium leading-relaxed italic border-l-8 border-blue-600/30 pl-10 uppercase tracking-tighter">
                        ...
                        <div class="grid grid-cols-2 gap-px bg-white/10 border border-white/10 shadow-3xl">
                            <div class="p-12 bg-slate-950 space-y-4 group/stat hover:bg-blue-600 transition-all duration-500">
                                ...
                                <p class="text-6xl font-black text-white group-hover/stat:text-slate-950 italic tracking-tighter">$5T+</p>
                            </div>
                            <div class="p-12 bg-slate-950 space-y-4 group/stat hover:bg-blue-600 transition-all duration-500">
                                <p class="text-[10px] font-black uppercase text-slate-500 group-hover/stat:text-slate-950/70 tracking-[0.3em]">Projected (2031)</p>
                                <p class="text-6xl font-black text-blue-400 group-hover/stat:text-slate-950 italic tracking-tighter">$8T+</p>
                            </div>
                        </div>
                    </div>
                    <div class="space-y-10">
                        <h4 class="text-[10px] font-black uppercase tracking-[0.4em] text-blue-400">Primary Growth Drivers</h4>
                        ...
                        <div class="p-10 bg-blue-600/10 border border-blue-600/20 text-center">
                             <p class="text-sm font-black uppercase tracking-[0.3em] text-blue-100 italic">9% Expected Annual CAGR</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-32 items-center">
                <div class="order-2 lg:order-1 grid grid-cols-2 gap-px bg-slate-200 border border-slate-200 shadow-3xl">
                    <div class="p-16 bg-white text-center group hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
                        ...
                        <h4 class="text-5xl font-black text-slate-950 group-hover:text-white transition-colors tracking-tighter italic">$180B+</h4>
                    </div>
                    <div class="p-16 bg-white text-center group hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
                         <div class="absolute top-0 left-0 w-1 h-full bg-blue-600 scale-y-0 group-hover:scale-y-100 transition-transform origin-top duration-500"></div>
                        <p class="text-[10px] font-black uppercase text-slate-400 tracking-[0.4em] mb-4">Projected (2031)</p>
                        <h4 class="text-5xl font-black text-blue-600 group-hover:text-blue-400 transition-colors tracking-tighter italic">$400B+</h4>
                    </div>
                    <div class="col-span-2 p-16 lg:p-24 bg-slate-950 text-white space-y-12 relative overflow-hidden group">
                        ...
                        <div class="flex items-center justify-between">
                            <span class="text-[10px] font-black uppercase tracking-[0.4em] text-blue-400">Growth Catalysts</span>
                        </div>
                        <div class="grid grid-cols-2 gap-px bg-white/5 border border-white/10 shadow-2xl">
                            @foreach(['Make in India & PLI', 'Semiconductor Mission', 'Smartphone Demand', 'Digital Economy'] as $cat)
                                <div class="p-8 bg-slate-950 border border-white/5 text-[10px] font-black uppercase tracking-[0.2em] text-slate-300 text-center hover:bg-blue-600 hover:text-slate-950 transition-all">{{ $cat }}</div>
                            @endforeach
                        </div>
                        <p class="text-[10px] text-slate-500 uppercase font-black tracking-[0.4em] text-center italic">India anticipates 16% CAGR by 2031</p>
                    </div>
                </div>
                ...
                <div class="order-1 lg:order-2 space-y-16">
                    <div class="section-heading text-left">
                        ...
                        <h2 class="text-6xl font-black uppercase tracking-tighter italic">India's Industrial <br><span class="text-blue-600">Ascension.</span></h2>
                        <div class="accent-line bg-blue-600"></div>
                    </div>
            ...
            <div class="space-y-24">
                <div class="text-center space-y-4">
                    <span class="text-blue-600 text-[10px] font-black uppercase tracking-[0.4em]">Vertical Specialization</span>
            ...
            <div class="grid lg:grid-cols-2 gap-32 items-center">
                <div class="space-y-16">
                    <div class="section-heading text-left">
                        ...
                        <h2 class="text-5xl font-black uppercase tracking-tighter italic">Why Electronics <br><span class="text-blue-600">Matter.</span></h2>
                        <div class="accent-line bg-blue-600"></div>
                    </div>
                    <div class="space-y-px bg-slate-200 border border-slate-200 shadow-3xl">
                        @foreach([
                ...
                <div class="p-16 lg:p-24 bg-slate-950 text-white space-y-16 relative overflow-hidden group shadow-3xl border border-white/5">
                    ...
                    <div class="relative z-10 space-y-12">
                        ...
                        <h4 class="text-6xl font-black uppercase tracking-tighter italic text-blue-600">The Road <br><span class="text-white">Ahead.</span></h4>
