                        ...
                        <div class="bg-slate-50 border border-slate-100 rounded-sm overflow-hidden group-hover:bg-slate-950 transition-all duration-700 h-full flex flex-col relative shadow-sm">
                            ...
                            <div class="relative w-full h-[400px] overflow-hidden border-b border-slate-200 group-hover:border-slate-800">
                                ...
                                <div class="absolute bottom-8 left-8 right-8">
                                    <h3 class="text-2xl font-black text-white uppercase italic tracking-tighter group-hover:text-brand-accent transition-colors drop-shadow-2xl">{{ $sector['title'] }}</h3>
                                </div>
                            </div>

                            <div class="p-10 flex-1 flex flex-col">
                                <p class="text-[10px] font-black text-slate-500 uppercase tracking-[0.3em] leading-relaxed mb-10 group-hover:text-slate-400 transition-colors">{{ Str::limit($sector['description'], 120) }}</p>
