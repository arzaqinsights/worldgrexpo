...
@section('content')
 ...
 <section class="relative pt-40 pb-20 bg-slate-950 overflow-hidden border-b border-slate-900">
  ...
  <div class="absolute inset-0 opacity-20">
   <img src="{{ asset('images/sectors/handicraft.webp') }}" class="w-full h-full object-cover">
  </div>
  ...
  <div class="container relative z-10 text-center space-y-12">
   <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10">
    ...
    <span class="text-white text-[10px] font-bold tracking-[0.4em] uppercase">Artisan Legacy Protocol</span>
   </div>
  ...
  <div class="container space-y-20">
   ...
   <div class="grid lg:grid-cols-2 gap-6">
    <div class="p-8 lg:p-12 bg-white space-y-12">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">Legacy of <br><span class="text-blue-600">Artistry.</span></h2>
     ...
     <div class="space-y-8 text-lg text-slate-600 leading-relaxed border-l-4 border-slate-200 pl-8">
      <p>
       <strong class="text-slate-900 font-bold ">The Handicraft Industry</strong> involves the creation of decorative and functional products made primarily by hand or with simple tools by skilled artisans.
      </p>
      <p>
    ...
    <div class="relative group">
     ...
     <div class="absolute bottom-0 left-0 p-12">
      <div class="bg-blue-600 text-white p-10 space-y-2 border-l-8 border-white/20 shadow-2xl">
       <p class="text-3xl font-bold tracking-tight uppercase ">Luxury</p>
       <p class="text-[10px] font-bold uppercase tracking-[0.3em] opacity-80">Artisan Segment</p>
      </div>
     </div>
    </div>
   </div>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm overflow-hidden">
    ...
    <div class="p-8 lg:p-12 bg-slate-950 text-white relative overflow-hidden group">
     ...
     <div class="relative z-10 space-y-16">
      <div class="space-y-4">
       <div class="text-blue-400 text-[10px] font-bold uppercase tracking-[0.4em]">Global Investment</div>
      ...
      <div class="space-y-12">
       <div class="flex items-end justify-between border-b border-white/10 pb-8">
        ...
        <span class="text-4xl font-bold text-white tracking-tight ">$850B</span>
       </div>
       <div class="flex items-end justify-between border-b border-white/10 pb-8">
      ...
      <div class="p-12 bg-white/5 border border-white/10 shadow-2xl">
        <p class="text-[10px] font-bold text-blue-400 uppercase tracking-[0.4em] mb-4">Market Reach</p>
        <p class="text-2xl font-bold text-white uppercase leading-tight tracking-tight">10% Expected CAGR</p>
        <p class="text-sm text-slate-500 mt-4 uppercase">Asia-Pacific remains the largest hub.</p>
      </div>
     </div>
    </div>
    ...
    <div class="p-8 lg:p-12 bg-white relative overflow-hidden group border-l border-slate-200">
     ...
     <div class="relative z-10 space-y-16 text-right">
      ...
      <div class="p-12 bg-blue-50 border-l-8 border-blue-600 shadow-sm text-right space-y-6">
       <p class="text-[9px] font-bold text-blue-600 uppercase tracking-[0.4em] ">Export Value</p>
       <p class="text-4xl font-bold text-slate-950 uppercase leading-tight tracking-tight">USD 5B+ Annually</p>
       <p class="text-[12px] font-bold text-slate-500 uppercase tracking-widest ">Global Export Rank: Top 2</p>
      </div>

      <div class="space-y-8">
       <h4 class="text-[9px] font-bold text-slate-400 uppercase tracking-[0.4em]">Artisan Hubs</h4>
       <div class="grid grid-cols-3 gap-6 shadow-sm">
        @foreach(['Jaipur', 'Moradabad', 'Saharanpur', 'Kutch', 'Kolkata', 'Kashmir'] as $city)
         <div class="p-6 bg-white flex flex-col items-center justify-center gap-4 group/item hover:bg-slate-950 transition-all duration-500 text-center">
          ...
          <span class="text-[9px] font-bold uppercase text-slate-600 group-hover/item:text-white tracking-[0.1em] leading-tight">{{ $city }}</span>
         </div>
        @endforeach
       </div>
      </div>
   ...
   <div class="grid grid-cols-2 md:grid-cols-4 gap-6 shadow-sm">
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-blue-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110">70L+</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">Active Artisans</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
    ...
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-blue-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">7K+</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">Organized Exporters</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-blue-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">TOP 2</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">Global Export Rank</p>
    </div>
   </div>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm overflow-hidden">
    <div class="p-12 bg-white space-y-16">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">Artisan <br><span class="text-blue-600">Opportunities.</span></h2>
      <div class="accent-line bg-blue-600"></div>
     </div>
    ...
    <div class="p-12 bg-slate-950 text-white space-y-12 relative overflow-hidden group border-l border-slate-200">
     ...
     <div class="relative z-10 space-y-16">
      <div class="space-y-4">
       ...
       <h3 class="text-3xl font-bold text-white ">Creative Economy</h3>
      </div>
