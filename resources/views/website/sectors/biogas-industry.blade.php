...
@section('content')
 ...
 <section class="relative pt-40 pb-20 bg-slate-950 overflow-hidden border-b border-slate-900">
  ...
  <div class="absolute inset-0 opacity-20">
   <img src="{{ asset('images/sectors/biogas-industry.webp') }}" class="w-full h-full object-cover">
  </div>
  ...
  <div class="container relative z-10 text-center space-y-12">
   <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10 backdrop-blur-md">
    ...
    <span class="text-white text-[10px] font-bold tracking-[0.4em] uppercase">Renewable Methane Infrastructure</span>
   </div>
   <h1 class="text-3xl md:text-5xl font-bold text-white leading-tight">
    Biogas <br>
    <span class="text-lime-600">Industry.</span>
   </h1>
   <p class="text-lg text-slate-400 max-w-4xl mx-auto leading-relaxed font-medium border-l-4 border-lime-600 pl-10 uppercase tracking-widest ">
  ...
  <div class="container space-y-20">
   ...
   <div class="grid lg:grid-cols-2 gap-12 items-center">
    <div class="space-y-12">
     ...
     <div class="space-y-8 text-lg text-slate-600 leading-relaxed border-l-4 border-slate-200 pl-8">
      <p>
       <strong class="text-slate-900 font-bold ">Biogas</strong> is a renewable energy source produced through the <strong>anaerobic digestion</strong> of organic waste materials such as agricultural residue, food waste, animal manure, sewage sludge, and industrial biodegradable waste.
      </p>
      <p>
    ...
    <div class="relative group animate-on-scroll">
     ...
     <div class="relative overflow-hidden border border-slate-200 shadow-sm">
   ...
   <div class="space-y-16">
    <div class="text-center space-y-4">
     <span class="text-lime-600 text-[10px] font-bold uppercase tracking-[0.4em]">Multi-Vertical Utilization</span>
     <h3 class="text-3xl font-bold text-slate-950 ">Biogas Applications</h3>
    </div>
    <div class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-6 shadow-sm">
     @php
      $apps = [
     ...
     @foreach($apps as $app)
      <div class="p-12 bg-white text-center group hover:bg-slate-950 transition-all duration-700">
       ...
       <h4 class="text-[10px] font-bold text-slate-900 group-hover:text-white uppercase tracking-[0.3em] leading-tight">{{ $app['label'] }}</h4>
      </div>
     @endforeach
    </div>
   </div>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm">
    ...
    <div class="p-16 bg-slate-950 relative overflow-hidden group">
     ...
     <div class="relative z-10 space-y-16">
      <div class="space-y-4">
       <div class="text-lime-400 text-[10px] font-bold uppercase tracking-[0.4em]">International Scale</div>
      ...
      <div class="space-y-8">
       <div class="flex items-end justify-between border-b border-white/10 pb-6">
        ...
        <span class="text-3xl font-bold text-white tracking-tight">$75B+</span>
       </div>
       <div class="flex items-end justify-between border-b border-white/10 pb-6">
        <span class="text-[10px] font-bold uppercase text-slate-500 tracking-[0.3em]">Projected (2032)</span>
        <span class="text-3xl font-bold text-white tracking-tight">$120B+</span>
       </div>
       <div class="flex items-end justify-between">
        <span class="text-[10px] font-bold uppercase text-slate-500 tracking-[0.3em]">Annual CAGR</span>
        <span class="text-3xl font-bold text-lime-500 tracking-tight">8%</span>
       </div>
      </div>
      ...
      <div class="space-y-4">
       ...
       <div class="flex flex-wrap gap-px bg-white/10 border border-white/10">
        @foreach(['Renewable Demand', 'Decarbonization', 'Waste-to-Energy', 'ESG Adoption', 'Blending Mandates'] as $driver)
         <span class="px-6 py-3 bg-slate-950 text-[9px] font-bold text-slate-300 uppercase tracking-[0.2em] border-r border-white/10 last:border-0">{{ $driver }}</span>
        @endforeach
       </div>
      </div>
     </div>
    ...
    <div class="p-16 bg-white relative overflow-hidden group border-l border-slate-200">
     ...
     <div class="relative z-10 space-y-16">
      <div class="space-y-4">
       <div class="text-lime-600 text-[10px] font-bold uppercase tracking-[0.4em]">National Momentum</div>
      ...
      <div class="space-y-8">
       <div class="flex items-end justify-between border-b border-slate-100 pb-6">
        ...
        <span class="text-3xl font-bold text-slate-950 tracking-tight">₹15K Cr+</span>
       </div>
       <div class="flex items-end justify-between border-b border-slate-100 pb-6">
        <span class="text-[10px] font-bold uppercase text-slate-400 tracking-[0.3em]">Annual CAGR</span>
        <span class="text-3xl font-bold text-lime-600 tracking-tight">18%</span>
       </div>
       <div class="p-8 bg-lime-50 border-l-4 border-lime-600">
        <p class="text-[9px] font-bold text-lime-600 uppercase tracking-[0.4em] mb-4">India Target (2031)</p>
        <p class="text-3xl font-bold text-slate-950 uppercase leading-tight">₹40,000 Crore+</p>
       </div>
      </div>
     </div>
    </div>
   ...
   <div class="grid grid-cols-2 md:grid-cols-4 gap-6 shadow-sm">
    <div class="p-12 bg-white text-center group hover:bg-slate-950 transition-all duration-700">
     <h4 class="text-3xl font-bold text-lime-600 mb-2">$75B+</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.3em]">Global Market</p>
    </div>
    <div class="p-12 bg-white text-center group hover:bg-slate-950 transition-all duration-700">
     <h4 class="text-3xl font-bold text-lime-600 mb-2">₹15K Cr+</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.3em]">India Market</p>
    </div>
    <div class="p-12 bg-white text-center group hover:bg-slate-950 transition-all duration-700">
     <h4 class="text-3xl font-bold text-lime-600 mb-2">5,000+</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.3em]">India Plants</p>
    </div>
    <div class="p-12 bg-white text-center group hover:bg-slate-950 transition-all duration-700">
     <h4 class="text-3xl font-bold text-lime-600 mb-2">15–18%</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.3em]">India CAGR</p>
    </div>
   </div>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm">
    <div class="p-12 bg-white space-y-16">
     <h3 class="text-4xl font-bold uppercase text-slate-950 border-l-8 border-slate-950 pl-10 tracking-tight">India Capacity</h3>
     <div class="space-y-8">
      <p class="text-xl text-slate-500 font-medium leading-relaxed border-l-4 border-slate-100 pl-10">
      ...
      <div class="space-y-4">
       <h4 class="text-[10px] font-bold text-slate-400 uppercase tracking-[0.4em]">Major Growth States</h4>
       <div class="grid grid-cols-2 gap-px bg-slate-100 border border-slate-100">
        @foreach(['Punjab', 'Haryana', 'Uttar Pradesh', 'Maharashtra', 'Gujarat', 'Karnataka'] as $state)
         <div class="p-6 bg-white flex items-center gap-4 group/state hover:bg-slate-950 transition-colors">
          ...
          <span class="text-[10px] font-bold text-slate-600 group-hover/state:text-white uppercase tracking-[0.2em]">{{ $state }}</span>
         </div>
        @endforeach
       </div>
      </div>
    ...
    <div class="p-12 bg-slate-50 space-y-16">
     <h3 class="text-4xl font-bold uppercase text-slate-950 border-l-8 border-lime-600 pl-10 tracking-tight">Global Ecosystem</h3>
     <div class="space-y-12">
      <div class="p-10 bg-slate-950 text-white shadow-2xl">
        <p class="text-[10px] font-bold text-lime-500 uppercase tracking-[0.4em] mb-4 text-center">Global Status</p>
        <p class="text-4xl font-bold text-center leading-tight ">50,000+ Biogas Plants Globally</p>
      </div>
      <ul class="space-y-6">
       @foreach([
        ...
        <li class="flex items-start gap-6 group/item">
         ...
         <span class="text-[10px] font-bold text-slate-600 uppercase tracking-[0.2em] group-hover/item:text-slate-950 transition-colors leading-relaxed">{{ $point }}</span>
        </li>
       @endforeach
      </ul>
     </div>
   ...
   <div class="grid lg:grid-cols-2 gap-32 items-center">
    <div class="space-y-16">
     ...
     <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 shadow-2xl">
      @php
       $trends = [
      ...
      @foreach($trends as $trend)
       <div class="p-10 bg-white group hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
        ...
        <div class="flex items-center gap-6">
         ...
         <span class="text-[9px] font-bold text-slate-600 group-hover:text-white uppercase tracking-[0.2em] leading-tight">{{ $trend['label'] }}</span>
        </div>
       </div>
      @endforeach
     </div>
    ...
    <div class="p-8 lg:p-12 bg-slate-950 text-white space-y-16 relative overflow-hidden group border border-white/5 shadow-sm">
     ...
     <div class="relative z-10 space-y-12">
      <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10 text-lime-400 text-[10px] font-bold uppercase tracking-[0.4em]">
       Sector Advantage
      </div>
      <h3 class="text-3xl font-bold text-slate-900 text-lime-600">Why India is a <br><span class="text-white">Biogas Hub.</span></h3>
      <ul class="space-y-8">
       @foreach([
        ...
        <li class="flex items-start gap-6 group/item">
         ...
         <span class="text-slate-400 text-lg font-bold uppercase tracking-widest group-hover/item:text-white transition-colors">{{ $why }}</span>
        </li>
       @endforeach
      </ul>
     </div>
   ...
   <!-- Conclusion CTA -->
   <div class="relative p-12 lg:p-32 bg-slate-950 overflow-hidden text-center shadow-sm border border-white/5 group">
    ...
    <div class="relative z-10 space-y-16">
     ...
     <p class="text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed font-medium border-l-4 border-lime-600 pl-10">
