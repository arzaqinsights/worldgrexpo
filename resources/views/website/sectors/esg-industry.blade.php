...
@section('content')
 ...
 <section class="relative pt-40 pb-20 bg-slate-950 overflow-hidden border-b border-slate-900">
  ...
  <div class="absolute inset-0 opacity-20">
   <img src="{{ asset('images/sectors/esg-industry.jpg') }}" class="w-full h-full object-cover">
  </div>
  ...
  <div class="container space-y-20">
   ...
   <div class="grid lg:grid-cols-2 gap-6">
    <div class="p-8 lg:p-12 bg-white space-y-12">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">Corporate <br><span class="text-emerald-600">Accountability.</span></h2>
     ...
     <div class="space-y-8 text-lg text-slate-600 leading-relaxed border-l-4 border-slate-200 pl-8">
      <p>
       <strong class="text-slate-900 font-bold ">Environmental, Social, and Governance (ESG)</strong> is a strategic framework used by companies to evaluate business sustainability.
      </p>
      <p>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm overflow-hidden">
    ...
    <div class="p-8 lg:p-12 bg-slate-950 text-white relative overflow-hidden group">
     ...
     <div class="relative z-10 space-y-16">
      <div class="space-y-4">
       <div class="text-emerald-400 text-[10px] font-bold uppercase tracking-[0.4em]">Global Investment</div>
       <h3 class="text-3xl font-bold text-slate-900">Global Market</h3>
      </div>
      
      <div class="space-y-12">
       <div class="flex items-end justify-between border-b border-white/10 pb-8">
        <span class="text-[10px] font-bold uppercase text-slate-500 tracking-[0.3em]">Managed Assets (2025)</span>
        <span class="text-4xl font-bold text-white tracking-tight ">$30T</span>
       </div>
       <div class="flex items-end justify-between border-b border-white/10 pb-8">
        <span class="text-[10px] font-bold uppercase text-slate-500 tracking-[0.3em]">Projected (2030)</span>
        <span class="text-4xl font-bold text-white tracking-tight ">$50T</span>
       </div>
      </div>

      <div class="space-y-8">
       <h4 class="text-[9px] font-bold text-slate-500 uppercase tracking-[0.4em]">Key Drivers</h4>
    ...
    <div class="p-8 lg:p-12 bg-white relative overflow-hidden group border-l border-slate-200">
     ...
     <div class="relative z-10 space-y-16 text-right">
      ...
      <div class="p-12 bg-emerald-50 border-l-8 border-emerald-600 shadow-sm text-right space-y-6">
       <p class="text-[9px] font-bold text-emerald-600 uppercase tracking-[0.4em] ">Compliance Standards</p>
       <p class="text-4xl font-bold text-slate-950 uppercase leading-tight tracking-tight">BRSR Adoption Required</p>
       <p class="text-[12px] font-bold text-slate-500 uppercase tracking-widest ">Top 1000 Indian Companies</p>
      </div>

      <div class="space-y-8">
       <h4 class="text-[9px] font-bold text-slate-400 uppercase tracking-[0.4em]">Adoption Sectors</h4>
       <div class="grid grid-cols-2 gap-6 shadow-sm">
        @foreach(['Manufacturing', 'Energy', 'FMCG', 'Banking & Finance', 'IT', 'Infrastructure'] as $sector)
         <div class="p-6 bg-white flex items-center gap-4 group/item hover:bg-slate-950 transition-all duration-500">
          ...
          <span class="text-[9px] font-bold uppercase text-slate-600 group-hover/item:text-white tracking-[0.1em] leading-tight">{{ $sector }}</span>
         </div>
        @endforeach
       </div>
      </div>
   ...
   <div class="grid grid-cols-2 md:grid-cols-4 gap-6 shadow-sm">
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-emerald-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110">15%</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">Global CAGR</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-emerald-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">20%+</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">India CAGR</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-emerald-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">500+</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">Advisory Firms</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-emerald-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">20K+</h4>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm overflow-hidden">
    <div class="relative overflow-hidden group">
     ...
     <div class="absolute bottom-0 left-0 p-12">
      <div class="bg-emerald-600 text-white p-10 space-y-2 border-l-8 border-white/20 shadow-2xl">
       <p class="text-3xl font-bold tracking-tight uppercase ">2026-31</p>
       <p class="text-[10px] font-bold uppercase tracking-[0.3em] opacity-80">Growth Forecast Period</p>
      </div>
     </div>
    </div>
    ...
    <div class="p-12 bg-white space-y-16">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">Emerging <br><span class="text-emerald-600">Opportunities.</span></h2>
      <div class="accent-line bg-emerald-600"></div>
     </div>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm">
    <div class="p-12 bg-slate-950 text-white space-y-12 relative overflow-hidden group">
     ...
     <div class="relative z-10 space-y-16">
      <div class="space-y-4">
       <div class="text-emerald-400 text-[10px] font-bold uppercase tracking-[0.4em]">Regional Hub</div>
       <h3 class="text-3xl font-bold text-white ">India's Global Role</h3>
      </div>
      <p class="text-2xl text-slate-400 font-medium border-l-4 border-emerald-600/30 pl-10 leading-relaxed ">
      ...
      <div class="grid grid-cols-2 gap-4 pt-12">
        ...
        <div class="p-8 bg-slate-950 border border-white/5 flex items-center gap-6 group/item hover:bg-emerald-600 transition-all duration-500">
         ...
         <span class="text-[10px] font-bold uppercase text-slate-300 group-hover/item:text-slate-950 tracking-[0.2em] transition-colors leading-tight">{{ $tag }}</span>
        </div>
        @endforeach
      </div>
     </div>
    ...
    <div class="p-12 bg-white space-y-12 border-l border-slate-200 text-center flex flex-col justify-center items-center relative overflow-hidden group">
     ...
     <div class="relative z-10 space-y-10">
      ...
      <h4 class="text-3xl font-bold uppercase text-slate-950 tracking-tight leading-tight">Growth Forecast</h4>
      <p class="text-2xl text-slate-500 font-medium max-w-sm mx-auto ">
       Global market expected to reach <span class="text-slate-950 font-bold tracking-tight">$50 Trillion</span> with India leading.
      </p>
     </div>
    </div>
   </div>
