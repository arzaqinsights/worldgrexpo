...
@section('content')
 ...
 <section class="relative pt-40 pb-20 bg-slate-950 overflow-hidden border-b border-slate-900">
  ...
  <div class="absolute inset-0 opacity-20">
   <img src="{{ asset('images/sectors/circular-economy.jpg') }}" class="w-full h-full object-cover">
  </div>
  ...
  <div class="container relative z-10 text-center space-y-12">
   <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10">
    ...
    <span class="text-white text-[10px] font-bold tracking-[0.4em] uppercase">Fiber Recovery Infrastructure</span>
   </div>
  ...
  <div class="container space-y-20">
   ...
   <div class="grid lg:grid-cols-2 gap-6">
    <div class="p-8 lg:p-12 bg-white space-y-12">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">Niche Impact <br><span class="text-indigo-600">Industry.</span></h2>
     ...
     <div class="space-y-8 text-lg text-slate-600 leading-relaxed border-l-4 border-slate-200 pl-8">
      <p>
       <strong class="text-slate-900 font-bold ">Cigarette butt recycling</strong> is the process of converting discarded filters and tobacco waste into industrial stuffing, paper pulp, and plastic alternatives.
      </p>
      <p>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm">
    ...
    <div class="p-8 lg:p-12 bg-slate-950 relative overflow-hidden group">
     ...
     <div class="relative z-10 space-y-16">
      <div class="space-y-4">
       <div class="text-indigo-400 text-[10px] font-bold uppercase tracking-[0.4em]">Environmental Crisis</div>
       <h3 class="text-3xl font-bold text-white ">Global Impact</h3>
      </div>
      
      <div class="space-y-12">
       <div class="space-y-4 border-b border-white/10 pb-10">
        <span class="text-7xl font-bold text-white tracking-tight block transition-transform group-hover:translate-x-4 duration-500">4.5 Trillion</span>
        <span class="text-[10px] font-bold uppercase text-slate-500 tracking-[0.3em]">Butts discarded annually worldwide</span>
       </div>
       <div class="space-y-4">
        <span class="text-7xl font-bold text-indigo-500 tracking-tight block transition-transform group-hover:translate-x-4 duration-500">12%</span>
        <span class="text-[10px] font-bold uppercase text-slate-500 tracking-[0.3em]">Of aquatic litter consists of filter waste</span>
       </div>
      </div>

      <div class="grid grid-cols-4 gap-px bg-white/10 border border-white/10">
       @foreach(['USA', 'UK', 'Canada', 'Australia'] as $region)
        <span class="p-4 bg-slate-950 text-[9px] font-bold text-slate-400 uppercase tracking-[0.2em] text-center hover:bg-indigo-600 hover:text-slate-950 transition-all cursor-default">{{ $region }}</span>
       @endforeach
      </div>
     </div>
    </div>
    ...
    <div class="p-8 lg:p-12 bg-white relative overflow-hidden group border-l border-slate-200">
     ...
     <div class="relative z-10 space-y-16">
      <div class="space-y-4">
       <div class="text-indigo-600 text-[10px] font-bold uppercase tracking-[0.4em]">Emerging Ecosystem</div>
      ...
      <div class="grid grid-cols-2 gap-6 shadow-sm">
       <div class="p-12 bg-white space-y-4">
        <p class="text-[9px] font-bold text-slate-400 uppercase tracking-[0.3em]">Annual Volume</p>
        <p class="text-3xl font-bold text-indigo-600 tracking-tight ">100B+</p>
       </div>
       <div class="p-12 bg-white space-y-4">
        <p class="text-[9px] font-bold text-slate-400 uppercase tracking-[0.3em]">Sector CAGR</p>
        <p class="text-3xl font-bold text-indigo-600 tracking-tight ">20%</p>
       </div>
      </div>
      ...
      <div class="space-y-px bg-slate-200 border border-slate-200">
       <div class="flex items-center justify-between p-10 bg-white group/item">
        <span class="text-[10px] font-bold uppercase text-slate-400 tracking-[0.3em] group-hover/item:text-indigo-600 transition-colors">Organized Startups</span>
        <span class="text-2xl font-bold text-slate-950 tracking-tight uppercase transition-colors group-hover/item:text-slate-950">10–20 Pioneers</span>
       </div>
       <div class="p-12 bg-indigo-50 border-l-8 border-indigo-600 shadow-sm">
        <p class="text-[9px] font-bold text-indigo-600 uppercase tracking-[0.4em] mb-4 ">Geographic Concentration</p>
        <p class="text-4xl font-bold text-slate-950 uppercase leading-tight tracking-tight">NCR & Major Metros</p>
       </div>
      </div>
     </div>
    </div>
   ...
   <div class="grid grid-cols-2 md:grid-cols-4 gap-6 shadow-sm">
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-indigo-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110">100+</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.3em]">Global Initiatives</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-indigo-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">Nascent</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.3em]">Sector Stage</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-indigo-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">High</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.3em]">ESG Impact</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-indigo-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">Top 1</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.3em]">Litter Rank</p>
    </div>
   </div>
   ...
   <div class="space-y-16">
    <div class="text-center space-y-4">
     <span class="text-indigo-600 text-[10px] font-bold uppercase tracking-[0.4em]">Venture Perspectives</span>
     <h3 class="text-4xl font-bold text-slate-900">Startup Opportunities</h3>
    </div>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 shadow-sm">
     @php
      $items = [
     ...
     @foreach($items as $i)
      <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all relative overflow-hidden">
       ...
       <h4 class="text-xl font-bold text-slate-950 group-hover:text-white mb-4 leading-tight transition-colors">{{ $i['title'] }}</h4>
       <p class="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] leading-tight transition-colors">{{ $i['sub'] }}</p>
      </div>
     @endforeach
    </div>
   </div>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm overflow-hidden">
    <div class="p-8 lg:p-12 bg-white space-y-12">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">Environmental <br><span class="text-indigo-600">Urgency.</span></h2>
      <div class="accent-line bg-indigo-600"></div>
     </div>
     ...
     <div class="flex items-center gap-10 pt-12">
       ...
       <p class="text-[12px] uppercase font-bold tracking-[0.4em] text-slate-900">Combat Environmental Pollution</p>
     </div>
    </div>
    <div class="relative bg-slate-950 p-8 lg:p-12 text-white overflow-hidden group">
     ...
     <div class="relative z-10 space-y-12">
      ...
      <h4 class="text-4xl font-bold uppercase tracking-tight text-indigo-600 leading-tight">Critical <br><span class="text-white">Waste Segment.</span></h4>
