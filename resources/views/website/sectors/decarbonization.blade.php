...
@section('content')
    ...
    <section class="relative pt-64 pb-32 bg-slate-950 overflow-hidden border-b border-slate-900">
        ...
        <div class="absolute inset-0 opacity-20">
            <img src="{{ asset('images/sectors/decarbonization.jpg') }}" class="w-full h-full object-cover grayscale">
        </div>
        ...
        <div class="container relative z-10 text-center space-y-12">
            <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10">
                ...
                <span class="text-white text-[10px] font-black tracking-[0.4em] uppercase">Emissions Mitigation Protocol</span>
            </div>
        ...
        <div class="container space-y-48">
            ...
            <div class="grid lg:grid-cols-2 gap-px bg-slate-200 border border-slate-200">
                <div class="p-16 lg:p-24 bg-white space-y-12">
                    <div class="section-heading text-left">
                        ...
                        <h2 class="text-5xl font-black uppercase tracking-tighter italic">Building A <br><span class="text-emerald-600">Zero Future.</span></h2>
                        <div class="accent-line bg-emerald-600"></div>
                    </div>
                    
                    <div class="space-y-8 text-2xl text-slate-500 font-medium leading-relaxed italic border-l-4 border-slate-100 pl-10">
                        <p>
                            <strong class="text-slate-900 font-black uppercase tracking-tight">Decarbonization</strong> refers to the process of reducing or eliminating carbon dioxide (CO₂) and greenhouse gas emissions from industrial and societal activities.
                        </p>
                        <p>
                ...
                <div class="grid grid-cols-2 gap-px bg-slate-200 shadow-3xl">
                    ...
                    @foreach($focusAreas as $area)
                        <div class="p-16 bg-white flex flex-col items-center justify-center text-center group hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
                            ...
                            <p class="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 group-hover:text-white transition-colors">{{ $area['label'] }}</p>
                        </div>
                    @endforeach
                </div>
            </div>
            ...
            <div class="space-y-24">
                <div class="text-center space-y-4">
                    <span class="text-emerald-600 text-[10px] font-black uppercase tracking-[0.4em]">Mitigation Methodologies</span>
                    <h3 class="text-6xl font-black text-slate-950 uppercase tracking-tighter italic">Decarbonization Strategies</h3>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-px bg-slate-200 border border-slate-200 shadow-3xl">
                    ...
                    @foreach($strategies as $strat)
                        <div class="p-16 bg-white space-y-6 group hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
                            ...
                            <h4 class="text-xl font-black uppercase text-slate-950 group-hover:text-white italic tracking-tighter transition-colors">{{ $strat['title'] }}</h4>
                            <p class="text-[12px] font-black uppercase text-slate-400 tracking-[0.1em] leading-relaxed group-hover:text-slate-300 transition-colors">{{ $strat['desc'] }}</p>
                        </div>
                    @endforeach
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-px bg-slate-200 border border-slate-200 shadow-3xl overflow-hidden">
                ...
                <div class="p-16 lg:p-24 bg-slate-950 text-white relative overflow-hidden group">
                    ...
                    <div class="relative z-10 space-y-16">
                        <div class="space-y-4">
                            <div class="text-emerald-400 text-[10px] font-black uppercase tracking-[0.4em]">Global Opportunity</div>
                            <h3 class="text-5xl font-black uppercase tracking-tighter italic">Global Market</h3>
                        </div>
                        
                        <div class="space-y-12">
                            <div class="flex items-end justify-between border-b border-white/10 pb-8">
                                <span class="text-[10px] font-black uppercase text-slate-500 tracking-[0.3em]">Investment (2025)</span>
                                <span class="text-6xl font-black text-white tracking-tighter italic">$2T+</span>
                            </div>
                            <div class="flex items-end justify-between border-b border-white/10 pb-8">
                                <span class="text-[10px] font-black uppercase text-slate-500 tracking-[0.3em]">Opportunity (2031)</span>
                                <span class="text-6xl font-black text-white tracking-tighter italic">$5T+</span>
                            </div>
                            <div class="flex items-end justify-between">
                                <span class="text-[10px] font-black uppercase text-slate-500 tracking-[0.3em]">Annual CAGR</span>
                                <span class="text-6xl font-black text-emerald-500 tracking-tighter italic">18%</span>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-px bg-white/5 border border-white/10 shadow-2xl">
                             <div class="p-10 bg-slate-950 text-center space-y-4 hover:bg-emerald-600 transition-all duration-500 group/card">
                                <p class="text-2xl font-black text-emerald-400 group-hover/card:text-slate-950 italic">50,000+</p>
                                <p class="text-[10px] text-slate-500 uppercase tracking-tight group-hover/card:text-slate-950/70">Global ESG Firms</p>
                             </div>
                             <div class="p-10 bg-slate-950 text-center space-y-4 hover:bg-emerald-600 transition-all duration-500 group/card">
                                <p class="text-2xl font-black text-emerald-400 group-hover/card:text-slate-950 italic">Paris Agreement</p>
                                <p class="text-[10px] text-slate-500 uppercase tracking-tight group-hover/card:text-slate-950/70">Primary Driver</p>
                             </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="relative z-10 space-y-16 text-right">
                        ...
                        <div class="space-y-12">
                            <div class="flex items-end justify-between border-b border-slate-100 pb-8">
                                ...
                                <span class="text-6xl font-black text-slate-950 tracking-tighter italic">$35B</span>
                            </div>
                            <div class="flex items-end justify-between border-b border-slate-100 pb-8">
                                <span class="text-[10px] font-black uppercase text-slate-400 tracking-[0.3em]">Projected (2031)</span>
                                <span class="text-6xl font-black text-slate-950 tracking-tighter italic">$100B</span>
                            </div>
                            <div class="p-12 bg-emerald-50 border-l-8 border-emerald-600 shadow-sm text-right">
                                <p class="text-[9px] font-black text-emerald-600 uppercase tracking-[0.4em] mb-4">National Commitment</p>
                                <p class="text-4xl font-black text-slate-950 uppercase italic leading-tight tracking-tighter">Net Zero by 2070</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="space-y-16">
                <div class="text-center space-y-4">
                    <span class="text-emerald-600 text-[10px] font-black uppercase tracking-[0.4em]">Analytical Comparison</span>
                    <h3 class="text-6xl font-black text-slate-950 uppercase tracking-tighter italic">Snapshot Comparison</h3>
                </div>
                    ...
                    <table class="w-full text-sm border-collapse border border-slate-200">
                        <thead>
                            <tr class="bg-slate-950 text-white">
                                ...
                                <th class="text-center p-12 font-black uppercase tracking-[0.3em] border border-white/10">Global Market</th>
                                <th class="text-center p-12 font-black uppercase tracking-[0.3em] border border-white/10">India Market</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white italic font-medium">
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="p-10 font-black text-slate-900 uppercase tracking-[0.1em] border border-slate-200 bg-slate-50/50">Market Stage</td>
                            ...
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="p-10 font-black text-slate-900 uppercase tracking-[0.1em] border border-slate-200 bg-slate-50/50">Primary Driver</td>
            ...
            <div class="grid lg:grid-cols-2 gap-px bg-slate-200 border border-slate-200 shadow-3xl">
                ...
                <div class="p-24 bg-slate-50 space-y-16 border-l border-slate-200">
                    <h3 class="text-5xl font-black uppercase text-slate-950 italic border-l-8 border-emerald-600 pl-10 tracking-tighter">India Outlook</h3>
                    <ul class="space-y-10">
                        @foreach([
            ...
            <div class="space-y-24">
                <div class="text-center space-y-4">
                    <span class="text-emerald-600 text-[10px] font-black uppercase tracking-[0.4em]">Vertical Specialization</span>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-px bg-slate-200 border border-slate-200 shadow-3xl">
                    @foreach(['Renewable Energy', 'Green Hydrogen', 'Energy Efficiency', 'Battery Systems', 'Carbon Trading', 'Carbon Capture', 'Sustainability Auditing', 'Green Finance'] as $segment)
                        <div class="p-16 bg-white text-center group hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
                            <div class="absolute top-0 left-0 w-full h-1 bg-emerald-600 scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-500"></div>
                             <p class="text-[10px] font-black uppercase text-slate-600 group-hover:text-white tracking-[0.2em] transition-colors italic leading-tight">{{ $segment }}</p>
                        </div>
                    @endforeach
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-32 items-center">
                <div class="space-y-16">
                    <div class="section-heading text-left">
                        ...
                        <h2 class="text-5xl font-black uppercase tracking-tighter italic">Strategic <br><span class="text-emerald-600">Importance.</span></h2>
                        <div class="accent-line bg-emerald-600"></div>
                    </div>
                ...
                <div class="p-16 lg:p-24 bg-slate-950 text-white space-y-16 relative overflow-hidden group shadow-3xl border border-white/5">
                    ...
                    <div class="relative z-10 space-y-12">
                        ...
                        <h4 class="text-6xl font-black uppercase tracking-tighter italic text-emerald-600">The Green <br><span class="text-white">Transition.</span></h4>
                        ...
                        <div class="grid grid-cols-2 gap-px bg-white/5 pt-12 border border-white/10">
                             @foreach(['NET ZERO', 'ESG FOCUS', 'CARBON CAPTURE', 'GREEN HYDROGEN'] as $tag)
                                <span class="p-8 bg-slate-950 border border-white/5 text-[10px] font-black uppercase tracking-[0.4em] text-emerald-400 text-center hover:bg-emerald-600 hover:text-slate-950 transition-all cursor-default">{{ $tag }}</span>
                             @endforeach
                        </div>
                    </div>
                </div>
