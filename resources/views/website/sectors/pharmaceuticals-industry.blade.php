...
@section('content')
    ...
    <section class="relative pt-64 pb-32 bg-slate-950 overflow-hidden border-b border-slate-900">
        ...
        <div class="absolute inset-0 opacity-20">
            <img src="{{ asset('images/sectors/pharma-hero.png') }}" class="w-full h-full object-cover grayscale">
        </div>
        ...
        <div class="container relative z-10 text-center space-y-12">
            <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10">
                ...
                <span class="text-white text-[10px] font-black tracking-[0.4em] uppercase">Clinical Innovation Protocol</span>
            </div>
        ...
        <div class="container space-y-48">
            ...
            <div class="grid lg:grid-cols-2 gap-px bg-slate-200 border border-slate-200">
                <div class="p-16 lg:p-24 bg-white space-y-12">
                    <div class="section-heading text-left">
                        <span class="subtitle">Clinical Research Framework</span>
                        <h2 class="text-5xl font-black uppercase tracking-tighter italic">Science <br><span class="text-blue-600">Dynamics.</span></h2>
                        <div class="accent-line bg-blue-600"></div>
                    </div>
                    
                    <div class="space-y-8 text-2xl text-slate-500 font-medium leading-relaxed italic border-l-4 border-slate-100 pl-10">
                        <p>
                            <strong class="text-slate-900 font-black uppercase tracking-tight">The pharmaceutical industry</strong> is one of the most research-driven and essential sectors globally, dedicated to the discovery, development, and distribution of medicines.
                        </p>
                        <p>
                            It plays a crucial role in disease prevention and treatment, serving as a pillar of global public health through vaccines, biologics, and essential medicines.
                        </p>
                    </div>
                </div>
            ...
            <div class="grid lg:grid-cols-2 gap-px bg-slate-200 border border-slate-200 shadow-3xl overflow-hidden">
                    ...
                    <div class="relative z-10 space-y-16">
                        ...
                        <div class="space-y-12">
                            <div class="flex items-end justify-between border-b border-white/10 pb-8">
                                ...
                                <span class="text-6xl font-black text-white tracking-tighter italic">$1.6T+</span>
                            </div>
                            <div class="flex items-end justify-between border-b border-white/10 pb-8">
                                <span class="text-[10px] font-black uppercase text-slate-500 tracking-[0.3em]">Projected (2032)</span>
                                <span class="text-6xl font-black text-white tracking-tighter italic">$2.8T+</span>
                            </div>
                        </div>

                        <div class="space-y-8">
                            <h4 class="text-[9px] font-black text-slate-500 uppercase tracking-[0.4em]">Major Markets</h4>
                            <div class="grid grid-cols-3 gap-px bg-white/10 border border-white/10 shadow-2xl">
                                @foreach(['USA', 'China', 'Germany', 'Japan', 'UK', 'India'] as $market)
                                    <div class="p-6 bg-slate-950 flex flex-col items-center justify-center gap-4 group/item hover:bg-blue-600 transition-all duration-500">
                                        <span class="text-[9px] font-black uppercase text-slate-300 group-hover:text-slate-950 tracking-[0.1em] text-center">{{ $market }}</span>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                ...
                <div class="p-16 lg:p-24 bg-white relative overflow-hidden group border-l border-slate-200">
                    <div class="absolute top-0 right-0 p-12 text-blue-600 opacity-5 group-hover:opacity-10 transition-opacity">
                        <i class="fa-solid fa-flask-vial text-[12rem]"></i>
                    </div>
                    <div class="relative z-10 space-y-16 text-right">
                        <div class="space-y-4">
                            <div class="text-blue-600 text-[10px] font-black uppercase tracking-[0.4em]">Pharmacy of the World</div>
                        ...
                        <div class="p-12 bg-blue-50 border-l-8 border-blue-600 shadow-sm text-right space-y-6">
                            <p class="text-[9px] font-black text-blue-600 uppercase tracking-[0.4em] italic">Market Projection</p>
                            <p class="text-4xl font-black text-slate-950 uppercase italic leading-tight tracking-tighter">$130B+ Target (2030)</p>
                            <p class="text-[12px] font-black text-slate-500 uppercase tracking-widest italic">10-12% Annual CAGR</p>
                        </div>

                        <div class="space-y-8">
                            <h4 class="text-[9px] font-black text-slate-400 uppercase tracking-[0.4em]">Supply Strength</h4>
                            <div class="grid grid-cols-2 gap-px bg-slate-200 border border-slate-200 shadow-sm">
                                <div class="p-8 bg-white flex flex-col items-center justify-center gap-4 group/item hover:bg-slate-950 transition-all duration-500">
                                    <span class="text-4xl font-black text-blue-600 group-hover:text-white transition-colors">20%</span>
                                    <span class="text-[9px] font-black uppercase text-slate-600 group-hover:text-white tracking-[0.1em] text-center">Global Generic Supply</span>
                                </div>
                                <div class="p-8 bg-white flex flex-col items-center justify-center gap-4 group/item hover:bg-slate-950 transition-all duration-500">
                                    <span class="text-4xl font-black text-blue-600 group-hover:text-white transition-colors">TOP 3</span>
                                    <span class="text-[9px] font-black uppercase text-slate-600 group-hover:text-white tracking-[0.1em] text-center">Global Export Volume</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-px bg-slate-200 border border-slate-200 shadow-3xl">
                <div class="p-16 bg-white text-center group hover:bg-slate-950 transition-all duration-700">
                    <h4 class="text-6xl font-black text-blue-600 mb-4 transition-all duration-500 tracking-tighter italic group-hover:scale-110">3,000+</h4>
                    <p class="text-[10px] font-black text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">Pharma Companies</p>
                </div>
                <div class="p-16 bg-white text-center group hover:bg-slate-950 transition-all duration-700">
                    <h4 class="text-6xl font-black text-blue-600 mb-4 transition-all duration-500 tracking-tighter italic group-hover:scale-110 uppercase">10.5K+</h4>
                    <p class="text-[10px] font-black text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">Mfg Units (India)</p>
                </div>
                <div class="p-16 bg-white text-center group hover:bg-slate-950 transition-all duration-700">
                    <h4 class="text-6xl font-black text-blue-600 mb-4 transition-all duration-500 tracking-tighter italic group-hover:scale-110 uppercase">USFDA</h4>
                    <p class="text-[10px] font-black text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">Max Plants outside USA</p>
                </div>
                <div class="p-16 bg-white text-center group hover:bg-slate-950 transition-all duration-700">
                    <h4 class="text-6xl font-black text-blue-600 mb-4 transition-all duration-500 tracking-tighter italic group-hover:scale-110 uppercase">2.7M+</h4>
                    <p class="text-[10px] font-black text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">Professionals</p>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-px bg-slate-200 border border-slate-200 shadow-3xl overflow-hidden">
                <div class="p-24 bg-white space-y-16">
                    <div class="section-heading text-left">
                        ...
                        <h2 class="text-5xl font-black uppercase tracking-tighter italic">Emerging <br><span class="text-blue-600">Tech.</span></h2>
                        <div class="accent-line bg-blue-600"></div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        @php
                            $items = [
                                ...
                                ['icon' => 'leaf', 'title' => 'Sustainable Green Mfg'],
                            ];
                        @endphp
                        @foreach($items as $i)
                ...
                <div class="p-24 bg-slate-950 text-white space-y-12 relative overflow-hidden group border-l border-slate-200">
                    ...
                    <div class="relative z-10 space-y-16">
                        <div class="space-y-4">
                            ...
                            <h3 class="text-5xl font-black text-white uppercase tracking-tighter italic">Global Advantage</h3>
                        </div>
                        <p class="text-2xl text-slate-400 font-medium italic border-l-4 border-blue-600/30 pl-10 leading-relaxed uppercase tracking-tighter">
                            The pharmaceutical sector is fundamental to global public health, medical advancement, and economic development.
                        </p>
                        <div class="grid grid-cols-2 gap-px bg-white/5 border border-white/5 pt-12">
                             @foreach(['GENERICS', 'APIs', 'VACCINES', 'BIOLOGICS'] as $tag)
            ...
            <div class="relative p-24 lg:p-32 bg-slate-950 overflow-hidden text-center shadow-3xl group">
                ...
                <div class="relative z-10 space-y-16">
                    <h3 class="text-5xl md:text-[8rem] font-black text-white uppercase tracking-tighter leading-[0.85]">
                        Pharmacy <br><span class="text-blue-600">Global.</span>
                    </h3>
                    <p class="text-2xl text-slate-400 max-w-4xl mx-auto leading-relaxed font-medium italic border-l-4 border-blue-600 pl-10 md:text-center mx-auto uppercase tracking-tighter">
                        World Grexpo empowers pharmaceutical players to transition from domestic supply to global clinical leadership.
                    </p>
                    <div class="flex justify-center">
                        <a href="{{ route('join.index') }}" 
                            class="btn-sharp px-16 group !border-blue-600/30 hover:!bg-blue-600">
                            Register for Pharma Support 
