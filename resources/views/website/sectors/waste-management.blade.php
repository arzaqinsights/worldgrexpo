...
@section('title', 'Waste Management Industry')
 ...
 <section class="relative pt-40 pb-20 bg-slate-950 overflow-hidden border-b border-slate-900">
  ...
  <div class="container relative z-10 text-center space-y-12">
   <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10">
    ...
    <span class="text-white text-[10px] font-bold tracking-[0.4em] uppercase">Sustainable Resource Infrastructure</span>
   </div>
  ...
  <div class="container space-y-20">
   ...
   <div class="grid lg:grid-cols-2 gap-6">
    <div class="p-8 lg:p-12 bg-white space-y-12">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">Systematic <br><span class="text-emerald-600">Processing.</span></h2>
     ...
     <div class="space-y-8 text-lg text-slate-600 leading-relaxed border-l-4 border-slate-200 pl-8">
      <p>
       <strong class="text-slate-900 font-bold ">Waste Management</strong> refers to the systematic collection, transportation, processing, recycling, and disposal of waste materials.
      </p>
      <p>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm overflow-hidden">
    ...
    <div class="p-8 lg:p-12 bg-slate-950 text-white relative overflow-hidden group">
     ...
     <div class="relative z-10 space-y-16">
      <div class="space-y-4">
       <div class="text-emerald-400 text-[10px] font-bold uppercase tracking-[0.4em]">International Value</div>
      ...
      <div class="space-y-12">
       ...
       <div class="flex items-end justify-between border-b border-white/10 pb-8">
        ...
        <span class="text-4xl font-bold text-emerald-500 tracking-tight ">$2.5T+</span>
       </div>
      </div>
      ...
      <div class="space-y-8">
       ...
       <div class="grid grid-cols-1 gap-4">
        @foreach(['Rising urban waste generation', 'Industrial expansion', 'Environmental regulations', 'Circular economy initiatives'] as $driver)
     ...
     <div class="relative z-10 space-y-16 text-right">
      ...
      <div class="space-y-12">
       ...
       <div class="flex items-end justify-between border-b border-slate-100 pb-8">
        ...
        <span class="text-4xl font-bold text-emerald-600 tracking-tight ">14%</span>
       </div>
       <div class="p-12 bg-emerald-50 border-l-8 border-emerald-600 shadow-sm text-right">
        <p class="text-[9px] font-bold text-emerald-600 uppercase tracking-[0.4em] mb-4 ">Projection (2031)</p>
        <p class="text-3xl font-bold text-slate-950 uppercase leading-tight tracking-tight">₹2 Lakh Cr+</p>
       </div>
      </div>
     </div>
    </div>
   ...
   <div class="grid grid-cols-2 md:grid-cols-4 gap-6 shadow-sm">
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-emerald-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110">$1.5T+</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">Global Market</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-emerald-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">₹1L Cr+</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">India Market</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-emerald-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">10-14%</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">India CAGR</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-emerald-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">$2.5T</h4>
   ...
   <div class="space-y-12">
    <div class="text-center space-y-4">
     <span class="text-emerald-600 text-[10px] font-bold uppercase tracking-[0.4em]">Resource Classification</span>
     <h3 class="text-4xl font-bold text-slate-900">Key Waste Segments</h3>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 shadow-sm">
     ...
     @foreach($segments as $s)
      <div class="p-16 bg-white {{ $s['col'] ?? '' }} flex flex-col items-center justify-center text-center group hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
       ...
       <h4 class="text-[12px] font-bold uppercase text-slate-950 group-hover:text-white transition-colors tracking-[0.15em] mb-2 ">{{ $s['title'] }}</h4>
       <p class="text-[10px] font-bold uppercase text-slate-400 tracking-[0.1em] leading-tight">{{ $s['desc'] }}</p>
      </div>
     @endforeach
    </div>
   </div>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm overflow-hidden">
    <div class="p-12 bg-slate-950 text-white space-y-16">
     <h3 class="text-3xl font-bold text-slate-900 text-emerald-500 border-l-8 border-emerald-600 pl-10">Emerging Trends</h3>
     <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
      @foreach([
       ...
       <div class="p-10 bg-slate-950 group/item hover:bg-emerald-600 transition-all duration-500 relative overflow-hidden text-center">
        ...
        <i class="fa-solid fa-{{ $trend['icon'] }} text-3xl mb-6 text-emerald-600 group-hover/item:text-slate-950 transition-colors"></i>
    ...
    <div class="p-12 bg-white space-y-16 border-l border-slate-200">
     ...
     <div class="space-y-px bg-slate-200 border border-slate-200 shadow-sm">
      ...
      <div class="flex items-center gap-10 p-10 bg-white group/opp hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
       ...
       <i class="fa-solid fa-{{ $opp['icon'] }} text-2xl text-emerald-600 group-hover/opp:text-white transition-colors"></i>
   ...
   <div class="grid lg:grid-cols-2 gap-32 items-center">
    <div class="space-y-16">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">Future <br><span class="text-emerald-600">Evolution.</span></h2>
      <div class="accent-line bg-emerald-600"></div>
     </div>
     <div class="space-y-px bg-slate-200 border border-slate-200 shadow-sm">
      @foreach([
    ...
    <div class="p-8 lg:p-12 bg-slate-950 text-white space-y-16 relative overflow-hidden group shadow-sm border border-white/5">
     ...
     <div class="relative z-10 space-y-12">
      ...
      <h4 class="text-4xl font-bold text-emerald-600">Strategic <br><span class="text-white">Resilience.</span></h4>
      ...
      <div class="grid grid-cols-2 gap-px bg-white/5 pt-12 border border-white/10">
        @foreach(['ESG COMPLIANT', 'RECOVERY FOCUS', 'SMART LOGISTICS', 'CIRCULAR HUB'] as $tag)
