...
@section('content')
 ...
 <section class="relative pt-40 pb-20 bg-slate-950 overflow-hidden border-b border-slate-900">
  ...
  <div class="absolute inset-0 opacity-20">
   <img src="{{ asset('images/sectors/fmcg-industry.jpg') }}" class="w-full h-full object-cover">
  </div>
  ...
  <div class="container relative z-10 text-center space-y-12">
   <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10">
    ...
    <span class="text-white text-[10px] font-bold tracking-[0.4em] uppercase">High-Frequency Consumption Protocol</span>
   </div>
  ...
  <div class="container space-y-20">
   ...
   <div class="grid lg:grid-cols-2 gap-6">
    <div class="p-8 lg:p-12 bg-white space-y-12">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">Consumer <br><span class="text-rose-600">Essentials.</span></h2>
     ...
     <div class="space-y-8 text-lg text-slate-600 leading-relaxed border-l-4 border-slate-200 pl-8">
      <p>
       <strong class="text-slate-900 font-bold ">Fast Moving Consumer Goods (FMCG)</strong> represent products that are sold quickly at relatively low cost and are consumed on a regular basis.
      </p>
      <p>
    ...
    <div class="grid grid-cols-2 gap-px bg-slate-200">
     ...
     @foreach($categories as $cat)
      <div class="p-12 bg-white flex flex-col items-center justify-center text-center group hover:bg-slate-950 transition-all duration-700">
       ...
       <p class="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400 group-hover:text-white">{{ $cat['label'] }}</p>
      </div>
     @endforeach
    </div>
   </div>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm overflow-hidden">
    ...
    <div class="p-8 lg:p-12 bg-slate-950 text-white relative overflow-hidden group">
     ...
     <div class="relative z-10 space-y-16">
      <div class="space-y-4">
       <div class="text-rose-400 text-[10px] font-bold uppercase tracking-[0.4em]">Global Landscape</div>
      ...
      <div class="space-y-12">
       <div class="flex items-end justify-between border-b border-white/10 pb-8">
        ...
        <span class="text-4xl font-bold text-white tracking-tight ">$8T+</span>
       </div>
       <div class="flex items-end justify-between border-b border-white/10 pb-8">
    ...
    <div class="p-8 lg:p-12 bg-white relative overflow-hidden group border-l border-slate-200">
     ...
     <div class="relative z-10 space-y-16 text-right">
      <div class="space-y-4">
       <div class="text-rose-600 text-[10px] font-bold uppercase tracking-[0.4em]">Rapid Consumption</div>
      ...
      <div class="p-12 bg-rose-50 border-l-8 border-rose-600 shadow-sm text-right space-y-6">
       <p class="text-[9px] font-bold text-rose-600 uppercase tracking-[0.4em] ">Market Forecast</p>
       <p class="text-4xl font-bold text-slate-950 uppercase leading-tight tracking-tight">$500B+ Projected (2031)</p>
       <p class="text-[12px] font-bold text-slate-500 uppercase tracking-widest ">16% CAGR Growth</p>
      </div>
       ...
       <div class="grid grid-cols-2 gap-6 shadow-sm">
        @foreach(['Middle-class income', 'Rural penetration', 'Quick-commerce', 'Premiumization'] as $cat)
         <div class="p-6 bg-white flex items-center gap-4 group/item hover:bg-slate-950 transition-all duration-500">
          ...
          <span class="text-[9px] font-bold uppercase text-slate-600 group-hover/item:text-white tracking-[0.1em] leading-tight">{{ $cat }}</span>
         </div>
        @endforeach
       </div>
      </div>
   ...
   <div class="grid grid-cols-2 md:grid-cols-4 gap-6 shadow-sm">
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-rose-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110">$220B+</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">India Market (2025)</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-rose-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">10K+</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">Organized Brands</p>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-rose-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">5%</h4>
     <div class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">Global Share</div>
    </div>
    <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all">
     <h4 class="text-4xl font-bold text-rose-600 mb-4 transition-all duration-500 tracking-tight group-hover:scale-110 uppercase">8.4%</h4>
     <p class="text-[10px] font-bold text-slate-400 group-hover:text-white uppercase tracking-[0.4em]">FMCG GDP Share</p>
    </div>
   </div>
   ...
   <div class="grid lg:grid-cols-2 gap-6 shadow-sm overflow-hidden">
    <div class="p-12 bg-white space-y-16">
     <div class="section-heading text-left">
      ...
      <h2 class="text-3xl font-bold text-slate-900">High-Growth <br><span class="text-rose-600">Segments.</span></h2>
      <div class="accent-line bg-rose-600"></div>
     </div>
    ...
    <div class="p-12 bg-slate-950 text-white space-y-12 relative overflow-hidden group border-l border-slate-200">
     ...
     <div class="relative z-10 space-y-16">
      <div class="space-y-4">
       <div class="text-rose-400 text-[10px] font-bold uppercase tracking-[0.4em]">Future Vision</div>
       <h3 class="text-3xl font-bold text-white ">Smart Logistics</h3>
      </div>
      <p class="text-2xl text-slate-400 font-medium border-l-4 border-rose-600/30 pl-10 leading-relaxed ">
      ...
      <div class="grid grid-cols-2 gap-4 pt-12">
        <div class="p-8 bg-slate-950 border border-white/5 flex flex-col items-center gap-4 group/item hover:bg-rose-600 transition-all duration-500">
         ...
         <span class="text-[10px] font-bold uppercase text-slate-300 group-hover:text-slate-950 tracking-[0.2em] transition-colors leading-tight">AI Analytics</span>
        </div>
        <div class="p-8 bg-slate-950 border border-white/5 flex flex-col items-center gap-4 group/item hover:bg-rose-600 transition-all duration-500">
         <i class="fa-solid fa-leaf text-rose-600 text-3xl group-hover:text-slate-950 transition-colors"></i>
         <span class="text-[10px] font-bold uppercase text-slate-300 group-hover:text-slate-950 tracking-[0.2em] transition-colors leading-tight">Sustainable Pack</span>
        </div>
      </div>
     </div>
    </div>
