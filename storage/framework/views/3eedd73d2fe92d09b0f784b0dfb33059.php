...
<?php $__env->startSection('title', 'Policy Advocacy & Government Liaison - World Grexpo Foundation'); ?>
        ...
        <div class="container space-y-32">
            ...
            <div class="space-y-20">
                ...
                <div class="grid md:grid-cols-3 gap-2">
                    ...
                    ?>
                    <?php $__currentLoopData = $advocacy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group relative h-[550px] overflow-hidden rounded-sm border border-slate-900">
                        <img src="<?php echo e($adv['img']); ?>" class="w-full h-full object-cover grayscale group-hover:grayscale-0 group-hover:scale-105 transition-all duration-1000" alt="Advocacy Node">
                        ...
                        <div class="absolute inset-0 p-12 flex flex-col justify-end">
                            <h4 class="text-3xl font-black text-brand-accent mb-4 uppercase italic tracking-tighter group-hover:text-white transition-colors"><?php echo e($adv['t']); ?></h4>
                            <p class="text-slate-400 text-xs font-bold uppercase tracking-widest leading-relaxed group-hover:text-white transition-colors"><?php echo e($adv['d']); ?></p>
                        </div>
            ...
            <div class="bg-slate-950 p-16 lg:p-24 rounded-sm relative overflow-hidden text-center space-y-20">
                 ...
                 <div class="grid grid-cols-2 md:grid-cols-4 gap-4 relative z-10">
                    <?php $__currentLoopData = ['ESG Simplified', 'Carbon Credits', 'Green Certification', 'Transition Funding']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-10 bg-white/5 border border-white/10 rounded-sm hover:bg-brand-primary transition-all duration-700 group">
                            ...
                            <p class="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400 group-hover:text-slate-950 transition-colors"><?php echo e($item); ?></p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                 </div>
            ...
            <div class="relative bg-slate-950 p-24 rounded-sm text-left overflow-hidden border-l-[20px] border-brand-accent group">
                ...
                <div class="relative z-10 space-y-12">
                    ...
                    <a href="<?php echo e(route('join.index')); ?>" class="inline-flex items-center gap-6 px-16 py-8 bg-white text-slate-950 font-black uppercase tracking-[0.3em] text-xs rounded-sm hover:bg-brand-accent hover:text-slate-950 transition-all duration-700 shadow-4xl italic group">
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\worldgrexpo\resources\views/website/services/policy-advocacy.blade.php ENDPATH**/ ?>