                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 shadow-sm">
                    ...
                    <?php $__currentLoopData = $techs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tech): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all relative overflow-hidden">
                            ...
                            <h4 class="text-xl font-bold text-slate-950 group-hover:text-white  mb-2  leading-tight"><?php echo e($tech['title']); ?></h4>
                            <p class="text-[9px] font-bold text-slate-400 uppercase tracking-[0.2em] leading-tight transition-colors"><?php echo e($tech['desc']); ?></p>
                        </div>
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <?php $__currentLoopData = ['Plastic Crisis', 'ESG Commitments', 'Food-grade Demand', 'Circular Regulation']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="px-8 py-6 bg-slate-950 text-[9px] font-bold text-slate-400 uppercase tracking-[0.2em] text-center hover:bg-cyan-600 hover:text-slate-950 transition-colors cursor-default"><?php echo e($driver); ?></span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                    </div>
                        ...
                        <tbody class="bg-white  font-medium">
                            ...
                            <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-slate-50 transition-colors">
                                    <td class="p-10 font-bold text-slate-900 uppercase tracking-[0.1em] border border-slate-200 bg-slate-50/50"><?php echo e($row[0]); ?></td>
                    ...
                    <ul class="space-y-10">
                        <?php $__currentLoopData = [
                            ...
                            <li class="flex items-start gap-8 group/item">
                                ...
                                <span class="text-[12px] font-bold text-slate-600 uppercase tracking-[0.2em] group-hover/item:text-slate-950 transition-colors leading-relaxed"><?php echo e($outlook); ?></span>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
                ...
                <div class="p-12 bg-slate-950 text-white space-y-12 group">
                    ...
                    <div class="flex flex-wrap gap-4 pt-12">
                        <?php $__currentLoopData = ['Europe', 'USA', 'Japan', 'China']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="px-8 py-4 bg-white/5 border border-white/10 text-[9px] font-bold uppercase tracking-[0.3em] hover:bg-cyan-600 hover:text-slate-950 transition-all cursor-default"><?php echo e($hub); ?> Hubs</span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 shadow-sm">
                    ...
                    <?php $__currentLoopData = $outputs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $out): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all relative overflow-hidden">
                            ...
                            <h4 class="text-xl font-bold text-slate-950 group-hover:text-white  mb-2  leading-tight"><?php echo e($out['label']); ?></h4>
                            <p class="text-[9px] font-bold text-slate-400 uppercase tracking-[0.2em] leading-tight transition-colors"><?php echo e($out['sub']); ?></p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
