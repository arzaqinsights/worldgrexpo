...
<?php $__env->startSection('title', 'Healthcare Industry Overview'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-32 pb-24 bg-slate-900 text-white overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-25"
            style="background-image: url('<?php echo e(asset('images/sectors/healthcare-hero.png')); ?>'); background-size: cover; background-position: center;">
        </div>
        ...
        <div class="container space-y-16">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative group animate-in fade-in slide-in-from-right duration-700">
                    ...
                    <img src="<?php echo e(asset('images/sectors/healthcare-details.png')); ?>" alt="Healthcare Industry"
                ...
                <div class="p-8 rounded-3xl bg-gradient-to-br from-slate-800 to-slate-900 text-white shadow-2xl transform hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php $__currentLoopData = ['Aging Population', 'Chronic Diseases', 'Tech Innovation', 'Insurance Expansion']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="p-10 rounded-3xl bg-slate-900 text-white overflow-hidden relative">
                ...
                <div class="relative z-10 grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="p-8 bg-blue-600 rounded-2xl shadow-xl">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php $__currentLoopData = ['Delhi NCR', 'Mumbai', 'Bengaluru', 'Hyderabad', 'Chennai', 'Kolkata']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="order-1 md:order-2 p-8 bg-slate-100 rounded-3xl border border-slate-200 shadow-sm relative overflow-hidden group">
                    <div class="relative z-10">
                        ...
                        <div class="flex flex-wrap gap-3">
                            <?php $__currentLoopData = ['USA', 'China', 'India', 'Germany', 'UK', 'Japan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center gap-2 px-4 py-2 bg-white rounded-full border border-slate-200 text-sm font-bold text-slate-600 group-hover:border-blue-300 transition-colors">
                                <i class="fa-solid fa-earth-americas text-blue-500"></i> <?php echo e($country); ?>
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\worldgrexpo\resources\views/website/sectors/healthcare-industry.blade.php ENDPATH**/ ?>