        ...
        <div class="flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div class="w-full lg:w-5/12 sticky top-32 z-30 hidden lg:block self-start">
                <div class="relative rounded-2xl overflow-hidden shadow-2xl group w-full h-[calc(100vh-10rem)] max-h-[700px] min-h-[500px]">
                    <img src="<?php echo e(asset('images/membership-sidebar.png')); ?>" alt="MSMECCII Membership" class="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-1000">
...
<?php /**PATH C:\laragon\www\msmeccii\resources\views/website/home/partials/membership.blade.php ENDPATH**/ ?>