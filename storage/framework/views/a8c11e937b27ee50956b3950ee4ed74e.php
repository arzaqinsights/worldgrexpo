 ...
 <div class="container relative z-10">
  ...
  <div class="flex flex-col lg:flex-row justify-between items-end mb-24 gap-12 animate-on-scroll">
   <div class="max-w-4xl space-y-8">
    ...
    <p class="text-2xl text-slate-500 text-lg leading-relaxed max-w-2xl">
   ...
   <div class="group relative bg-white overflow-hidden transition-all duration-700 animate-on-scroll">
    ...
    <div class="relative aspect-[4/5] overflow-hidden bg-slate-900">
     <img src="<?php echo e($leader['img']); ?>" 
      ...
      class="w-full h-full object-cover transition-all duration-[2000ms] hover:scale-105 opacity-80 hover:opacity-100">
     ...
     <div class="absolute bottom-0 left-0 right-0 p-10">
      <div class="space-y-4">
       <h3 class="text-3xl font-bold text-white uppercase tracking-tight leading-none hover:text-brand-primary transition-colors">
        <?php echo e($leader['name']); ?>

       </h3>
       <div class="flex items-center gap-4">
        <span class="w-10 h-1 bg-brand-accent"></span>
        <span class="text-[9px] font-bold text-brand-accent uppercase tracking-[0.2em]"><?php echo e($leader['role']); ?></span>
       </div>
      </div>
     </div>
    </div>
    ...
    <!-- Bio Layer (Sharp) -->
    <div class="p-10 space-y-8 bg-white hover:bg-slate-50 transition-colors duration-700 h-full">
     <p class="text-slate-500 text-[11px] font-bold uppercase tracking-widest leading-relaxed">
      <?php echo e($leader['desc']); ?>

     </p>
     
     <div class="pt-8 border-t border-slate-100 hover:border-slate-200">
      <a href="#" class="inline-flex items-center gap-4 text-[9px] font-bold text-slate-900 uppercase tracking-[0.4em] hover:text-brand-primary transition-all">
       View Profile <i class="fa-solid fa-plus text-[8px] hover:rotate-90 transition-transform"></i>
      </a>
     </div>
    </div>

    <!-- Sharp Side Accent -->
    <div class="absolute top-0 right-0 w-1 h-0 bg-brand-primary hover:h-full transition-all duration-700"></div>
   </div>
