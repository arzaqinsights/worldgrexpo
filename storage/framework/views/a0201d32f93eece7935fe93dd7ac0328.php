...
<?php $__env->startSection('title', 'Strategic Promotion Services - World Grexpo Foundation'); ?>
        ...
        <div class="container space-y-32">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-24">
                <div class="w-full lg:w-1/2 space-y-12 animate-on-scroll">
                    ...
                    <div class="space-y-6">
                        <?php $__currentLoopData = ['Proprietary Brand Positioning', 'Multi-Node Global Campaigns', 'Industrial Lead Generation']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center gap-6 group">
                            ...
                            <span class="text-xs font-black uppercase tracking-widest text-slate-950"><?php echo e($feature); ?></span>
                        </div>
            ...
            <div class="grid md:grid-cols-3 gap-2">
                ...
                <div class="group relative overflow-hidden rounded-sm h-[500px] border border-slate-900">
                    <img src="<?php echo e($step['img']); ?>" class="w-full h-full object-cover grayscale group-hover:grayscale-0 group-hover:scale-105 transition-all duration-1000" alt="Industrial Node">
                    ...
                    <div class="absolute inset-0 p-12 flex flex-col justify-end">
                        <h4 class="text-4xl font-black text-brand-accent mb-4 uppercase italic tracking-tighter group-hover:text-white transition-colors"><?php echo e($step['t']); ?></h4>
                        <p class="text-slate-400 text-xs font-bold uppercase tracking-widest leading-relaxed group-hover:text-white transition-colors"><?php echo e($step['d']); ?></p>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-2">
                        ...
                        <div class="p-10 bg-white/5 border border-white/10 rounded-sm hover:bg-brand-primary transition-all duration-700 group">
                            <div class="w-12 h-12 bg-white/5 border border-white/10 flex items-center justify-center rounded-sm mb-8 group-hover:bg-white group-hover:rotate-12 transition-all duration-700">
                                <i class="fa-solid fa-<?php echo e($dev['icon']); ?> text-brand-accent group-hover:text-brand-primary transition-colors"></i>
                            </div>
                            <h4 class="text-xl font-black text-white uppercase tracking-tighter italic mb-4 group-hover:text-slate-950 transition-colors"><?php echo e($dev['title']); ?></h4>
                            <p class="text-[10px] font-black text-slate-500 uppercase tracking-widest leading-loose group-hover:text-slate-900 transition-colors"><?php echo e($dev['desc']); ?></p>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            ...
            <div class="text-center py-32 border-t border-slate-100">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center gap-6 px-16 py-8 bg-slate-950 text-white font-black uppercase tracking-[0.3em] text-xs rounded-sm hover:bg-brand-accent hover:text-slate-950 transition-all shadow-2xl group italic">
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\worldgrexpo\resources\views/website/services/strategic-promotion.blade.php ENDPATH**/ ?>