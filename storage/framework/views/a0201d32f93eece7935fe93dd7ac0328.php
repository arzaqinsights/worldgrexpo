    ...
    <section class="relative pt-64 pb-32 bg-slate-950 text-white overflow-hidden border-b border-slate-900">
        ...
        <div class="container relative z-10 text-left">
            <div class="inline-flex items-center gap-4 px-6 py-2 bg-white/5 border border-white/10 backdrop-blur-md mb-12">
                ...
                <span class="text-white text-[10px] font-black tracking-[0.4em] uppercase">Market Dominance</span>
            </div>
        ...
        <div class="container space-y-48">
                ...
                <div class="space-y-12 animate-on-scroll">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center gap-8 group">
                            <div class="w-12 h-12 bg-slate-50 border border-slate-100 flex items-center justify-center group-hover:bg-slate-950 transition-all duration-500 shadow-sm">
                                <i class="fa-solid fa-check text-brand-primary text-sm group-hover:text-white"></i>
                            </div>
                            <span class="text-xs font-black uppercase tracking-[0.2em] text-slate-950"><?php echo e($feature); ?></span>
                        </div>
            ...
            <div class="bg-slate-950 p-24 lg:p-32 relative overflow-hidden shadow-3xl">
                ...
                <div class="relative z-10 space-y-24">
                    <div class="flex flex-col md:flex-row justify-between items-end gap-12 text-left">
                        ...
                        <p class="text-2xl text-slate-400 font-medium max-w-xl leading-relaxed italic">
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-white/5 border border-white/10 shadow-3xl">
                        ...
                        <div class="p-12 bg-transparent hover:bg-brand-primary transition-all duration-700 group">
                            <div class="w-16 h-16 bg-white/5 border border-white/10 flex items-center justify-center mb-10 group-hover:bg-white group-hover:rotate-12 transition-all duration-700">
                                <i class="fa-solid fa-<?php echo e($dev['icon']); ?> text-brand-primary text-2xl group-hover:text-brand-primary-dark"></i>
                            </div>
                            <h4 class="text-2xl font-black text-white uppercase tracking-tighter mb-6 group-hover:text-slate-950 transition-colors leading-none">
                                <?php echo e($dev['title']); ?>

                            </h4>
                            <p class="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] leading-relaxed group-hover:text-slate-900 transition-colors">
                                <?php echo e($dev['desc']); ?>
            ...
            <div class="relative bg-slate-900 p-24 lg:p-32 overflow-hidden group border-t border-slate-800 text-center">
                ...
                <div class="relative z-10 space-y-16 max-w-5xl mx-auto">
                    ...
                    <a href="<?php echo e(route('contact')); ?>" class="btn-sharp px-20 group mx-auto">
