                        ...
                        <?php $__currentLoopData = $delegates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="flex-1 flex flex-col items-center group/bar">
                                ...
                                <div class="w-full relative transition-all duration-500 group-hover/bar:scale-x-105"
                                     style="height: <?php echo e(($h / 100) * 350); ?>px; background: <?php echo e($isLatest ? 'var(--color-brand-primary)' : 'var(--color-brand-accent)'); ?>;">
                                    ...
                                    <div class="absolute inset-0 flex flex-col items-center justify-center text-center p-2">
                                        <div class="text-xl lg:text-3xl font-black <?php echo e($isLatest ? 'text-white' : 'text-brand-primary-dark'); ?> tracking-tighter tabular-nums leading-none">
                                ...
                                <!-- Year Label (Sharp) -->
                                <div class="mt-8">
                                    <span class="text-xs font-black <?php echo e($isLatest ? 'text-brand-primary' : 'text-slate-400'); ?> tracking-widest uppercase"><?php echo e($stat->year); ?></span>
                                </div>
                            </div>
        ...
        <div class="mt-24 pt-16 border-t border-slate-100 flex flex-col lg:flex-row items-center justify-between gap-12">
            <div class="flex items-center gap-8">
                ...
                <p class="text-slate-400 text-[10px] font-black uppercase tracking-[0.3em] italic">
                    Certified Industrial Excellence — Covering <?php echo e(count(config('sectors.sectors'))); ?>+ Global Sectors
                </p>
            </div>

            <a href="<?php echo e(route('growth')); ?>" class="btn-sharp px-16 group">
                Statistical Report
