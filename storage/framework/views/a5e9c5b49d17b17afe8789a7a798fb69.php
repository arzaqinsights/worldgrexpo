<?php $__env->startSection('title', 'Sustainability Leadership Overview'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-64 pb-32 bg-slate-950 overflow-hidden border-b border-slate-900">
        ...
        <div class="absolute inset-0 opacity-20">
            <img src="<?php echo e(asset('images/sectors/sustainability-leadership.jpg')); ?>" class="w-full h-full object-cover grayscale">
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/10 border border-white/10 shadow-2xl relative z-10">
                    ...
                    <?php $__currentLoopData = $pillars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-12 bg-slate-950 group/item hover:bg-lime-600 transition-all duration-500">
                            <i class="fa-solid fa-<?php echo e($p['icon']); ?> text-4xl text-lime-600 group-hover/item:text-slate-950 mb-8 transition-colors"></i>
                            <h4 class="text-xl font-black uppercase text-white group-hover/item:text-slate-950 mb-4 transition-colors italic"><?php echo e($p['title']); ?></h4>
                            <p class="text-[10px] font-black uppercase text-slate-500 group-hover/item:text-slate-900 tracking-widest leading-relaxed transition-colors italic"><?php echo e($p['desc']); ?></p>
                        </div>
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\worldgrexpo\resources\views/website/sectors/sustainability-leadership.blade.php ENDPATH**/ ?>