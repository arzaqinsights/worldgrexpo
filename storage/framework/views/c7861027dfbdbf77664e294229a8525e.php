<?php $__env->startSection('title', 'Plastic Machinery Industry'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-32 pb-24 bg-slate-900 text-white overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-10"
            style="background-image: url('<?php echo e(asset('images/sectors/plastic-machinery.jpg')); ?>'); background-size: cover; background-position: center;">
        </div>
    ...
    <section class="py-16 bg-white">
        <div class="container space-y-16">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <img src="<?php echo e(asset('images/sectors/plastic-machinery.jpg')); ?>" alt="Plastic Machinery India"
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\msmeccii\resources\views/website/sectors/plastic-machinery.blade.php ENDPATH**/ ?>