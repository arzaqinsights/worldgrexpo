...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('admin.settings.bulk-update')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-8 bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center gap-4 p-4 bg-slate-50 rounded-xl border border-slate-100">
                        <?php if(isset($site['signature'])): ?>
                            <div class="h-16 w-32 flex items-center justify-center bg-white rounded-lg border border-slate-200 p-2">
                                <img src="<?php echo e($site['signature']); ?>" class="max-h-full max-w-full object-contain">
                            </div>
                        <?php endif; ?>
                        <div class="flex-1">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div class="space-y-3">
                        ...
                        <input type="text" name="settings[phone_1]" value="<?php echo e($site['phone_1'] ?? ''); ?>"
                        ...
                        <input type="text" name="settings[phone_2]" value="<?php echo e($site['phone_2'] ?? ''); ?>"
                            placeholder="Secondary (optional)"
                            class="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm font-medium focus:ring-2 focus:ring-brand-primary/30 focus:border-brand-primary outline-none">
                        <input type="text" name="settings[phone_3]" value="<?php echo e($site['phone_3'] ?? ''); ?>"
                    ...
                    <div class="space-y-3">
                        ...
                        <input type="email" name="settings[email_1]" value="<?php echo e($site['email_1'] ?? ''); ?>"
                            placeholder="Primary: support@World Grexpo.in"
                            class="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm font-medium focus:ring-2 focus:ring-brand-primary/30 focus:border-brand-primary outline-none">
                        <input type="email" name="settings[email_2]" value="<?php echo e($site['email_2'] ?? ''); ?>"
                            placeholder="Secondary (optional)"
                            class="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm font-medium focus:ring-2 focus:ring-brand-primary/30 focus:border-brand-primary outline-none">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="settings[address]" rows="3"
                            ...
                            class="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm font-medium focus:ring-2 focus:ring-brand-primary/30 focus:border-brand-primary outline-none resize-none"><?php echo e($site['address'] ?? ''); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                ...
                <div class="p-6 space-y-5">
                    <div>
                        ...
                        <input type="url" name="settings[facebook_url]" value="<?php echo e($site['facebook_url'] ?? ''); ?>"
                    ...
                    <div>
                        ...
                        <input type="url" name="settings[twitter_url]" value="<?php echo e($site['twitter_url'] ?? ''); ?>"
                    ...
                    <div>
                        ...
                        <input type="url" name="settings[instagram_url]" value="<?php echo e($site['instagram_url'] ?? ''); ?>"
                    ...
                    <div>
                        ...
                        <input type="url" name="settings[linkedin_url]" value="<?php echo e($site['linkedin_url'] ?? ''); ?>"
                    ...
                    <div>
                        ...
                        <input type="url" name="settings[youtube_url]" value="<?php echo e($site['youtube_url'] ?? ''); ?>"
                    ...
                    <div>
                        ...
                        <input type="url" name="settings[whatsapp_url]" value="<?php echo e($site['whatsapp_url'] ?? ''); ?>"
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="settings[payment_gateway_limit]"
                                value="<?php echo e($site['payment_gateway_limit'] ?? '500000'); ?>"
                    ...
                    <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="settings[bank_name]" value="<?php echo e($site['bank_name'] ?? ''); ?>"
                        ...
                        <div>
                            <label class="block text-[10px] font-black text-slate-400 uppercase mb-1">Account Holder
                                Name</label>
                            <input type="text" name="settings[account_name]" value="<?php echo e($site['account_name'] ?? ''); ?>"
                        ...
                        <div>
                            ...
                            <input type="text" name="settings[account_number]" value="<?php echo e($site['account_number'] ?? ''); ?>"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-[10px] font-black text-slate-400 uppercase mb-1">IFSC Code
                                    (India)</label>
                                <input type="text" name="settings[ifsc_code]" value="<?php echo e($site['ifsc_code'] ?? ''); ?>"
                            ...
                            <div>
                                <label class="block text-[10px] font-black text-slate-400 uppercase mb-1">SWIFT / BIC
                                    Code</label>
                                <input type="text" name="settings[swift_code]" value="<?php echo e($site['swift_code'] ?? ''); ?>"
                        ...
                        <div class="md:col-span-2">
                            <label class="block text-[10px] font-black text-slate-400 uppercase mb-1">Bank Branch
                                Address</label>
                            <input type="text" name="settings[bank_branch]" value="<?php echo e($site['bank_branch'] ?? ''); ?>"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="settings[beneficiary_address]"
                                value="<?php echo e($site['beneficiary_address'] ?? ''); ?>"
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="settings[mail_host]" value="<?php echo e($site['mail_host'] ?? ''); ?>"
                                placeholder="e.g. smtp.gmail.com"
                                class="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm font-medium outline-none focus:border-brand-primary">
                        </div>
                        <div>
                            <label class="block text-[10px] font-black text-slate-400 uppercase mb-1">SMTP Port</label>
                            <input type="text" name="settings[mail_port]" value="<?php echo e($site['mail_port'] ?? '587'); ?>"
                        ...
                        <div>
                            ...
                            <select name="settings[mail_encryption]" class="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm font-medium outline-none focus:border-brand-primary">
                                <option value="tls" <?php echo e(($site['mail_encryption'] ?? 'tls') == 'tls' ? 'selected' : ''); ?>>TLS</option>
                                <option value="ssl" <?php echo e(($site['mail_encryption'] ?? '') == 'ssl' ? 'selected' : ''); ?>>SSL</option>
                                <option value="none" <?php echo e(($site['mail_encryption'] ?? '') == 'none' ? 'selected' : ''); ?>>None</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="settings[mail_username]" value="<?php echo e($site['mail_username'] ?? ''); ?>"
                        ...
                        <div>
                            ...
                            <input type="password" name="settings[mail_password]" value="<?php echo e($site['mail_password'] ?? ''); ?>"
                                placeholder="••••••••••••"
                                class="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm font-medium outline-none focus:border-brand-primary">
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="email" name="settings[mail_from_address]" value="<?php echo e($site['mail_from_address'] ?? ''); ?>"
                        ...
                        <div>
                            ...
                            <input type="text" name="settings[mail_from_name]" value="<?php echo e($site['mail_from_name'] ?? 'World Grexpo'); ?>"
                                placeholder="e.g. MSME Chamber of Commerce"
                                class="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm font-medium outline-none focus:border-brand-primary">
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\worldgrexpo\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>