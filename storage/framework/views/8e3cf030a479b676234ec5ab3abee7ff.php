...
<?php $__env->startSection('content'); ?>
  ...
  <section class="relative pt-40 pb-20 bg-slate-950 overflow-hidden border-b border-slate-900">
    ...
    <div class="absolute inset-0 opacity-20">
      <img src="<?php echo e(asset('images/sectors/e-waste-recycling.jpeg')); ?>" class="w-full h-full object-cover">
    </div>
        ...
        <div class="relative group">
          ...
          <div class="relative h-full overflow-hidden border-l border-slate-200 shadow-sm">
            <img src="<?php echo e(asset('images/sectors/e-waste-recycling.jpeg')); ?>" alt="E-Waste Recycling"
              class="w-full h-full object-cover hover:-0 transition-all duration-1000">
          </div>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6 shadow-sm">
          ...
          <?php $__currentLoopData = $process; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all relative overflow-hidden">
              ...
              <p class="text-[10px] font-bold text-slate-900 group-hover:text-white uppercase tracking-[0.3em] leading-tight transition-colors"><?php echo e($p['label']); ?></p>
            </div>
            ...
            <div class="space-y-8">
              ...
              <div class="grid grid-cols-2 gap-4">
                <?php $__currentLoopData = ['Rapid Consumption', 'Shorter Lifecycles', 'IT Upgrades', 'ESG Mandates']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <span class="px-8 py-6 bg-slate-950 text-[9px] font-bold text-slate-400 uppercase tracking-[0.2em] text-center hover:bg-yellow-600 hover:text-slate-950 transition-colors cursor-default"><?php echo e($driver); ?></span>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </div>
            </div>
          </div>
          ...
          <div class="grid grid-cols-2 gap-4 pt-8">
             <?php $__currentLoopData = ['Delhi NCR', 'Mumbai', 'Bengaluru', 'Chennai', 'Hyderabad', 'Pune']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="flex items-center gap-4 group/item">
                ...
                <span class="text-[12px] font-bold uppercase text-slate-600 group-hover:text-slate-400 tracking-[0.2em] transition-colors leading-relaxed group-hover/item:text-yellow-600"><?php echo e($hub); ?></span>
              </div>
             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
        </div>
          ...
          <ul class="space-y-6">
            <?php $__currentLoopData = [
              ...
              <li class="flex items-start gap-8 group/item">
                ...
                <span class="text-[14px] font-bold uppercase text-slate-600 tracking-[0.2em] transition-colors leading-relaxed group-hover/item:text-slate-950 "><?php echo e($driver); ?></span>
              </li>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </ul>
        </div>
          ...
          <?php $__currentLoopData = ['Precious Metal Recovery', 'PCB Recycling', 'Battery Recycling', 'Refurbishment', 'Data Destruction', 'Reverse Logistics']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="p-8 bg-slate-50 rounded-2xl text-center group hover:shadow-lg transition-all relative overflow-hidden">
              <div class="absolute top-0 left-0 w-full h-1 bg-yellow-600 scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-500"></div>
               <p class="text-[12px] font-bold uppercase text-slate-600 group-hover:text-white tracking-[0.2em] transition-colors leading-tight"><?php echo e($seg); ?></p>
            </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
      </div>
            ...
            <div class="grid grid-cols-1 gap-px bg-white/5 pt-12 border border-white/10">
               <?php $__currentLoopData = ['Massive Electronics Market', 'Cost-effective processing', 'Technical labor availability', 'Government formalization']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="p-8 bg-slate-950 border border-white/5 flex items-center gap-8 group/item hover:bg-yellow-600 transition-all duration-500">
                  ...
                  <span class="text-[12px] font-bold uppercase text-slate-300 group-hover/item:text-slate-950 tracking-[0.2em] transition-colors leading-tight"><?php echo e($tag); ?></span>
                </div>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
          </div>
