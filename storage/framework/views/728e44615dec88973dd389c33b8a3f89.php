...
<section class="relative h-screen bg-slate-950 overflow-hidden">
    ...
    <div class="swiper hero-swiper h-full w-full">
        <div class="swiper-wrapper h-full"><?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if($slider->image_path): ?><div class="swiper-slide h-full w-full relative bg-slate-900"><img src="<?php echo e(asset($slider->image_path)); ?>" alt="Slider Image" class="w-full h-full object-cover grayscale-[0.2] hover:grayscale-0 transition-all duration-[2000ms]" loading="eager"><div class="absolute inset-0 bg-gradient-to-b from-slate-950/40 via-transparent to-slate-950/80"></div><div class="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,rgba(2,6,23,0.4)_100%)]"></div></div><?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></div>
    ...
    <script>
        (function() {
            ...
            function initHeroSwiper() {
                ...
                const sliderCount = <?php echo e(count($sliders ?? [])); ?>;
