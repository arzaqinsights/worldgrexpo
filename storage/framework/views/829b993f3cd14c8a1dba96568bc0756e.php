...
<?php $__env->startSection('content'); ?>
 ...
 <section class="relative pt-40 pb-20 bg-slate-950 overflow-hidden border-b border-slate-900">
  ...
  <div class="absolute inset-0 opacity-20">
   <img src="<?php echo e(asset('images/sectors/plastic-recycling.jpeg')); ?>" class="w-full h-full object-cover">
  </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-5 gap-4 relative z-10">
     ...
     <?php $__currentLoopData = $processes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="p-12 bg-slate-950 text-center group/step hover:bg-cyan-600 transition-all duration-500">
       ...
       <h4 class="text-[10px] font-bold uppercase text-slate-400 group-hover/step:text-slate-950 tracking-[0.2em] leading-tight transition-colors"><?php echo e($step['label']); ?></h4>
      </div>
