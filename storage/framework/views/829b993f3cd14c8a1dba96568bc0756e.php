<?php $__env->startSection('title', 'Plastic Recycling Industry Overview'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-64 pb-32 bg-slate-950 overflow-hidden border-b border-slate-900">
        ...
        <div class="absolute inset-0 opacity-20">
            <img src="<?php echo e(asset('images/sectors/plastic-recycling.jpeg')); ?>" class="w-full h-full object-cover grayscale">
        </div>
        ...
        <div class="container space-y-48">
            ...
            <div class="grid lg:grid-cols-2 gap-px bg-slate-200 border border-slate-200">
                ...
                <div class="relative group">
                    ...
                    <div class="relative h-full overflow-hidden border-l border-slate-200 shadow-3xl">
                        <img src="<?php echo e(asset('images/sectors/plastic-recycling.jpeg')); ?>" alt="Plastic Recycling"
            ...
            <div class="p-24 bg-slate-950 text-white space-y-16 relative overflow-hidden group border border-white/5 shadow-3xl">
                ...
                <div class="grid grid-cols-2 md:grid-cols-5 gap-px bg-white/10 border border-white/10 shadow-2xl relative z-10">
                    ...
                    ?>
                    <?php $__currentLoopData = $processes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-12 bg-slate-950 text-center group/step hover:bg-cyan-600 transition-all duration-500">
                            <i class="fa-solid fa-<?php echo e($step['icon']); ?> text-4xl text-cyan-600 group-hover/step:text-slate-950 mb-8 transition-colors"></i>
                            <h4 class="text-[10px] font-black uppercase text-slate-400 group-hover/step:text-slate-950 tracking-[0.2em] leading-tight transition-colors"><?php echo e($step['label']); ?></h4>
                        </div>
                    ...
                    <div class="relative z-10 space-y-16">
                        ...
                        <div class="p-8 bg-white/5 border border-white/10 shadow-2xl">
                             ...
                             <div class="grid grid-cols-1 gap-4">
                                <?php $__currentLoopData = ['Sustainability Regulations', 'Brand ESG Commitments', 'Ban on Virgin Plastics', 'E-commerce Expansion']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center gap-4 group/item">
                                        <div class="w-1.5 h-1.5 bg-cyan-600"></div>
                                        <span class="text-[9px] font-black uppercase text-slate-400 group-hover/item:text-white transition-colors tracking-widest leading-tight italic"><?php echo e($d); ?></span>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                             </div>
                        </div>
            ...
            <div class="p-12 bg-slate-950 border border-white/10 shadow-3xl text-center group">
                ...
                <div class="flex flex-wrap justify-center gap-px bg-white/10 border border-white/10">
                    <?php $__currentLoopData = ['PET', 'HDPE', 'LDPE', 'PP', 'PVC', 'PS', 'ABS']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $poly): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\worldgrexpo\resources\views/website/sectors/plastic-recycling.blade.php ENDPATH**/ ?>