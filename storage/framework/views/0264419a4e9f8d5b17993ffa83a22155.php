    ...
    <div class="container relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-slate-200 border border-slate-200 auto-rows-[300px]">
            <?php $__currentLoopData = $values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="<?php echo e($v['size']); ?> group relative overflow-hidden bg-slate-900 transition-all duration-700">
                    ...
                    <div class="absolute inset-0 p-12 flex flex-col justify-between z-20">
                        <div class="flex justify-between items-start">
                            <span class="text-6xl font-black text-white/5 group-hover:text-brand-accent transition-colors duration-500 tabular-nums"><?php echo e($v['id']); ?></span>
