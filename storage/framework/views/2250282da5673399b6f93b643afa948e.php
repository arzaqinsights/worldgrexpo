...
<?php $__env->startSection('title', 'Biogas Industry'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-64 pb-32 bg-slate-950 overflow-hidden border-b border-slate-900">
        ...
        <div class="absolute inset-0 opacity-20">
            <img src="<?php echo e(asset('images/sectors/biogas-industry.webp')); ?>" class="w-full h-full object-cover grayscale">
        </div>
            ...
            <div class="grid lg:grid-cols-2 gap-24 items-center">
                ...
                <div class="relative group animate-on-scroll">
                    ...
                    <div class="relative overflow-hidden border border-slate-200 shadow-3xl">
                        <img src="<?php echo e(asset('images/sectors/biogas-industry.webp')); ?>" alt="Biogas Industry"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-px bg-slate-200 border border-slate-200 shadow-3xl">
                    ...
                    <?php $__currentLoopData = $apps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-12 bg-white text-center group hover:bg-slate-950 transition-all duration-700">
                            <div class="w-16 h-16 mx-auto mb-8 bg-slate-50 border border-slate-100 flex items-center justify-center text-<?php echo e($app['color']); ?>-600 group-hover:bg-<?php echo e($app['color']); ?>-600 group-hover:text-white transition-all shadow-sm">
                                <i class="fa-solid fa-<?php echo e($app['icon']); ?> text-2xl"></i>
                            </div>
                            <h4 class="text-[10px] font-black text-slate-900 group-hover:text-white uppercase tracking-[0.3em] leading-tight"><?php echo e($app['label']); ?></h4>
                        </div>
                    ...
                    <div class="relative z-10 space-y-16">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex flex-wrap gap-px bg-white/10 border border-white/10">
                                <?php $__currentLoopData = ['Renewable Demand', 'Decarbonization', 'Waste-to-Energy', 'ESG Adoption', 'Blending Mandates']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="px-6 py-3 bg-slate-950 text-[9px] font-black text-slate-300 uppercase tracking-[0.2em] border-r border-white/10 last:border-0"><?php echo e($driver); ?></span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-px bg-slate-100 border border-slate-100">
                                <?php $__currentLoopData = ['Punjab', 'Haryana', 'Uttar Pradesh', 'Maharashtra', 'Gujarat', 'Karnataka']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="p-6 bg-white flex items-center gap-4 group/state hover:bg-slate-950 transition-colors">
                                        ...
                                        <span class="text-[10px] font-black text-slate-600 group-hover/state:text-white uppercase tracking-[0.2em]"><?php echo e($state); ?></span>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                        ...
                        <ul class="space-y-6">
                            <?php $__currentLoopData = [
                                ...
                                <li class="flex items-start gap-6 group/item">
                                    ...
                                    <span class="text-[10px] font-black text-slate-600 uppercase tracking-[0.2em] group-hover/item:text-slate-950 transition-colors leading-relaxed"><?php echo e($point); ?></span>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-px bg-slate-200 border border-slate-200 shadow-2xl">
                        ...
                        <?php $__currentLoopData = $trends; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trend): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="p-10 bg-white group hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
                                <div class="absolute top-0 left-0 w-1 h-full bg-<?php echo e($trend['color']); ?>-500 scale-y-0 group-hover:scale-y-100 transition-transform origin-top duration-500"></div>
                                <div class="flex items-center gap-6">
                                    <div class="w-10 h-10 bg-<?php echo e($trend['color']); ?>-100 flex items-center justify-center text-<?php echo e($trend['color']); ?>-600 group-hover:bg-<?php echo e($trend['color']); ?>-600 group-hover:text-white transition-all shadow-sm">
                                        <i class="fa-solid fa-<?php echo e($trend['icon']); ?> text-sm"></i>
                                    </div>
                                    <span class="text-[9px] font-black text-slate-600 group-hover:text-white uppercase tracking-[0.2em] leading-tight"><?php echo e($trend['label']); ?></span>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                        ...
                        <ul class="space-y-8">
                            <?php $__currentLoopData = [
                                ...
                                <li class="flex items-start gap-6 group/item">
                                    ...
                                    <span class="text-slate-400 text-lg font-black uppercase tracking-widest group-hover/item:text-white transition-colors"><?php echo e($why); ?></span>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\worldgrexpo\resources\views/website/sectors/biogas-industry.blade.php ENDPATH**/ ?>