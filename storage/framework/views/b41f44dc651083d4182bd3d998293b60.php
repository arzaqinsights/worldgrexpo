<section class="section-padding bg-slate-50 relative overflow-hidden border-b border-slate-100">
    <!-- Industrial Accents -->
        ...
        <div class="max-w-4xl mb-24 animate-on-scroll">
            <div class="space-y-8">
                <div class="section-heading">
                    ...
                    <h2>The <span class="text-brand-primary">POWER</span> Framework.</h2>
                    <div class="accent-line"></div>
                </div>
                <p class="text-2xl text-slate-500 font-medium leading-relaxed max-w-3xl">
            ...
            <?php $__currentLoopData = $power; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="p-12 bg-white group hover:bg-slate-900 transition-all duration-700 animate-on-scroll">
                    <div class="space-y-10">
                        <div class="w-14 h-14 bg-slate-50 border border-slate-100 flex items-center justify-center text-brand-primary group-hover:bg-brand-primary group-hover:text-white group-hover:border-brand-primary transition-all shadow-sm">
                            <i class="fa-solid <?php echo e($p['icon']); ?> text-lg"></i>
                        </div>
                        
                        <div class="space-y-6">
                            <div class="flex items-baseline gap-4">
                                <span class="text-5xl font-black text-brand-primary leading-none"><?php echo e($p['l']); ?></span>
                                <h4 class="text-xl font-black text-slate-900 group-hover:text-white uppercase tracking-tighter transition-colors leading-none"><?php echo e($p['t']); ?></h4>
                            </div>
                            <p class="text-[10px] font-black text-slate-400 group-hover:text-white/40 uppercase tracking-[0.2em] leading-relaxed transition-colors"><?php echo e($p['d']); ?></p>
                        </div>
