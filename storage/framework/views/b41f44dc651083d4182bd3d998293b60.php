     ...
     <div class="space-y-10">
      ...
      <div class="space-y-6">
       <div class="flex items-baseline gap-4">
        <span class="text-2xl font-bold text-brand-primary leading-none"><?php echo e($p['l']); ?></span>
        <h4 class="text-xl font-bold text-slate-900 hover:text-white uppercase tracking-tight transition-colors leading-none"><?php echo e($p['t']); ?></h4>
       </div>
       <p class="text-[10px] font-bold text-slate-400 hover:text-white/40 uppercase tracking-[0.2em] leading-relaxed transition-colors"><?php echo e($p['d']); ?></p>
      </div>
