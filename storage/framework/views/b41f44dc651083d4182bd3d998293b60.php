    ...
    <div class="p-6 md:p-8 bg-white group hover:bg-slate-900 transition-all duration-500">
     <div class="space-y-6">
      <div class="w-10 h-10 bg-slate-50 border border-slate-100 flex items-center justify-center text-brand-primary group-hover:bg-brand-primary group-hover:text-white group-hover:border-brand-primary transition-all shadow-sm">
       <i class="fa-solid <?php echo e($p['icon']); ?> text-sm"></i>
      </div>
      
      <div class="space-y-4">
       <div class="flex items-baseline gap-2">
        <span class="text-xl font-black text-brand-primary leading-none"><?php echo e($p['l']); ?></span>
        <h4 class="text-sm font-black text-slate-900 group-hover:text-white uppercase tracking-wider transition-colors leading-none"><?php echo e($p['t']); ?></h4>
       </div>
       <p class="text-xs text-slate-500 group-hover:text-slate-400 font-normal leading-relaxed transition-colors"><?php echo e($p['d']); ?></p>
      </div>
