        ...
        <div class="space-y-1">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-1">
                <div class="lg:col-span-3 bg-slate-900 p-6  relative overflow-hidden group">
                    <div class="relative z-10 flex flex-col md:flex-row gap-12 items-start">
                        <div class="w-16 h-16 bg-brand-primary flex items-center justify-center shrink-0">
                            <i class="<?php echo e($reasons[0]['icon']); ?> text-white text-2xl"></i>
                        </div>
                        <div class="space-y-6">
                            <h3 class="text-2xl font-bold text-white uppercase tracking-tighter"><?php echo e($reasons[0]['title']); ?></h3>
                            <p class="text-white/60 text-base leading-relaxed max-w-2xl"><?php echo e($reasons[0]['desc']); ?></p>
                            <div class="flex flex-wrap gap-3">
                                <?php $__currentLoopData = $reasons[0]['points']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="px-4 py-1.5 bg-white/5 border border-white/10 text-[9px] font-bold text-white uppercase tracking-widest"><?php echo e($point); ?></span>
                ...
                <div class="bg-brand-primary p-6 flex flex-col justify-between group">
                    ...
                    <div class="space-y-4">
                        <h3 class="text-lg font-bold text-white uppercase tracking-tighter leading-tight"><?php echo e($reasons[1]['title']); ?></h3>
                        <p class="text-brand-primary-dark/60 text-[10px] font-bold uppercase tracking-widest leading-relaxed"><?php echo e($reasons[1]['desc']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-1">
                <div class="bg-brand-primary p-6 flex flex-col justify-between group">
                    ...
                    <div class="space-y-4">
                        <h3 class="text-lg font-bold text-white uppercase tracking-tighter leading-tight"><?php echo e($reasons[3]['title']); ?></h3>
                        <p class="text-brand-primary-dark/60 text-[10px] font-bold uppercase tracking-widest leading-relaxed"><?php echo e($reasons[3]['desc']); ?></p>
                    </div>
                </div>
                <div class="lg:col-span-3 bg-slate-900 p-6  relative overflow-hidden group">
                    <div class="relative z-10 flex flex-col md:flex-row gap-12 items-start">
                        <div class="w-16 h-16 bg-brand-accent flex items-center justify-center shrink-0">
                            <i class="<?php echo e($reasons[2]['icon']); ?> text-brand-primary-dark text-2xl"></i>
                        </div>
                        <div class="space-y-6">
                            <h3 class="text-2xl font-bold text-white uppercase tracking-tighter"><?php echo e($reasons[2]['title']); ?></h3>
                            <p class="text-white/60 text-base leading-relaxed max-w-2xl"><?php echo e($reasons[2]['desc']); ?></p>
                            <div class="grid grid-cols-3 gap-4">
                                <?php $__currentLoopData = $reasons[2]['points']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center gap-3 bg-white/5 p-3 border border-white/10">
                                        ...
                                        <span class="text-[9px] font-bold text-white uppercase tracking-widest"><?php echo e($point); ?></span>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-1">
                <div class="lg:col-span-3 bg-slate-900 p-6  relative overflow-hidden group">
                    <div class="relative z-10 flex flex-col md:flex-row gap-12 items-start">
                        <div class="w-16 h-16 bg-white flex items-center justify-center shrink-0">
                            <i class="<?php echo e($reasons[4]['icon']); ?> text-brand-primary text-2xl"></i>
                        </div>
                        <div class="space-y-6">
                            <h3 class="text-2xl font-bold text-white uppercase tracking-tighter"><?php echo e($reasons[4]['title']); ?></h3>
                            <p class="text-white/60 text-base leading-relaxed max-w-2xl"><?php echo e($reasons[4]['desc']); ?></p>
                            <div class="flex flex-wrap gap-3">
                                <?php $__currentLoopData = $reasons[4]['points']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="px-4 py-1.5 bg-brand-accent text-brand-primary-dark text-[9px] font-bold uppercase tracking-widest"><?php echo e($point); ?></span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-brand-primary p-6 flex flex-col justify-between group">
                    ...
                    <div class="space-y-4">
                        <h3 class="text-lg font-bold text-white uppercase tracking-tighter leading-tight"><?php echo e($reasons[5]['title']); ?></h3>
                        <p class="text-brand-primary-dark/60 text-[10px] font-bold uppercase tracking-widest leading-relaxed"><?php echo e($reasons[5]['desc']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-1">
                <div class="bg-brand-primary p-6 flex flex-col justify-between group">
                    ...
                    <div class="space-y-4">
                        <h3 class="text-lg font-bold text-white uppercase tracking-tighter leading-tight"><?php echo e($reasons[7]['title']); ?></h3>
                        <p class="text-brand-primary-dark/60 text-[10px] font-bold uppercase tracking-widest leading-relaxed"><?php echo e($reasons[7]['desc']); ?></p>
                    </div>
                </div>
                <div class="lg:col-span-3 bg-slate-900 p-6  relative overflow-hidden group">
                    <div class="relative z-10 flex flex-col md:flex-row gap-12 items-start">
                        <div class="w-16 h-16 bg-brand-primary flex items-center justify-center shrink-0">
                            <i class="<?php echo e($reasons[6]['icon']); ?> text-white text-2xl"></i>
                        </div>
                        <div class="space-y-6">
                            <h3 class="text-2xl font-bold text-white uppercase tracking-tighter"><?php echo e($reasons[6]['title']); ?></h3>
                            <p class="text-white/60 text-base leading-relaxed max-w-2xl"><?php echo e($reasons[6]['desc']); ?></p>
                            <div class="flex flex-wrap gap-3">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-1">
                <div class="lg:col-span-3 bg-slate-900 p-6  relative overflow-hidden group">
                    <div class="relative z-10 flex flex-col md:flex-row gap-12 items-start">
                        <div class="w-16 h-16 bg-brand-accent flex items-center justify-center shrink-0">
                            <i class="<?php echo e($reasons[8]['icon']); ?> text-brand-primary-dark text-2xl"></i>
                        </div>
                        <div class="space-y-6">
                            <h3 class="text-2xl font-bold text-white uppercase tracking-tighter"><?php echo e($reasons[8]['title']); ?></h3>
                            <p class="text-white/60 text-base leading-relaxed max-w-2xl"><?php echo e($reasons[8]['desc']); ?></p>
                            <div class="flex flex-wrap gap-3">
                ...
                <div class="bg-brand-primary p-6 flex flex-col justify-between group">
                    ...
                    <div class="space-y-4">
                        <h3 class="text-lg font-bold text-white uppercase tracking-tighter leading-tight"><?php echo e($reasons[9]['title']); ?></h3>
                        <p class="text-brand-primary-dark/60 text-[10px] font-bold uppercase tracking-widest leading-relaxed"><?php echo e($reasons[9]['desc']); ?></p>
                    </div>
                </div>
            </div>
        </div>
