<?php $__env->startSection('title', 'Water Conservation Industry'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-64 pb-32 bg-slate-950 overflow-hidden border-b border-slate-900">
        ...
        <div class="absolute inset-0 opacity-20">
            <img src="<?php echo e(asset('images/sectors/water-conservation.jpg')); ?>" class="w-full h-full object-cover grayscale">
        </div>
                ...
                <div class="grid grid-cols-2 gap-px bg-slate-200 shadow-3xl">
                    ...
                    <?php $__currentLoopData = $inclusions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-10 bg-white flex flex-col items-center justify-center text-center group hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
                             <div class="absolute top-0 left-0 w-1 h-full bg-<?php echo e($inc['color']); ?>-600 scale-y-0 group-hover:scale-y-100 transition-transform origin-top duration-500"></div>
                            <i class="fa-solid fa-<?php echo e($inc['icon']); ?> text-4xl mb-6 text-slate-200 group-hover:text-<?php echo e($inc['color']); ?>-600 transition-all duration-500"></i>
                            <p class="text-[9px] font-black uppercase tracking-[0.2em] text-slate-400 group-hover:text-white transition-colors italic leading-tight"><?php echo e($inc['label']); ?></p>
                        </div>
                    ...
                    <div class="relative z-10 space-y-16">
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="grid grid-cols-2 gap-px bg-white/10 border border-white/10 shadow-2xl">
                                <?php $__currentLoopData = ['Water Scarcity', 'Climate Change', 'Industrial Demand', 'Urban Growth']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="p-8 bg-slate-950 text-center text-[10px] font-black uppercase tracking-[0.1em] text-slate-400 hover:bg-blue-600 hover:text-slate-950 transition-all cursor-default"><?php echo e($driver); ?></div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-px bg-white/5 border border-white/5">
                        <?php $__currentLoopData = [
                            ...
                            <div class="p-10 bg-slate-950 group/item hover:bg-blue-600 transition-all duration-500 relative overflow-hidden text-center">
                                ...
                                <i class="fa-solid fa-<?php echo e($trend['icon']); ?> text-3xl mb-6 text-blue-600 group-hover/item:text-slate-950 transition-colors"></i>
                ...
                <div class="p-24 bg-white space-y-16 border-l border-slate-200">
                    ...
                    <div class="space-y-px bg-slate-200 border border-slate-200 shadow-sm">
                        ...
                        <div class="flex items-center gap-10 p-10 bg-white group/opp hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
                            ...
                            <i class="fa-solid fa-<?php echo e($opp['icon']); ?> text-2xl text-blue-600 group-hover/opp:text-white transition-colors"></i>
                ...
                <div class="p-16 lg:p-24 bg-slate-950 text-white space-y-16 relative overflow-hidden group shadow-3xl border border-white/5">
                    ...
                    <div class="relative z-10 space-y-12">
                        ...
                        <div class="grid grid-cols-2 gap-px bg-white/5 pt-12 border border-white/10">
                             <?php $__currentLoopData = ['ESG COMPLIANT', 'ZLD SYSTEMS', 'SMART WATER', 'REUSE HUB']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="p-8 bg-slate-950 border border-white/5 text-[10px] font-black uppercase tracking-[0.4em] text-blue-300 text-center hover:bg-blue-600 hover:text-slate-950 transition-all cursor-default"><?php echo e($tag); ?></span>
                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\worldgrexpo\resources\views/website/sectors/water-conservation.blade.php ENDPATH**/ ?>