...
<?php $__env->startSection('title', 'Start-Up Ecosystem'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-32 pb-24 bg-slate-900 text-white overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-10"
            style="background-image: url('<?php echo e(asset('images/sectors/start-up-ecosystem.jpg')); ?>'); background-size: cover; background-position: center;">
        </div>
    ...
    <section class="py-16 bg-white">
        <div class="container space-y-16">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <img src="<?php echo e(asset('images/sectors/start-up-ecosystem.jpg')); ?>" alt="Start-Up Importance"
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <img src="<?php echo e(asset('images/sectors/start-up-ecosystem.jpg')); ?>" alt="India Start-Up Hub"
