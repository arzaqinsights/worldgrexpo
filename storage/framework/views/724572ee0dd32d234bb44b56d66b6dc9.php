...
<?php $__env->startSection('content'); ?>
 ...
 <section class="relative pt-40 pb-20 bg-slate-950 overflow-hidden border-b border-slate-900">
  ...
  <div class="absolute inset-0 opacity-20">
   <img src="<?php echo e(asset('images/sectors/start-up-ecosystem.jpg')); ?>" class="w-full h-full object-cover">
  </div>
       ...
       <div class="grid grid-cols-3 gap-4">
        <?php $__currentLoopData = ['USA', 'UK', 'Germany', 'Singapore', 'Israel', 'UAE']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         <div class="p-6 bg-slate-950 flex flex-col items-center justify-center gap-4 group/item hover:bg-fuchsia-600 transition-all duration-500">
          <span class="text-[9px] font-bold uppercase text-slate-300 group-hover:text-slate-950 tracking-[0.1em] text-center"><?php echo e($hub); ?></span>
         </div>
