...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-64 pb-32 bg-slate-950 overflow-hidden border-b border-slate-900">
        ...
        <div class="absolute inset-0 opacity-20">
            <img src="<?php echo e(asset('images/sectors/circular-economy.jpg')); ?>" class="w-full h-full object-cover grayscale">
        </div>
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="grid grid-cols-2 gap-px bg-white/10 border border-white/10">
                                <?php $__currentLoopData = ['Raw Material Costs', 'Resource Scarcity', 'Climate Mitigation', 'ESG Mandates']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="px-8 py-6 bg-slate-950 text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] text-center hover:bg-teal-600 hover:text-slate-950 transition-all cursor-default"><?php echo e($driver); ?></span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 gap-px bg-slate-200 border border-slate-200 shadow-sm">
                                <?php $__currentLoopData = ['Waste Management', 'Sustainable Packaging', 'Renewable Energy', 'Water Reuse', 'Industrial Efficiency', 'Green Manufacturing']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="p-8 bg-white flex items-center gap-6 group/item hover:bg-slate-950 transition-all duration-500">
                                        ...
                                        <span class="text-[10px] font-black uppercase text-slate-600 group-hover/item:text-white tracking-[0.1em] leading-tight transition-colors"><?php echo e($area); ?></span>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-px bg-slate-200 border border-slate-200 shadow-3xl">
                    ...
                    <?php $__currentLoopData = $pillars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-16 bg-white text-center group hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
                            ...
                            <h4 class="text-2xl font-black text-slate-950 group-hover:text-white uppercase tracking-tighter mb-4 italic leading-tight transition-colors"><?php echo e($p['title']); ?></h4>
                            <p class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] leading-tight transition-colors"><?php echo e($p['desc']); ?></p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
