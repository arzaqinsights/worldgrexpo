...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-32 pb-24 bg-slate-950 text-white overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-20"
            style="background-image: url('<?php echo e(asset('images/sectors/chemicals-petrochemicals-industry.jpg')); ?>'); background-size: cover; background-position: center;">
        </div>
                ...
                <div class="grid grid-cols-2 gap-4 animate-in fade-in slide-in-from-right duration-700">
                    ...
                    <?php $__currentLoopData = $segments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-6 bg-slate-50 border border-slate-100 rounded-2xl text-center group hover:bg-slate-900 hover:text-white transition-all duration-300 shadow-sm">
                            <i class="fa-solid fa-<?php echo e($s['icon']); ?> text-3xl mb-3 text-indigo-500 group-hover:text-indigo-400 font-black"></i>
                            <p class="text-[10px] font-black uppercase tracking-tight"><?php echo e($s['label']); ?></p>
                        </div>
                        ...
                        <div class="space-y-4">
                            <?php $__currentLoopData = [
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-xs font-bold uppercase text-slate-300"><?php echo e($stat); ?></span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="order-2 md:order-1 grid grid-cols-2 gap-4">
                    ...
                    <div class="p-6 bg-slate-50 border border-slate-200 rounded-3xl text-center shadow hover:shadow-lg transition-all">
                        <p class="text-[10px] font-black uppercase text-indigo-600 mb-2">Segment 0<?php echo e($idx + 1); ?></p>
                        <p class="text-lg font-black text-slate-900 leading-tight italic uppercase"><?php echo e($pill['t']); ?></p>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                ...
                <div class="order-1 md:order-2 space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center gap-4 group">
                            ...
                            <p class="text-sm font-bold uppercase text-slate-700 tracking-tight transition-transform group-hover:translate-x-2"><?php echo e($item); ?></p>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                    <?php $__currentLoopData = ['Packaging & FMCG', 'Agriculture', 'Automotive', 'Construction', 'Healthcare', 'Textiles']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eco): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-6 bg-white border border-slate-200 rounded-2xl text-center group hover:border-indigo-500 hover:shadow-xl transition-all">
                             <p class="text-xs font-black uppercase text-slate-600 group-hover:text-indigo-600 transition-colors"><?php echo e($eco); ?></p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center gap-4 p-4 rounded-xl border-l-4 border-indigo-500 bg-slate-50 hover:bg-white hover:shadow-md transition-all">
                            ...
                            <span class="text-sm font-bold uppercase tracking-tight text-slate-900"><?php echo e($imp); ?></span>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="flex flex-wrap gap-2">
                             <?php $__currentLoopData = ['GREEN CHEM', 'ESG FOCUS', 'HYDROGEN', 'CIRCULAR']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="px-3 py-1 bg-white/10 rounded-lg text-[10px] font-black uppercase text-indigo-300 border border-indigo-500/20"><?php echo e($tag); ?></span>
                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                </div>
