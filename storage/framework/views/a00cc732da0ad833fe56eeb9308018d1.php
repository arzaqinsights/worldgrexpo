...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-64 pb-32 bg-slate-950 overflow-hidden border-b border-slate-900">
        ...
        <div class="absolute inset-0 opacity-20">
            <img src="<?php echo e(asset('images/sectors/csr.jpg')); ?>" class="w-full h-full object-cover grayscale">
        </div>
                        ...
                        <ul class="space-y-8">
                            <?php $__currentLoopData = [
                                ...
                                <li class="flex items-start gap-8 group/item">
                                    ...
                                    <span class="text-xl font-black uppercase tracking-widest text-slate-400 group-hover/item:text-white transition-colors leading-tight"><?php echo e($item); ?></span>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
                ...
                <div class="p-16 lg:p-24 bg-white text-slate-950 space-y-12 group relative overflow-hidden border-l border-slate-200">
                    ...
                    <ul class="space-y-8">
                        <?php $__currentLoopData = [
                            ...
                            <li class="flex items-start gap-8 group/item">
                                <div class="w-2 h-2 bg-rose-600 mt-4 group-hover/item:scale-150 transition-transform"></div>
                                <span class="text-xl font-black uppercase tracking-widest text-slate-700 group-hover/item:text-slate-950 transition-colors leading-tight"><?php echo e($item); ?></span>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
            ...
            <div class="space-y-24">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-px bg-slate-200 border border-slate-200 shadow-3xl">
                    ...
                    <div class="p-16 bg-white space-y-12 group hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
                        ...
                        <ul class="space-y-4">
                            <?php $__currentLoopData = ['Education & Skill Dev', 'Women Empowerment', 'Rural Development', 'Healthcare & Sanitation']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="p-16 bg-white space-y-12 group hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
                        ...
                        <ul class="space-y-4">
                            <?php $__currentLoopData = ['Renewable Energy', 'Tree Plantation', 'Waste Management', 'Water Conservation']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="flex items-center gap-4 text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 group-hover:text-slate-400 transition-colors">
                    ...
                    <div class="p-16 bg-white space-y-12 group hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
                        ...
                        <ul class="space-y-4">
                            <?php $__currentLoopData = ['Entrepreneurship Dev', 'Livelihood Enhancement', 'MSME Support Programs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="flex items-center gap-4 text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 group-hover:text-slate-400 transition-colors">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-px bg-white/5 pt-12">
                             <?php $__currentLoopData = [
                                ...
                                <div class="p-8 bg-slate-950 border border-white/5 flex items-center gap-8 group/item hover:bg-rose-600 transition-all duration-500">
                                    <i class="fa-solid fa-<?php echo e($fut['icon']); ?> text-rose-600 text-2xl group-hover/item:text-slate-950 transition-colors"></i>
                                    <span class="text-[12px] font-black uppercase text-slate-300 group-hover/item:text-slate-950 tracking-[0.2em] transition-colors leading-tight"><?php echo e($fut['label']); ?></span>
                                </div>
                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\worldgrexpo\resources\views/website/sectors/csr.blade.php ENDPATH**/ ?>