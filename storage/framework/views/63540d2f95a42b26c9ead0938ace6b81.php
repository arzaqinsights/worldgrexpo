                    ...
                    <div class="group relative bg-white flex flex-col h-full transition-all duration-500 hover:shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-300 hover:border-brand-primary">
                        ...
                        <div class="relative aspect-[16/10] overflow-hidden bg-slate-100">
                            ...
                            <div class="absolute bottom-0 left-0 bg-brand-primary p-5 text-white text-center min-w-[80px]">
                                <div class="text-3xl font-black leading-none tracking-tighter"><?php echo e($event->event_date->format('d')); ?></div>
                                <div class="text-[10px] font-black uppercase tracking-[0.2em] mt-1 opacity-90"><?php echo e($event->event_date->format('M')); ?></div>
                            </div>
                            ...
                            <div class="space-y-6 flex-1 pt-2">
                                ...
                                <div class="flex items-start gap-4 group/item">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-bold text-slate-800 uppercase tracking-wider leading-relaxed"><?php echo e($event->location ?: 'India Expo Centre, Greater Noida'); ?></p>
                                    </div>
                                </div>
                            </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\worldgrexpo\resources\views/website/home/partials/events.blade.php ENDPATH**/ ?>