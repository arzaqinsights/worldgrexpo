                        ...
                        <div class="group relative flex flex-col h-full bg-white rounded overflow-hidden border border-brand-primary transition-all duration-700 hover:-translate-y-4"
                            ...
                            <div class="relative aspect-video overflow-hidden">
                                ...
                                <!-- <div class="absolute top-6 left-6 p-4 rounded-2xl bg-white shadow-2xl text-center min-w-[70px]">
                                    <div class="text-2xl font-black text-brand-primary leading-none"><?php echo e($event->event_date->format('d')); ?></div>
                                    <div class="text-[10px] font-black uppercase tracking-widest text-slate-400 mt-1"><?php echo e($event->event_date->format('M')); ?></div>
                                </div> -->
                            </div>
                                ...
                                <div class="pt-4 border-t border-slate-100 space-y-4">
                                    ...
                                    <div class="flex items-center gap-4 group/item">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm font-bold text-slate-700"><?php echo e($event->location ?: 'India Expo Centre, Delhi NCR'); ?></div>
                                        </div>
                                    </div>
                                </div>
