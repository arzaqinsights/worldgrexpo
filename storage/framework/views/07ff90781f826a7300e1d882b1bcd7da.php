        ...
        <div class="flex flex-col lg:flex-row items-end justify-between gap-12 mb-20">
            <div class="max-w-3xl space-y-8">
                <div class="section-heading">
                    ...
                    <h2>World <span class="text-brand-primary">Grexpo.</span></h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-1 border border-slate-100">
            ...
            <div class="md:col-span-2 bg-white space-y-8 border-b md:border-b-0 md:border-r border-slate-100">
                <div class="flex items-center gap-4">
                    ...
                    <span class="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Institutional Mandate</span>
                </div>
                <h3 class="text-4xl font-black text-slate-900 leading-tight uppercase tracking-tighter">
            ...
            <div class="bg-slate-950 p-6 flex flex-col justify-between space-y-6">
                <div class="space-y-8">
                    <div class="flex items-center gap-4">
                        ...
                        <span class="text-[9px] font-black uppercase tracking-[0.3em] text-brand-accent">Global Impact</span>
                    </div>
                    <div class="grid grid-cols-1 gap-8">
                        <div>
                            <span class="block text-3xl md:text-4xl lg:text-5xl font-black text-white tracking-tighter">30+</span>
                            <span class="text-[9px] font-black uppercase tracking-[0.3em] text-slate-500">Nations Reached</span>
                        </div>
                        <div>
                            <span class="block text-3xl md:text-4xl lg:text-5xl font-black text-white tracking-tighter"><?php echo e(count(config('sectors.sectors'))); ?></span>
                            <span class="text-[9px] font-black uppercase tracking-[0.3em] text-slate-500">Strategic Sectors</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="md:col-span-3 grid grid-cols-2 md:grid-cols-4 gap-px bg-slate-100 mt-20">
                ...
                ?>
                <?php $__currentLoopData = $focus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white p-8 border border-slate-300 group hover:bg-slate-100 hover:border-brand-primary transition-all">
                        <div class="w-10 h-10 bg-slate-50 flex items-center justify-center mb-6 group-hover:bg-brand-primary group-hover:text-white transition-all">
                            <i class="fa-solid <?php echo e($item['icon']); ?> text-xs"></i>
                        </div>
                        <h4 class="text-[11px] font-black uppercase tracking-widest text-slate-900 mb-2"><?php echo e($item['label']); ?></h4>
                        <p class="text-[10px] font-bold text-slate-400 uppercase tracking-wider"><?php echo e($item['desc']); ?></p>
                    </div>
...
<?php /**PATH C:\laragon\www\worldgrexpo\resources\views/website/about/partials/who_we_are.blade.php ENDPATH**/ ?>