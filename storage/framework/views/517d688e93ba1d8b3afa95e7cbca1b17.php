...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-32 pb-24 bg-slate-900 text-white overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-10"
            style="background-image: url('<?php echo e(asset('images/sectors/packaging-machinery.jpg')); ?>'); background-size: cover; background-position: center;">
        </div>
    ...
    <section class="py-16 bg-white">
        <div class="container space-y-16">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <img src="<?php echo e(asset('images/sectors/packaging-machinery.jpg')); ?>" alt="Packaging Machinery Share"
