...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-64 pb-32 bg-slate-950 overflow-hidden border-b border-slate-900">
        ...
        <div class="absolute inset-0 opacity-20">
            <img src="<?php echo e(asset('images/sectors/packaging-inks-hero.png')); ?>" class="w-full h-full object-cover grayscale">
        </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-px bg-white/5 border border-white/5">
                        <?php $__currentLoopData = [
                            ...
                            <div class="p-10 bg-slate-950 group/item hover:bg-pink-600 transition-all duration-500 relative overflow-hidden text-center">
                                ...
                                <i class="fa-solid fa-<?php echo e($opp['icon']); ?> text-3xl mb-6 text-pink-600 group-hover/item:text-slate-950 transition-colors"></i>
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\worldgrexpo\resources\views/website/sectors/flexible-packaging-inks.blade.php ENDPATH**/ ?>