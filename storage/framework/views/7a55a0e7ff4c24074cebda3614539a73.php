...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-64 pb-32 bg-slate-950 overflow-hidden border-b border-slate-900">
        ...
        <div class="absolute inset-0 opacity-20">
            <img src="<?php echo e(asset('images/sectors/plastic-machinery.jpg')); ?>" class="w-full h-full object-cover grayscale">
        </div>
                             ...
                             <div class="grid grid-cols-2 gap-4">
                                <?php $__currentLoopData = ['E-commerce Pkg', 'Automotive Lightening', 'Industry 4.0', 'Energy Efficiency']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center gap-4 group/item">
                                        ...
                                        <span class="text-[9px] font-black uppercase text-slate-400 group-hover/item:text-white transition-colors tracking-widest leading-tight"><?php echo e($d); ?></span>
                                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-white/10 border border-white/10 shadow-2xl relative z-10">
                    ...
                    <?php $__currentLoopData = $machinery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-12 bg-slate-950 group/item hover:bg-indigo-600 transition-all duration-500">
                            ...
                            <h4 class="text-xl font-black uppercase text-white group-hover/item:text-slate-950 mb-4 transition-colors italic"><?php echo e($m['title']); ?></h4>
                            <p class="text-[10px] font-black uppercase text-slate-500 group-hover/item:text-slate-900 tracking-widest leading-relaxed transition-colors italic"><?php echo e($m['desc']); ?></p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
