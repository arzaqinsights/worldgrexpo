        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
            ...
            <div class="group flex flex-col bg-slate-50 border border-slate-100 rounded-sm p-8 hover:bg-slate-950 transition-all duration-700 shadow-sm relative overflow-hidden">
                ...
                <div class="relative overflow-hidden aspect-[3/4] mb-10 border border-slate-200 group-hover:border-slate-800 rounded-sm">
                    <img src="<?php echo e(asset($award->award_image)); ?>" alt="<?php echo e($award->title); ?>" class="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-[2000ms]">
                    ...
                    <div class="absolute inset-0 bg-slate-950/80 p-10 flex flex-col justify-end opacity-0 group-hover:opacity-100 transition-opacity duration-700">
                        <p class="text-white text-[10px] font-black uppercase tracking-[0.2em] leading-relaxed italic">
                            <?php echo e(Str::limit($award->description, 150)); ?>
                ...
                <div class="flex flex-col flex-1">
                    ...
                    <div class="mt-auto space-y-4">
                        ...
                        <a href="<?php echo e(asset($award->pdf_path)); ?>" target="_blank" class="flex items-center justify-center gap-4 w-full py-6 bg-slate-950 text-white font-black text-[10px] uppercase tracking-[0.3em] italic rounded-sm border border-white/10 hover:bg-brand-accent hover:text-slate-950 transition-all duration-700 group/btn">
                        ...
                        <div class="flex items-center gap-6 p-6 bg-white border border-slate-200 rounded-sm group-hover:bg-white/5 group-hover:border-white/10 transition-all">
                            ...
                            <img src="<?php echo e(asset($award->giver_image)); ?>" class="w-16 h-16 grayscale group-hover:grayscale-0 object-cover rounded-sm border border-slate-100 group-hover:border-slate-800">
                            <?php else: ?>
                            ...
                            <?php endif; ?>
                            <div>
                                <p class="text-[10px] font-black text-slate-950 uppercase tracking-[0.2em] leading-none mb-2 group-hover:text-white transition-colors"><?php echo e($award->giver_name); ?></p>
...
<section class="py-32 bg-slate-950 relative overflow-hidden">
    ...
    <div class="container relative z-10 text-center">
        ...
        <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center gap-6 px-16 py-8 bg-white text-slate-950 font-black uppercase tracking-[0.3em] text-xs rounded-sm hover:bg-brand-accent transition-all duration-700 shadow-4xl italic group">
