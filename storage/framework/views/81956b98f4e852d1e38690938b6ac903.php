        ...
        <div class="flex flex-col lg:flex-row gap-12 items-start">
                ...
                <div class="space-y-px bg-slate-100 md:h-[432px] overflow-scroll">
                    <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="group bg-white transition-all duration-300 border border-slate-300"
                             :class="active === <?php echo e($item['id']); ?> ? 'bg-slate-50' : ''">
                            ...
                            <button class="w-full flex items-center justify-between p-8 text-left outline-none" 
                                ...
                                <div class="w-10 h-10 border border-slate-200 flex items-center justify-center shrink-0 transition-all duration-300"
                                     :class="active === <?php echo e($item['id']); ?> ? 'bg-brand-primary text-white border-brand-primary rotate-180' : 'text-slate-400 group-hover:bg-slate-50'">
            ...
            <div class="w-full lg:w-5/12 lg:sticky lg:top-32 self-start">
                <div class="relative bg-slate-900 overflow-hidden group min-h-[650px] flex items-end border border-slate-200">
                    <img src="<?php echo e(asset('images/faq-bg.png')); ?>" alt="Support" class="absolute inset-0 w-full h-full object-cover opacity-40 group-hover:opacity-60 transition-opacity duration-1000">
...
<?php /**PATH C:\laragon\www\worldgrexpo\resources\views/website/home/partials/faqs.blade.php ENDPATH**/ ?>