...
<?php $__env->startSection('title', 'Textile Industry Overview'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-32 pb-24 bg-slate-900 text-white overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-20"
            style="background-image: url('<?php echo e(asset('images/sectors/textile.png')); ?>'); background-size: cover; background-position: center;">
        </div>
        ...
        <div class="container space-y-16">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative group animate-in fade-in slide-in-from-right duration-700">
                    ...
                    <img src="<?php echo e(asset('images/sectors/textile.png')); ?>" alt="Textile Industry"
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="order-2 md:order-1 relative">
                    <img src="<?php echo e(asset('images/sectors/manufacturing.jpg')); ?>" alt="Textile Opportunities"
                ...
                <div class="relative z-10 grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php $__currentLoopData = ['Surat', 'Tiruppur', 'Ludgaon', 'Panipat', 'Ahmedabad', 'Mumbai', 'Delhi NCR']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="px-3 py-1 bg-white/5 rounded-full text-[10px] font-bold tracking-widest text-blue-300 border border-white/5"><?php echo e($hub); ?></span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\worldgrexpo\resources\views/website/sectors/textile-industry.blade.php ENDPATH**/ ?>