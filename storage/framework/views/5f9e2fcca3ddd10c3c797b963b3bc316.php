...
<?php $__env->startSection('title', 'Pharmaceuticals Industry - Driving Global Health Innovation'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-32 pb-24 bg-slate-900 text-white overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-25"
            style="background-image: url('<?php echo e(asset('images/sectors/pharma-hero.png')); ?>'); background-size: cover; background-position: center;">
        </div>
        ...
        <div class="container space-y-16">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative group animate-in fade-in slide-in-from-right duration-700">
                    ...
                    <img src="<?php echo e(asset('images/sectors/pharma-details.png')); ?>" alt="Pharmaceutical Industry"
                ...
                <div class="p-8 rounded-3xl bg-gradient-to-br from-slate-800 to-slate-900 text-white shadow-2xl transform hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php $__currentLoopData = ['USA', 'China', 'Germany', 'Japan', 'UK', 'India']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $market): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="px-3 py-1 bg-white/5 rounded-full text-xs font-bold border border-white/10 text-slate-300"><?php echo e($market); ?></span>
                ...
                <div class="order-1 md:order-2 p-8 bg-slate-900 rounded-3xl text-white relative overflow-hidden">
                    <div class="relative z-10">
                        ...
                        <div class="mt-8 pt-6 border-t border-white/10">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <?php $__currentLoopData = ['Generics', 'APIs', 'Vaccines', 'Biologics', 'Nutraceuticals']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="text-[10px] font-black px-2 py-1 bg-white/5 rounded border border-white/5"><?php echo e($seg); ?></span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\worldgrexpo\resources\views/website/sectors/pharmaceuticals-industry.blade.php ENDPATH**/ ?>