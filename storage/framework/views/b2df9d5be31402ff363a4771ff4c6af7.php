...
<div class="flex justify-between items-center mb-6">
    ...
    <div class="flex items-center gap-3">
        <form action="<?php echo e(route('admin.forms.import-sql')); ?>" method="POST" enctype="multipart/form-data" class="flex items-center m-0">
            <?php echo csrf_field(); ?>
        ...
        <a href="<?php echo e(route('admin.forms.create')); ?>" class="bg-emerald-500 hover:bg-emerald-600 text-white font-bold py-3 px-6 rounded-xl shadow-lg hover:shadow-emerald-500/40 transition-all flex items-center gap-2 text-sm">
                    ...
                    <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-3">
                                ...
                                <a href="<?php echo e(route('admin.forms.export-sql', $form)); ?>" class="text-indigo-600 hover:text-indigo-700 font-bold bg-indigo-50 hover:bg-indigo-100 px-3 py-1.5 rounded-lg transition-colors" title="Export Form to SQL">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\worldgrexpo\resources\views/admin/forms/index.blade.php ENDPATH**/ ?>