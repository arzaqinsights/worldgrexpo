        ...
        <div class="container space-y-32">
            ...
            <div class="space-y-20">
                ...
                <div class="grid md:grid-cols-3 gap-2">
                    ...
                    <div class="group relative h-[550px] overflow-hidden rounded-sm border border-slate-900">
                        <img src="<?php echo e($port['img']); ?>" class="w-full h-full object-cover grayscale group-hover:grayscale-0 group-hover:scale-105 transition-all duration-1000" alt="Intelligence Node">
                        ...
                        <div class="absolute inset-0 p-12 flex flex-col justify-end">
                            <h4 class="text-3xl font-black text-brand-accent mb-4 uppercase italic tracking-tighter group-hover:text-white transition-colors"><?php echo e($port['t']); ?></h4>
                            <p class="text-slate-400 text-[10px] font-bold leading-relaxed uppercase tracking-widest group-hover:text-white transition-colors"><?php echo e($port['d']); ?></p>
                        </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 relative z-10">
                    ...
                    <div class="p-10 bg-white/5 border border-white/10 rounded-sm hover:bg-brand-primary transition-all duration-700 group">
                        <div class="w-16 h-16 bg-white/5 border border-white/10 mx-auto rounded-sm flex items-center justify-center text-brand-accent group-hover:bg-white group-hover:text-brand-primary transition-all duration-700 mb-8">
                            <i class="fa-solid fa-<?php echo e($tech['icon']); ?> text-2xl group-hover:scale-110"></i>
                        </div>
                        <p class="text-[10px] font-black uppercase text-slate-400 tracking-widest group-hover:text-slate-950 transition-colors"><?php echo e($tech['title']); ?></p>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <div class="relative bg-slate-950 p-24 rounded-sm text-left overflow-hidden border-l-[20px] border-brand-accent group">
                ...
                <div class="relative z-10 space-y-12">
                    ...
                    <a href="<?php echo e(route('forms.show', ['slug' => 'join-us'])); ?>" class="inline-flex items-center gap-6 px-16 py-8 bg-white text-slate-950 font-black uppercase tracking-[0.3em] text-xs rounded-sm hover:bg-brand-accent hover:text-slate-950 transition-all duration-700 shadow-4xl italic group">
