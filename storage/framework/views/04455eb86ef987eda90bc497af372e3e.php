<section class="py-20 bg-slate-950 relative overflow-hidden border-b border-slate-900">
 <!-- Industrial Pattern -->
 ...
 <div class="container relative z-10">
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-px bg-slate-800 border border-slate-800 shadow-2xl">
   ...
   <div class="p-16 lg:p-24 bg-slate-950 group relative overflow-hidden">
    ...
    <div class="w-20 h-20 bg-brand-primary flex items-center justify-center mb-12 hover:scale-110 transition-transform duration-700 shadow-2xl">
     <i class="fa-solid fa-bullseye text-3xl text-brand-primary-dark"></i>
    </div>
    
    <div class="space-y-12">
     <div class="space-y-4">
      <div class="text-brand-accent text-[10px] font-bold uppercase tracking-[0.4em]">The Drive</div>
      <h3 class="text-3xl font-bold text-white uppercase tracking-tight leading-none">
       Our <br><span class="text-brand-primary">Mission.</span>
      </h3>
     </div>
     
     <p class="text-slate-400 text-lg font-medium leading-relaxed max-w-xl">
     ...
     <div class="p-12 bg-white/5 border border-white/10 relative overflow-hidden">
      ...
      <p class="text-white text-lg font-bold leading-tight uppercase tracking-tight">
   ...
   <div class="p-16 lg:p-24 bg-brand-primary group relative overflow-hidden">
    ...
    <div class="w-20 h-20 bg-brand-primary-dark flex items-center justify-center mb-12 shadow-2xl hover:rotate-90 transition-transform duration-700">
     <i class="fa-solid fa-eye text-brand-accent text-3xl"></i>
    </div>

    <div class="space-y-12">
     <div class="space-y-4">
      <div class="text-brand-primary-dark text-[10px] font-bold uppercase tracking-[0.4em]">The Horizon</div>
      <h3 class="text-3xl font-bold text-brand-primary-dark uppercase tracking-tight leading-none">
       Our <br><span class="text-white">Vision.</span>
      </h3>
     </div>
     
     <p class="text-brand-primary-dark font-medium text-lg leading-relaxed max-w-xl">
     ...
     <div class="space-y-10 pt-12 border-t border-brand-primary-dark/10">
      ...
      <div class="flex items-start gap-8 group/item">
       <div class="w-14 h-14 bg-brand-primary-dark border border-brand-primary-dark flex items-center justify-center shrink-0 hover/item:bg-white transition-all duration-500">
        <i class="fa-solid fa-<?php echo e($item['i']); ?> text-brand-accent hover/item:text-brand-primary text-lg"></i>
       </div>
       <div class="space-y-3">
        <span class="block text-brand-primary-dark font-bold text-3xl uppercase tracking-tight leading-none"><?php echo e($item['t']); ?></span>
        <span class="block text-brand-primary-dark/60 text-[10px] font-bold uppercase tracking-[0.3em] leading-relaxed"><?php echo e($item['d']); ?></span>
       </div>
      </div>
