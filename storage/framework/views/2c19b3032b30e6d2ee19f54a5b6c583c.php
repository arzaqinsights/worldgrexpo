...
<?php $__env->startSection('title', 'Global Awareness & Thought Leadership - World Grexpo Foundation'); ?>
                ...
                <div class="grid md:grid-cols-3 gap-2">
                    ...
                    <div class="p-16 bg-slate-50 border border-slate-100 rounded-sm group hover:bg-slate-950 transition-all duration-700">
                        <div class="w-16 h-16 bg-white border border-slate-200 flex items-center justify-center rounded-sm mb-10 mx-auto group-hover:bg-brand-accent group-hover:border-brand-accent transition-all duration-700">
                             <i class="fa-solid fa-<?php echo e($mod['icon']); ?> text-slate-950 text-2xl group-hover:scale-110"></i>
                        </div>
                        <h4 class="text-2xl font-black mb-6 uppercase italic tracking-tighter group-hover:text-white transition-colors"><?php echo e($mod['t']); ?></h4>
                        <p class="text-slate-500 text-xs font-bold leading-relaxed uppercase tracking-widest group-hover:text-slate-400 transition-colors"><?php echo e($mod['d']); ?></p>
                    </div>
             ...
             <div class="space-y-20">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-2">
                    ...
                    <div class="h-80 relative rounded-sm overflow-hidden group border border-slate-900">
                        <img src="<?php echo e($img['img']); ?>" class="w-full h-full object-cover grayscale group-hover:grayscale-0 group-hover:scale-105 transition-all duration-1000" alt="Summit Node">
                        <div class="absolute inset-0 bg-slate-950/60 group-hover:bg-brand-primary/40 transition-all duration-700"></div>
                        <div class="absolute bottom-6 left-6">
                            <span class="px-6 py-3 bg-slate-950 border border-white/10 text-[10px] font-black uppercase tracking-[0.3em] text-brand-accent group-hover:bg-brand-accent group-hover:text-slate-950 transition-all duration-700 italic shadow-2xl"><?php echo e($img['loc']); ?></span>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\worldgrexpo\resources\views/website/services/global-awareness.blade.php ENDPATH**/ ?>