        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <div class="relative group">
                ...
                <div class="relative z-10 border-20 border-slate-200 bg-white overflow-hidden shadow-[20px_20px_0px_0px_rgba(170,204,0,0.1)]">
                    <img src="<?php echo e(asset('images/home/award.jpeg')); ?>" alt="Awards Ceremony" class="w-full h-full object-cover grayscale-[0.2] group-hover:grayscale-0 transition-all duration-1000 group-hover:scale-105">
                </div>
