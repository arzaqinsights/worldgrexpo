<?php $__env->startSection('title', 'Manufacturing Industry Overview'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative pt-64 pb-32 bg-slate-950 overflow-hidden border-b border-slate-900">
        ...
        <div class="absolute inset-0 opacity-20">
            <img src="<?php echo e(asset('images/sectors/manufacturing.jpg')); ?>" class="w-full h-full object-cover grayscale">
        </div>
        ...
        <div class="container space-y-48">
            ...
            <div class="grid lg:grid-cols-2 gap-px bg-slate-200 border border-slate-200">
                ...
                <div class="grid grid-cols-2 gap-px bg-slate-200">
                    ...
                    ?>
                    <?php $__currentLoopData = $segments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-12 bg-white flex flex-col items-center justify-center text-center group hover:bg-slate-950 transition-all duration-700">
                            <i class="fa-solid fa-<?php echo e($sec['icon']); ?> text-4xl mb-6 text-indigo-600 transition-transform duration-500 group-hover:scale-110"></i>
                            <p class="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 group-hover:text-white"><?php echo e($sec['label']); ?></p>
                        </div>
                    ...
                    <div class="relative z-10 space-y-16">
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="grid grid-cols-2 gap-px bg-white/10 border border-white/10 shadow-2xl">
                                <?php $__currentLoopData = ['Industrial Automation', 'Infrastructure Growth', 'Supply Chain Shift', 'Digital Transformation']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="relative z-10 space-y-16 text-right">
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="grid grid-cols-2 gap-px bg-slate-200 border border-slate-200 shadow-sm">
                                <?php $__currentLoopData = ['Industry 4.0', 'Smart Factories', 'Green Mfg', 'Robotics']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="p-6 bg-white flex flex-col items-center justify-center gap-4 group/item hover:bg-slate-950 transition-all duration-500">
                                        ...
                                        <span class="text-[9px] font-black uppercase text-slate-600 group-hover/item:text-white tracking-[0.1em] leading-tight text-center"><?php echo e($cat); ?></span>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div class="flex items-center gap-10 p-10 bg-slate-50 group/opp hover:bg-slate-950 transition-all duration-700 relative overflow-hidden">
                            ...
                            <div class="w-16 h-16 border border-slate-200 flex items-center justify-center text-indigo-600 group-hover/opp:bg-indigo-600 group-hover/opp:text-white transition-all duration-500 shadow-sm">
                                <i class="fa-solid fa-<?php echo e($i['icon']); ?> text-2xl"></i>
                            </div>
                            <span class="text-xl font-black uppercase text-slate-700 tracking-[0.15em] group-hover/opp:text-white transition-colors leading-tight italic"><?php echo e($i['title']); ?></span>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                ...
                <div class="p-24 bg-slate-950 text-white space-y-12 relative overflow-hidden group border-l border-slate-200">
                    ...
                    <div class="relative z-10 space-y-16">
                        ...
                        <div class="grid grid-cols-2 gap-px bg-white/5 border border-white/5 pt-12">
                             <?php $__currentLoopData = ['SMART PRODUCTION', 'DIGITAL TRANS.', 'ESG COMPLIANCE', 'GLOBAL SUPPLY']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.website', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\worldgrexpo\resources\views/website/sectors/manufacturing.blade.php ENDPATH**/ ?>