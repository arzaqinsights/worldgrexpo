...
<?php $__env->startSection('content'); ?>
 ...
 <section class="relative pt-40 pb-20 bg-slate-950 overflow-hidden border-b border-slate-900">
  ...
  <div class="absolute inset-0 opacity-20">
   <img src="<?php echo e(asset('images/sectors/solar-recycling.jpeg')); ?>" class="w-full h-full object-cover">
  </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 shadow-sm">
     ...
     <?php $__currentLoopData = $processes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="p-16 bg-slate-50 rounded-2xl p-8 flex flex-col items-center text-center group hover:shadow-lg transition-all">
       ...
       <h4 class="text-[12px] font-bold uppercase text-slate-950 group-hover:text-white transition-colors tracking-[0.15em] mb-2"><?php echo e($p['title']); ?></h4>
       <p class="text-[10px] font-bold uppercase text-slate-400 tracking-[0.1em] leading-tight"><?php echo e($p['desc']); ?></p>
      </div>
      ...
      <div class="space-y-8">
       ...
       <div class="grid grid-cols-2 gap-4">
        <?php $__currentLoopData = ['Rapid Installed Growth', 'WEEE Regulations', 'High Mineral Value', 'ESG Mandates']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         <div class="p-8 bg-slate-950 text-center text-[10px] font-bold uppercase tracking-[0.1em] text-slate-400 hover:bg-amber-600 hover:text-slate-950 transition-all cursor-default"><?php echo e($driver); ?></div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
       </div>
      </div>
     </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 shadow-sm">
     <div class="p-12 bg-slate-950 text-white space-y-8 flex flex-col justify-center border-r border-white/5">
      ...
      <?php $__currentLoopData = ['Market Size 2025', 'Forecast Value', 'CAGR', 'Market Stage']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $param): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
       <p class="text-[10px] font-bold uppercase text-slate-500 tracking-[0.4em]"><?php echo e($param); ?></p>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
     </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-5 gap-6 shadow-sm">
     ...
     <?php $__currentLoopData = $materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="p-10 bg-slate-50 rounded-2xl p-8 flex flex-col items-center text-center group hover:shadow-lg transition-all">
       ...
       <h4 class="text-[12px] font-bold uppercase text-slate-950 group-hover:text-white transition-colors tracking-[0.15em] mb-2 "><?php echo e($m['title']); ?></h4>
       <p class="text-[9px] font-bold uppercase text-slate-400 tracking-[0.1em] leading-tight"><?php echo e($m['desc']); ?></p>
      </div>
     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
   </div>
    ...
    <div class="p-8 lg:p-12 bg-slate-950 text-white space-y-16 relative overflow-hidden group shadow-sm border border-white/5">
     ...
     <div class="relative z-10 space-y-12">
      ...
      <div class="grid grid-cols-2 gap-px bg-white/5 pt-12 border border-white/10">
        ...
        <span class="p-8 bg-slate-950 border border-white/5 text-[10px] font-bold uppercase tracking-[0.4em] text-amber-300 text-center hover:bg-amber-600 hover:text-slate-950 transition-all cursor-default"><?php echo e($tag); ?></span>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
     </div>
    </div>
